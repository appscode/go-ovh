...
// GetDomainZoneZoneNameTaskDefaultBody get domain zone zone name task default body
// swagger:model getDomainZoneZoneNameTaskDefaultBody
...
func (m *GetDomainZoneZoneNameTaskDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameTaskDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameTaskDefaultBody

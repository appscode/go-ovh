...
// DeleteDomainZoneZoneNameDynHostLoginLoginDefaultBody delete domain zone zone name dyn host login login default body
// swagger:model deleteDomainZoneZoneNameDynHostLoginLoginDefaultBody
...
func (m *DeleteDomainZoneZoneNameDynHostLoginLoginDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainZoneZoneNameDynHostLoginLoginDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainZoneZoneNameDynHostLoginLoginDefaultBody

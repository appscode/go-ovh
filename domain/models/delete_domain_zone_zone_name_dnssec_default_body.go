...
// DeleteDomainZoneZoneNameDnssecDefaultBody delete domain zone zone name dnssec default body
// swagger:model deleteDomainZoneZoneNameDnssecDefaultBody
...
func (m *DeleteDomainZoneZoneNameDnssecDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainZoneZoneNameDnssecDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainZoneZoneNameDnssecDefaultBody

...
// GetDomainZoneZoneNameSoaDefaultBody get domain zone zone name soa default body
// swagger:model getDomainZoneZoneNameSoaDefaultBody
...
func (m *GetDomainZoneZoneNameSoaDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameSoaDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameSoaDefaultBody

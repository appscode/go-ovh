...
// GetDomainZoneZoneNameTaskIDDefaultBody get domain zone zone name task Id default body
// swagger:model getDomainZoneZoneNameTaskIdDefaultBody
...
func (m *GetDomainZoneZoneNameTaskIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameTaskIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameTaskIDDefaultBody

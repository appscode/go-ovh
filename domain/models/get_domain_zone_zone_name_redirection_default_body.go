...
// GetDomainZoneZoneNameRedirectionDefaultBody get domain zone zone name redirection default body
// swagger:model getDomainZoneZoneNameRedirectionDefaultBody
...
func (m *GetDomainZoneZoneNameRedirectionDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameRedirectionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameRedirectionDefaultBody

...
// PutDomainZoneZoneNameRecordIDDefaultBody put domain zone zone name record Id default body
// swagger:model putDomainZoneZoneNameRecordIdDefaultBody
...
func (m *PutDomainZoneZoneNameRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameRecordIDDefaultBody

...
// PostDomainZoneZoneNameHistoryCreationDateRestoreDefaultBody post domain zone zone name history creation date restore default body
// swagger:model postDomainZoneZoneNameHistoryCreationDateRestoreDefaultBody
...
func (m *PostDomainZoneZoneNameHistoryCreationDateRestoreDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameHistoryCreationDateRestoreDefaultBody

...
// PostDomainDataProContactDefaultBody post domain data pro contact default body
// swagger:model postDomainDataProContactDefaultBody
...
func (m *PostDomainDataProContactDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainDataProContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainDataProContactDefaultBody

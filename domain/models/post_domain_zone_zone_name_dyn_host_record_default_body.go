...
// PostDomainZoneZoneNameDynHostRecordDefaultBody post domain zone zone name dyn host record default body
// swagger:model postDomainZoneZoneNameDynHostRecordDefaultBody
...
func (m *PostDomainZoneZoneNameDynHostRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameDynHostRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameDynHostRecordDefaultBody

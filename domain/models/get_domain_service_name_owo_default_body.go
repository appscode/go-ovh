...
// GetDomainServiceNameOwoDefaultBody get domain service name owo default body
// swagger:model getDomainServiceNameOwoDefaultBody
...
func (m *GetDomainServiceNameOwoDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameOwoDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameOwoDefaultBody

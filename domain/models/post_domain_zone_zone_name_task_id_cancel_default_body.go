...
// PostDomainZoneZoneNameTaskIDCancelDefaultBody post domain zone zone name task Id cancel default body
// swagger:model postDomainZoneZoneNameTaskIdCancelDefaultBody
...
func (m *PostDomainZoneZoneNameTaskIDCancelDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameTaskIDCancelDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameTaskIDCancelDefaultBody

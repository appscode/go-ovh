...
// PostDomainServiceNameTaskIDRelaunchDefaultBody post domain service name task Id relaunch default body
// swagger:model postDomainServiceNameTaskIdRelaunchDefaultBody
...
func (m *PostDomainServiceNameTaskIDRelaunchDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameTaskIDRelaunchDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameTaskIDRelaunchDefaultBody

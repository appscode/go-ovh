...
// DeleteDomainServiceNameNameServerIDDefaultBody delete domain service name name server Id default body
// swagger:model deleteDomainServiceNameNameServerIdDefaultBody
...
func (m *DeleteDomainServiceNameNameServerIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainServiceNameNameServerIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainServiceNameNameServerIDDefaultBody

...
// PutDomainZoneZoneNameDynHostRecordIDDefaultBody put domain zone zone name dyn host record Id default body
// swagger:model putDomainZoneZoneNameDynHostRecordIdDefaultBody
...
func (m *PutDomainZoneZoneNameDynHostRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameDynHostRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameDynHostRecordIDDefaultBody

...
// PostDomainZoneZoneNameTaskIDRelaunchDefaultBody post domain zone zone name task Id relaunch default body
// swagger:model postDomainZoneZoneNameTaskIdRelaunchDefaultBody
...
func (m *PostDomainZoneZoneNameTaskIDRelaunchDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameTaskIDRelaunchDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameTaskIDRelaunchDefaultBody

...
// PutDomainServiceNameServiceInfosDefaultBody put domain service name service infos default body
// swagger:model putDomainServiceNameServiceInfosDefaultBody
...
func (m *PutDomainServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainServiceNameServiceInfosDefaultBody

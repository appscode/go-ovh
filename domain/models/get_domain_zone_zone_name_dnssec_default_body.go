...
// GetDomainZoneZoneNameDnssecDefaultBody get domain zone zone name dnssec default body
// swagger:model getDomainZoneZoneNameDnssecDefaultBody
...
func (m *GetDomainZoneZoneNameDnssecDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDnssecDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDnssecDefaultBody

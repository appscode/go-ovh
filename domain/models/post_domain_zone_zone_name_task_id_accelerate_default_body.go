...
// PostDomainZoneZoneNameTaskIDAccelerateDefaultBody post domain zone zone name task Id accelerate default body
// swagger:model postDomainZoneZoneNameTaskIdAccelerateDefaultBody
...
func (m *PostDomainZoneZoneNameTaskIDAccelerateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameTaskIDAccelerateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameTaskIDAccelerateDefaultBody

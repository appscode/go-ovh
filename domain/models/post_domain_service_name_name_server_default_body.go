...
// PostDomainServiceNameNameServerDefaultBody post domain service name name server default body
// swagger:model postDomainServiceNameNameServerDefaultBody
...
func (m *PostDomainServiceNameNameServerDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameNameServerDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameNameServerDefaultBody

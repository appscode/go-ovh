...
// PostDomainDataAfnicAssociationInformationDefaultBody post domain data afnic association information default body
// swagger:model postDomainDataAfnicAssociationInformationDefaultBody
...
func (m *PostDomainDataAfnicAssociationInformationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainDataAfnicAssociationInformationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainDataAfnicAssociationInformationDefaultBody

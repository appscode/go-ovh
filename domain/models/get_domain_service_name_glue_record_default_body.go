...
// GetDomainServiceNameGlueRecordDefaultBody get domain service name glue record default body
// swagger:model getDomainServiceNameGlueRecordDefaultBody
...
func (m *GetDomainServiceNameGlueRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameGlueRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameGlueRecordDefaultBody

...
// PostDomainServiceNameOwoDefaultBody post domain service name owo default body
// swagger:model postDomainServiceNameOwoDefaultBody
...
func (m *PostDomainServiceNameOwoDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameOwoDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameOwoDefaultBody

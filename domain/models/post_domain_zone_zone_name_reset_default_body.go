...
// PostDomainZoneZoneNameResetDefaultBody post domain zone zone name reset default body
// swagger:model postDomainZoneZoneNameResetDefaultBody
...
func (m *PostDomainZoneZoneNameResetDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameResetDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameResetDefaultBody

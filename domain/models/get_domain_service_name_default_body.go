...
// GetDomainServiceNameDefaultBody get domain service name default body
// swagger:model getDomainServiceNameDefaultBody
...
func (m *GetDomainServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameDefaultBody

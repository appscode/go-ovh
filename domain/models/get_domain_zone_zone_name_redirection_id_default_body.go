...
// GetDomainZoneZoneNameRedirectionIDDefaultBody get domain zone zone name redirection Id default body
// swagger:model getDomainZoneZoneNameRedirectionIdDefaultBody
...
func (m *GetDomainZoneZoneNameRedirectionIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameRedirectionIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameRedirectionIDDefaultBody

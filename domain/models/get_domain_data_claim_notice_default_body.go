...
// GetDomainDataClaimNoticeDefaultBody get domain data claim notice default body
// swagger:model getDomainDataClaimNoticeDefaultBody
...
func (m *GetDomainDataClaimNoticeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataClaimNoticeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataClaimNoticeDefaultBody

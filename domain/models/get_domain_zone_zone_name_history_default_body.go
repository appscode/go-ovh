...
// GetDomainZoneZoneNameHistoryDefaultBody get domain zone zone name history default body
// swagger:model getDomainZoneZoneNameHistoryDefaultBody
...
func (m *GetDomainZoneZoneNameHistoryDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameHistoryDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameHistoryDefaultBody

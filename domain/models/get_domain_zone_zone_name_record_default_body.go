...
// GetDomainZoneZoneNameRecordDefaultBody get domain zone zone name record default body
// swagger:model getDomainZoneZoneNameRecordDefaultBody
...
func (m *GetDomainZoneZoneNameRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameRecordDefaultBody

...
// DeleteDomainServiceNameOwoFieldDefaultBody delete domain service name owo field default body
// swagger:model deleteDomainServiceNameOwoFieldDefaultBody
...
func (m *DeleteDomainServiceNameOwoFieldDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainServiceNameOwoFieldDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainServiceNameOwoFieldDefaultBody

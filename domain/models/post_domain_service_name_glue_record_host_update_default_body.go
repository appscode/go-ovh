...
// PostDomainServiceNameGlueRecordHostUpdateDefaultBody post domain service name glue record host update default body
// swagger:model postDomainServiceNameGlueRecordHostUpdateDefaultBody
...
func (m *PostDomainServiceNameGlueRecordHostUpdateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameGlueRecordHostUpdateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameGlueRecordHostUpdateDefaultBody

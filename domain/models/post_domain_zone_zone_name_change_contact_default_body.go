...
// PostDomainZoneZoneNameChangeContactDefaultBody post domain zone zone name change contact default body
// swagger:model postDomainZoneZoneNameChangeContactDefaultBody
...
func (m *PostDomainZoneZoneNameChangeContactDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameChangeContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameChangeContactDefaultBody

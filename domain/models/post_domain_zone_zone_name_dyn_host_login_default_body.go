...
// PostDomainZoneZoneNameDynHostLoginDefaultBody post domain zone zone name dyn host login default body
// swagger:model postDomainZoneZoneNameDynHostLoginDefaultBody
...
func (m *PostDomainZoneZoneNameDynHostLoginDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameDynHostLoginDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameDynHostLoginDefaultBody

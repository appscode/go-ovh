...
// GetDomainServiceNameNameServerIDDefaultBody get domain service name name server Id default body
// swagger:model getDomainServiceNameNameServerIdDefaultBody
...
func (m *GetDomainServiceNameNameServerIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameNameServerIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameNameServerIDDefaultBody

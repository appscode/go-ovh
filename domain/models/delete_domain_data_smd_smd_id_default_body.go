...
// DeleteDomainDataSmdSmdIDDefaultBody delete domain data smd smd Id default body
// swagger:model deleteDomainDataSmdSmdIdDefaultBody
...
func (m *DeleteDomainDataSmdSmdIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainDataSmdSmdIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainDataSmdSmdIDDefaultBody

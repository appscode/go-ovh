...
// GetDomainZoneZoneNameExportDefaultBody get domain zone zone name export default body
// swagger:model getDomainZoneZoneNameExportDefaultBody
...
func (m *GetDomainZoneZoneNameExportDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameExportDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameExportDefaultBody

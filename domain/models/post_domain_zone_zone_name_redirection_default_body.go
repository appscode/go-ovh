...
// PostDomainZoneZoneNameRedirectionDefaultBody post domain zone zone name redirection default body
// swagger:model postDomainZoneZoneNameRedirectionDefaultBody
...
func (m *PostDomainZoneZoneNameRedirectionDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameRedirectionDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameRedirectionDefaultBody

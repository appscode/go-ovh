...
// DeleteDomainZoneZoneNameRedirectionIDDefaultBody delete domain zone zone name redirection Id default body
// swagger:model deleteDomainZoneZoneNameRedirectionIdDefaultBody
...
func (m *DeleteDomainZoneZoneNameRedirectionIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainZoneZoneNameRedirectionIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainZoneZoneNameRedirectionIDDefaultBody

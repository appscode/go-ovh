...
// PutDomainZoneZoneNameRedirectionIDDefaultBody put domain zone zone name redirection Id default body
// swagger:model putDomainZoneZoneNameRedirectionIdDefaultBody
...
func (m *PutDomainZoneZoneNameRedirectionIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameRedirectionIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameRedirectionIDDefaultBody

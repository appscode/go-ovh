...
// GetDomainServiceNameGlueRecordHostDefaultBody get domain service name glue record host default body
// swagger:model getDomainServiceNameGlueRecordHostDefaultBody
...
func (m *GetDomainServiceNameGlueRecordHostDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameGlueRecordHostDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameGlueRecordHostDefaultBody

...
// PostDomainZoneZoneNameImportDefaultBody post domain zone zone name import default body
// swagger:model postDomainZoneZoneNameImportDefaultBody
...
func (m *PostDomainZoneZoneNameImportDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameImportDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameImportDefaultBody

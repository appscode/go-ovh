...
// PostDomainZoneZoneNameTerminateDefaultBody post domain zone zone name terminate default body
// swagger:model postDomainZoneZoneNameTerminateDefaultBody
...
func (m *PostDomainZoneZoneNameTerminateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameTerminateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameTerminateDefaultBody

...
// GetDomainDataProContactDefaultBody get domain data pro contact default body
// swagger:model getDomainDataProContactDefaultBody
...
func (m *GetDomainDataProContactDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataProContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataProContactDefaultBody

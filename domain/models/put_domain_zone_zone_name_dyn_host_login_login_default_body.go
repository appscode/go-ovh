...
// PutDomainZoneZoneNameDynHostLoginLoginDefaultBody put domain zone zone name dyn host login login default body
// swagger:model putDomainZoneZoneNameDynHostLoginLoginDefaultBody
...
func (m *PutDomainZoneZoneNameDynHostLoginLoginDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameDynHostLoginLoginDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameDynHostLoginLoginDefaultBody

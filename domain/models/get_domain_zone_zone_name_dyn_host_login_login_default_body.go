...
// GetDomainZoneZoneNameDynHostLoginLoginDefaultBody get domain zone zone name dyn host login login default body
// swagger:model getDomainZoneZoneNameDynHostLoginLoginDefaultBody
...
func (m *GetDomainZoneZoneNameDynHostLoginLoginDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDynHostLoginLoginDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDynHostLoginLoginDefaultBody

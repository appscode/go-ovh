...
// GetDomainZoneZoneNameDynHostRecordIDDefaultBody get domain zone zone name dyn host record Id default body
// swagger:model getDomainZoneZoneNameDynHostRecordIdDefaultBody
...
func (m *GetDomainZoneZoneNameDynHostRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDynHostRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDynHostRecordIDDefaultBody

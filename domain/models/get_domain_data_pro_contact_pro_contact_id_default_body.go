...
// GetDomainDataProContactProContactIDDefaultBody get domain data pro contact pro contact Id default body
// swagger:model getDomainDataProContactProContactIdDefaultBody
...
func (m *GetDomainDataProContactProContactIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataProContactProContactIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataProContactProContactIDDefaultBody

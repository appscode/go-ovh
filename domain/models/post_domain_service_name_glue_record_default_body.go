...
// PostDomainServiceNameGlueRecordDefaultBody post domain service name glue record default body
// swagger:model postDomainServiceNameGlueRecordDefaultBody
...
func (m *PostDomainServiceNameGlueRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameGlueRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameGlueRecordDefaultBody

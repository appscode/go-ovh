...
// GetDomainZoneZoneNameDynHostLoginDefaultBody get domain zone zone name dyn host login default body
// swagger:model getDomainZoneZoneNameDynHostLoginDefaultBody
...
func (m *GetDomainZoneZoneNameDynHostLoginDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDynHostLoginDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDynHostLoginDefaultBody

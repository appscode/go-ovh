...
// PostDomainZoneZoneNameRefreshDefaultBody post domain zone zone name refresh default body
// swagger:model postDomainZoneZoneNameRefreshDefaultBody
...
func (m *PostDomainZoneZoneNameRefreshDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameRefreshDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameRefreshDefaultBody

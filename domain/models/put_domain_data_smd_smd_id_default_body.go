...
// PutDomainDataSmdSmdIDDefaultBody put domain data smd smd Id default body
// swagger:model putDomainDataSmdSmdIdDefaultBody
...
func (m *PutDomainDataSmdSmdIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainDataSmdSmdIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainDataSmdSmdIDDefaultBody

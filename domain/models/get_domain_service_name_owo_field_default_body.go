...
// GetDomainServiceNameOwoFieldDefaultBody get domain service name owo field default body
// swagger:model getDomainServiceNameOwoFieldDefaultBody
...
func (m *GetDomainServiceNameOwoFieldDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameOwoFieldDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameOwoFieldDefaultBody

...
// GetDomainDataAfnicAssociationInformationDefaultBody get domain data afnic association information default body
// swagger:model getDomainDataAfnicAssociationInformationDefaultBody
...
func (m *GetDomainDataAfnicAssociationInformationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataAfnicAssociationInformationDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataAfnicAssociationInformationDefaultBody

...
// GetDomainServiceNameTaskIDDefaultBody get domain service name task Id default body
// swagger:model getDomainServiceNameTaskIdDefaultBody
...
func (m *GetDomainServiceNameTaskIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameTaskIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameTaskIDDefaultBody

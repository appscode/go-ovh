...
// DeleteDomainZoneZoneNameDynHostRecordIDDefaultBody delete domain zone zone name dyn host record Id default body
// swagger:model deleteDomainZoneZoneNameDynHostRecordIdDefaultBody
...
func (m *DeleteDomainZoneZoneNameDynHostRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainZoneZoneNameDynHostRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainZoneZoneNameDynHostRecordIDDefaultBody

...
// GetDomainZoneZoneNameDynHostRecordDefaultBody get domain zone zone name dyn host record default body
// swagger:model getDomainZoneZoneNameDynHostRecordDefaultBody
...
func (m *GetDomainZoneZoneNameDynHostRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDynHostRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDynHostRecordDefaultBody

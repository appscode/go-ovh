...
// PostDomainServiceNameUkOutgoingTransferDefaultBody post domain service name uk outgoing transfer default body
// swagger:model postDomainServiceNameUkOutgoingTransferDefaultBody
...
func (m *PostDomainServiceNameUkOutgoingTransferDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameUkOutgoingTransferDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameUkOutgoingTransferDefaultBody

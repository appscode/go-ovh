...
// GetDomainServiceNameDsRecordIDDefaultBody get domain service name ds record Id default body
// swagger:model getDomainServiceNameDsRecordIdDefaultBody
...
func (m *GetDomainServiceNameDsRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameDsRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameDsRecordIDDefaultBody

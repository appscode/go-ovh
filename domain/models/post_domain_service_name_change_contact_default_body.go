...
// PostDomainServiceNameChangeContactDefaultBody post domain service name change contact default body
// swagger:model postDomainServiceNameChangeContactDefaultBody
...
func (m *PostDomainServiceNameChangeContactDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameChangeContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameChangeContactDefaultBody

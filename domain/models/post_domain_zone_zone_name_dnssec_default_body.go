...
// PostDomainZoneZoneNameDnssecDefaultBody post domain zone zone name dnssec default body
// swagger:model postDomainZoneZoneNameDnssecDefaultBody
...
func (m *PostDomainZoneZoneNameDnssecDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameDnssecDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameDnssecDefaultBody

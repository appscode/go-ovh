...
// PutDomainServiceNameDefaultBody put domain service name default body
// swagger:model putDomainServiceNameDefaultBody
...
func (m *PutDomainServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainServiceNameDefaultBody

...
// PostDomainServiceNameTaskIDAccelerateDefaultBody post domain service name task Id accelerate default body
// swagger:model postDomainServiceNameTaskIdAccelerateDefaultBody
...
func (m *PostDomainServiceNameTaskIDAccelerateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameTaskIDAccelerateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameTaskIDAccelerateDefaultBody

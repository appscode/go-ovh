...
// GetDomainServiceNameServiceInfosDefaultBody get domain service name service infos default body
// swagger:model getDomainServiceNameServiceInfosDefaultBody
...
func (m *GetDomainServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameServiceInfosDefaultBody

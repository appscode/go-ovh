...
// GetDomainZoneZoneNameDefaultBody get domain zone zone name default body
// swagger:model getDomainZoneZoneNameDefaultBody
...
func (m *GetDomainZoneZoneNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameDefaultBody

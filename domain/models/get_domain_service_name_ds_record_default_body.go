...
// GetDomainServiceNameDsRecordDefaultBody get domain service name ds record default body
// swagger:model getDomainServiceNameDsRecordDefaultBody
...
func (m *GetDomainServiceNameDsRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameDsRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameDsRecordDefaultBody

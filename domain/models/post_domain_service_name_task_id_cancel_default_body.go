...
// PostDomainServiceNameTaskIDCancelDefaultBody post domain service name task Id cancel default body
// swagger:model postDomainServiceNameTaskIdCancelDefaultBody
...
func (m *PostDomainServiceNameTaskIDCancelDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameTaskIDCancelDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameTaskIDCancelDefaultBody

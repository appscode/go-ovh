...
// DeleteDomainServiceNameGlueRecordHostDefaultBody delete domain service name glue record host default body
// swagger:model deleteDomainServiceNameGlueRecordHostDefaultBody
...
func (m *DeleteDomainServiceNameGlueRecordHostDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainServiceNameGlueRecordHostDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainServiceNameGlueRecordHostDefaultBody

...
// PostDomainZoneZoneNameDynHostLoginLoginChangePasswordDefaultBody post domain zone zone name dyn host login login change password default body
// swagger:model postDomainZoneZoneNameDynHostLoginLoginChangePasswordDefaultBody
...
func (m *PostDomainZoneZoneNameDynHostLoginLoginChangePasswordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameDynHostLoginLoginChangePasswordDefaultBody

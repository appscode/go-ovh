...
// PostDomainServiceNameActivateZoneDefaultBody post domain service name activate zone default body
// swagger:model postDomainServiceNameActivateZoneDefaultBody
...
func (m *PostDomainServiceNameActivateZoneDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameActivateZoneDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameActivateZoneDefaultBody

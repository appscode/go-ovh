...
// GetDomainDataSmdSmdIDDefaultBody get domain data smd smd Id default body
// swagger:model getDomainDataSmdSmdIdDefaultBody
...
func (m *GetDomainDataSmdSmdIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataSmdSmdIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataSmdSmdIDDefaultBody

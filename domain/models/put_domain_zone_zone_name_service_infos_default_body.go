...
// PutDomainZoneZoneNameServiceInfosDefaultBody put domain zone zone name service infos default body
// swagger:model putDomainZoneZoneNameServiceInfosDefaultBody
...
func (m *PutDomainZoneZoneNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameServiceInfosDefaultBody

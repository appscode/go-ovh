...
// GetDomainDataExtensionDefaultBody get domain data extension default body
// swagger:model getDomainDataExtensionDefaultBody
...
func (m *GetDomainDataExtensionDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainDataExtensionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainDataExtensionDefaultBody

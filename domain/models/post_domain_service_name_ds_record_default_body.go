...
// PostDomainServiceNameDsRecordDefaultBody post domain service name ds record default body
// swagger:model postDomainServiceNameDsRecordDefaultBody
...
func (m *PostDomainServiceNameDsRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameDsRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameDsRecordDefaultBody

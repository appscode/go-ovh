...
// GetDomainServiceNameTaskDefaultBody get domain service name task default body
// swagger:model getDomainServiceNameTaskDefaultBody
...
func (m *GetDomainServiceNameTaskDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameTaskDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameTaskDefaultBody

...
// GetDomainZoneZoneNameHistoryCreationDateDefaultBody get domain zone zone name history creation date default body
// swagger:model getDomainZoneZoneNameHistoryCreationDateDefaultBody
...
func (m *GetDomainZoneZoneNameHistoryCreationDateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameHistoryCreationDateDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameHistoryCreationDateDefaultBody

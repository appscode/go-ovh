...
// GetDomainServiceNameAuthInfoDefaultBody get domain service name auth info default body
// swagger:model getDomainServiceNameAuthInfoDefaultBody
...
func (m *GetDomainServiceNameAuthInfoDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameAuthInfoDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameAuthInfoDefaultBody

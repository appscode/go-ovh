...
// GetDomainZoneZoneNameStatusDefaultBody get domain zone zone name status default body
// swagger:model getDomainZoneZoneNameStatusDefaultBody
...
func (m *GetDomainZoneZoneNameStatusDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameStatusDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameStatusDefaultBody

...
// DeleteDomainZoneZoneNameRecordIDDefaultBody delete domain zone zone name record Id default body
// swagger:model deleteDomainZoneZoneNameRecordIdDefaultBody
...
func (m *DeleteDomainZoneZoneNameRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteDomainZoneZoneNameRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteDomainZoneZoneNameRecordIDDefaultBody

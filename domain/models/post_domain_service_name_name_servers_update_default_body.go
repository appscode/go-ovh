...
// PostDomainServiceNameNameServersUpdateDefaultBody post domain service name name servers update default body
// swagger:model postDomainServiceNameNameServersUpdateDefaultBody
...
func (m *PostDomainServiceNameNameServersUpdateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameNameServersUpdateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameNameServersUpdateDefaultBody

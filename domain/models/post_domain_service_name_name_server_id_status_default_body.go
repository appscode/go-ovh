...
// PostDomainServiceNameNameServerIDStatusDefaultBody post domain service name name server Id status default body
// swagger:model postDomainServiceNameNameServerIdStatusDefaultBody
...
func (m *PostDomainServiceNameNameServerIDStatusDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainServiceNameNameServerIDStatusDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainServiceNameNameServerIDStatusDefaultBody

...
// GetDomainZoneZoneNameRecordIDDefaultBody get domain zone zone name record Id default body
// swagger:model getDomainZoneZoneNameRecordIdDefaultBody
...
func (m *GetDomainZoneZoneNameRecordIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameRecordIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameRecordIDDefaultBody

...
// PostDomainZoneZoneNameRecordDefaultBody post domain zone zone name record default body
// swagger:model postDomainZoneZoneNameRecordDefaultBody
...
func (m *PostDomainZoneZoneNameRecordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameRecordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameRecordDefaultBody

...
// GetDomainZoneZoneNameServiceInfosDefaultBody get domain zone zone name service infos default body
// swagger:model getDomainZoneZoneNameServiceInfosDefaultBody
...
func (m *GetDomainZoneZoneNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainZoneZoneNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainZoneZoneNameServiceInfosDefaultBody

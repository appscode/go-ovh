...
// PostDomainZoneZoneNameConfirmTerminationDefaultBody post domain zone zone name confirm termination default body
// swagger:model postDomainZoneZoneNameConfirmTerminationDefaultBody
...
func (m *PostDomainZoneZoneNameConfirmTerminationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostDomainZoneZoneNameConfirmTerminationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostDomainZoneZoneNameConfirmTerminationDefaultBody

...
// PutDomainZoneZoneNameSoaDefaultBody put domain zone zone name soa default body
// swagger:model putDomainZoneZoneNameSoaDefaultBody
...
func (m *PutDomainZoneZoneNameSoaDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutDomainZoneZoneNameSoaDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutDomainZoneZoneNameSoaDefaultBody

...
// GetDomainServiceNameNameServerDefaultBody get domain service name name server default body
// swagger:model getDomainServiceNameNameServerDefaultBody
...
func (m *GetDomainServiceNameNameServerDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetDomainServiceNameNameServerDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetDomainServiceNameNameServerDefaultBody

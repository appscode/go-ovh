...
func (o *PostDomainServiceNameTaskIDCancelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainServiceNameTaskIDCancelOK()
	...
	default:
		result := NewPostDomainServiceNameTaskIDCancelDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainServiceNameTaskIDCancelOK() *PostDomainServiceNameTaskIDCancelOK {
	return &PostDomainServiceNameTaskIDCancelOK{}
}
...
func (o *PostDomainServiceNameTaskIDCancelOK) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/task/{id}/cancel][%d] postDomainServiceNameTaskIdCancelOK ", 200)
}

func (o *PostDomainServiceNameTaskIDCancelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainServiceNameTaskIDCancelDefault(code int) *PostDomainServiceNameTaskIDCancelDefault {
	return &PostDomainServiceNameTaskIDCancelDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainServiceNameTaskIDCancelDefault) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/task/{id}/cancel][%d] PostDomainServiceNameTaskIDCancel default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainServiceNameTaskIDCancelDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainServiceNameTaskIDCancelDefaultBody)

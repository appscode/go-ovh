...
func (o *GetDomainDataSmdReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetDomainDataSmdDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetDomainDataSmdOK) Error() string {
	return fmt.Sprintf("[GET /domain/data/smd][%d] getDomainDataSmdOK  %+v", 200, o.Payload)
}

func (o *GetDomainDataSmdOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetDomainDataSmdDefault(code int) *GetDomainDataSmdDefault {
	return &GetDomainDataSmdDefault{
		_statusCode: code,
	}
}
...
func (o *GetDomainDataSmdDefault) Error() string {
	return fmt.Sprintf("[GET /domain/data/smd][%d] GetDomainDataSmd default  %+v", o._statusCode, o.Payload)
}

func (o *GetDomainDataSmdDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDomainDataSmdDefaultBody)

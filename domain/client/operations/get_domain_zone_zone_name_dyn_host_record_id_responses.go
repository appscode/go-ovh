...
func (o *GetDomainZoneZoneNameDynHostRecordIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDomainZoneZoneNameDynHostRecordIDOK()
	...
	default:
		result := NewGetDomainZoneZoneNameDynHostRecordIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetDomainZoneZoneNameDynHostRecordIDOK() *GetDomainZoneZoneNameDynHostRecordIDOK {
	return &GetDomainZoneZoneNameDynHostRecordIDOK{}
}
...
func (o *GetDomainZoneZoneNameDynHostRecordIDOK) Error() string {
	return fmt.Sprintf("[GET /domain/zone/{zoneName}/dynHost/record/{id}][%d] getDomainZoneZoneNameDynHostRecordIdOK  %+v", 200, o.Payload)
}

func (o *GetDomainZoneZoneNameDynHostRecordIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DomainZoneDynHostRecord)
...
func NewGetDomainZoneZoneNameDynHostRecordIDDefault(code int) *GetDomainZoneZoneNameDynHostRecordIDDefault {
	return &GetDomainZoneZoneNameDynHostRecordIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetDomainZoneZoneNameDynHostRecordIDDefault) Error() string {
	return fmt.Sprintf("[GET /domain/zone/{zoneName}/dynHost/record/{id}][%d] GetDomainZoneZoneNameDynHostRecordID default  %+v", o._statusCode, o.Payload)
}

func (o *GetDomainZoneZoneNameDynHostRecordIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDomainZoneZoneNameDynHostRecordIDDefaultBody)

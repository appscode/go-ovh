...
func (o *DeleteDomainZoneZoneNameRecordIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteDomainZoneZoneNameRecordIDOK()
	...
	default:
		result := NewDeleteDomainZoneZoneNameRecordIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteDomainZoneZoneNameRecordIDOK() *DeleteDomainZoneZoneNameRecordIDOK {
	return &DeleteDomainZoneZoneNameRecordIDOK{}
}
...
func (o *DeleteDomainZoneZoneNameRecordIDOK) Error() string {
	return fmt.Sprintf("[DELETE /domain/zone/{zoneName}/record/{id}][%d] deleteDomainZoneZoneNameRecordIdOK ", 200)
}

func (o *DeleteDomainZoneZoneNameRecordIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteDomainZoneZoneNameRecordIDDefault(code int) *DeleteDomainZoneZoneNameRecordIDDefault {
	return &DeleteDomainZoneZoneNameRecordIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteDomainZoneZoneNameRecordIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /domain/zone/{zoneName}/record/{id}][%d] DeleteDomainZoneZoneNameRecordID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteDomainZoneZoneNameRecordIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteDomainZoneZoneNameRecordIDDefaultBody)

...
func (o *PostDomainServiceNameActivateZoneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainServiceNameActivateZoneOK()
	...
	default:
		result := NewPostDomainServiceNameActivateZoneDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainServiceNameActivateZoneOK() *PostDomainServiceNameActivateZoneOK {
	return &PostDomainServiceNameActivateZoneOK{}
}
...
func (o *PostDomainServiceNameActivateZoneOK) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/activateZone][%d] postDomainServiceNameActivateZoneOK ", 200)
}

func (o *PostDomainServiceNameActivateZoneOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainServiceNameActivateZoneDefault(code int) *PostDomainServiceNameActivateZoneDefault {
	return &PostDomainServiceNameActivateZoneDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainServiceNameActivateZoneDefault) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/activateZone][%d] PostDomainServiceNameActivateZone default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainServiceNameActivateZoneDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainServiceNameActivateZoneDefaultBody)

...
func (o *PostDomainZoneZoneNameDynHostRecordReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainZoneZoneNameDynHostRecordOK()
	...
	default:
		result := NewPostDomainZoneZoneNameDynHostRecordDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainZoneZoneNameDynHostRecordOK() *PostDomainZoneZoneNameDynHostRecordOK {
	return &PostDomainZoneZoneNameDynHostRecordOK{}
}
...
func (o *PostDomainZoneZoneNameDynHostRecordOK) Error() string {
	return fmt.Sprintf("[POST /domain/zone/{zoneName}/dynHost/record][%d] postDomainZoneZoneNameDynHostRecordOK  %+v", 200, o.Payload)
}

func (o *PostDomainZoneZoneNameDynHostRecordOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainZoneZoneNameDynHostRecordDefault(code int) *PostDomainZoneZoneNameDynHostRecordDefault {
	return &PostDomainZoneZoneNameDynHostRecordDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainZoneZoneNameDynHostRecordDefault) Error() string {
	return fmt.Sprintf("[POST /domain/zone/{zoneName}/dynHost/record][%d] PostDomainZoneZoneNameDynHostRecord default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainZoneZoneNameDynHostRecordDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainZoneZoneNameDynHostRecordDefaultBody)

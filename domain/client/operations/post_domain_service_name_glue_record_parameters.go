...
// NewPostDomainServiceNameGlueRecordParams creates a new PostDomainServiceNameGlueRecordParams object
// with the default values initialized.
func NewPostDomainServiceNameGlueRecordParams() *PostDomainServiceNameGlueRecordParams {
	var ()
	return &PostDomainServiceNameGlueRecordParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostDomainServiceNameGlueRecordParamsWithTimeout creates a new PostDomainServiceNameGlueRecordParams object
...
// NewPostDomainServiceNameGlueRecordParamsWithContext creates a new PostDomainServiceNameGlueRecordParams object
...
// NewPostDomainServiceNameGlueRecordParamsWithHTTPClient creates a new PostDomainServiceNameGlueRecordParams object
...
/*PostDomainServiceNameGlueRecordParams contains all the parameters to send to the API endpoint
for the post domain service name glue record operation typically these are written to a http.Request
*/
...
func (o *PostDomainServiceNameGlueRecordParams) WithDomainGlueRecordPost(domainGlueRecordPost *models.PostDomainServiceNameGlueRecordParamsBody) *PostDomainServiceNameGlueRecordParams {
	o.SetDomainGlueRecordPost(domainGlueRecordPost)
	return o
}
...
func (o *PostDomainServiceNameGlueRecordParams) SetDomainGlueRecordPost(domainGlueRecordPost *models.PostDomainServiceNameGlueRecordParamsBody) {
	o.DomainGlueRecordPost = domainGlueRecordPost
}
...
func (o *PostDomainServiceNameGlueRecordParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DomainGlueRecordPost != nil {
		if err := r.SetBodyParam(o.DomainGlueRecordPost); err != nil {
			return err
		}
	}

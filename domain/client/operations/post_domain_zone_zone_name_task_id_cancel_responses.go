...
func (o *PostDomainZoneZoneNameTaskIDCancelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainZoneZoneNameTaskIDCancelOK()
	...
	default:
		result := NewPostDomainZoneZoneNameTaskIDCancelDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainZoneZoneNameTaskIDCancelOK() *PostDomainZoneZoneNameTaskIDCancelOK {
	return &PostDomainZoneZoneNameTaskIDCancelOK{}
}
...
func (o *PostDomainZoneZoneNameTaskIDCancelOK) Error() string {
	return fmt.Sprintf("[POST /domain/zone/{zoneName}/task/{id}/cancel][%d] postDomainZoneZoneNameTaskIdCancelOK ", 200)
}

func (o *PostDomainZoneZoneNameTaskIDCancelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainZoneZoneNameTaskIDCancelDefault(code int) *PostDomainZoneZoneNameTaskIDCancelDefault {
	return &PostDomainZoneZoneNameTaskIDCancelDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainZoneZoneNameTaskIDCancelDefault) Error() string {
	return fmt.Sprintf("[POST /domain/zone/{zoneName}/task/{id}/cancel][%d] PostDomainZoneZoneNameTaskIDCancel default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainZoneZoneNameTaskIDCancelDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainZoneZoneNameTaskIDCancelDefaultBody)

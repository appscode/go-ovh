...
func (o *GetDomainDataAfnicAssociationInformationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDomainDataAfnicAssociationInformationOK()
	...
	default:
		result := NewGetDomainDataAfnicAssociationInformationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetDomainDataAfnicAssociationInformationOK() *GetDomainDataAfnicAssociationInformationOK {
	return &GetDomainDataAfnicAssociationInformationOK{}
}
...
func (o *GetDomainDataAfnicAssociationInformationOK) Error() string {
	return fmt.Sprintf("[GET /domain/data/afnicAssociationInformation][%d] getDomainDataAfnicAssociationInformationOK  %+v", 200, o.Payload)
}

func (o *GetDomainDataAfnicAssociationInformationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetDomainDataAfnicAssociationInformationDefault(code int) *GetDomainDataAfnicAssociationInformationDefault {
	return &GetDomainDataAfnicAssociationInformationDefault{
		_statusCode: code,
	}
}
...
func (o *GetDomainDataAfnicAssociationInformationDefault) Error() string {
	return fmt.Sprintf("[GET /domain/data/afnicAssociationInformation][%d] GetDomainDataAfnicAssociationInformation default  %+v", o._statusCode, o.Payload)
}

func (o *GetDomainDataAfnicAssociationInformationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDomainDataAfnicAssociationInformationDefaultBody)

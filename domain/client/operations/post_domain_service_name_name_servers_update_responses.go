...
func (o *PostDomainServiceNameNameServersUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainServiceNameNameServersUpdateOK()
	...
	default:
		result := NewPostDomainServiceNameNameServersUpdateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainServiceNameNameServersUpdateOK() *PostDomainServiceNameNameServersUpdateOK {
	return &PostDomainServiceNameNameServersUpdateOK{}
}
...
func (o *PostDomainServiceNameNameServersUpdateOK) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/nameServers/update][%d] postDomainServiceNameNameServersUpdateOK  %+v", 200, o.Payload)
}

func (o *PostDomainServiceNameNameServersUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainServiceNameNameServersUpdateDefault(code int) *PostDomainServiceNameNameServersUpdateDefault {
	return &PostDomainServiceNameNameServersUpdateDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainServiceNameNameServersUpdateDefault) Error() string {
	return fmt.Sprintf("[POST /domain/{serviceName}/nameServers/update][%d] PostDomainServiceNameNameServersUpdate default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainServiceNameNameServersUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainServiceNameNameServersUpdateDefaultBody)

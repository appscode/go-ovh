...
func (o *GetDomainZoneZoneNameTaskReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDomainZoneZoneNameTaskOK()
	...
	default:
		result := NewGetDomainZoneZoneNameTaskDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetDomainZoneZoneNameTaskOK() *GetDomainZoneZoneNameTaskOK {
	return &GetDomainZoneZoneNameTaskOK{}
}
...
func (o *GetDomainZoneZoneNameTaskOK) Error() string {
	return fmt.Sprintf("[GET /domain/zone/{zoneName}/task][%d] getDomainZoneZoneNameTaskOK  %+v", 200, o.Payload)
}

func (o *GetDomainZoneZoneNameTaskOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetDomainZoneZoneNameTaskDefault(code int) *GetDomainZoneZoneNameTaskDefault {
	return &GetDomainZoneZoneNameTaskDefault{
		_statusCode: code,
	}
}
...
func (o *GetDomainZoneZoneNameTaskDefault) Error() string {
	return fmt.Sprintf("[GET /domain/zone/{zoneName}/task][%d] GetDomainZoneZoneNameTask default  %+v", o._statusCode, o.Payload)
}

func (o *GetDomainZoneZoneNameTaskDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDomainZoneZoneNameTaskDefaultBody)

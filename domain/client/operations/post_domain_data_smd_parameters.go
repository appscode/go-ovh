...
// NewPostDomainDataSmdParams creates a new PostDomainDataSmdParams object
// with the default values initialized.
func NewPostDomainDataSmdParams() *PostDomainDataSmdParams {
	var ()
	return &PostDomainDataSmdParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostDomainDataSmdParamsWithTimeout creates a new PostDomainDataSmdParams object
...
// NewPostDomainDataSmdParamsWithContext creates a new PostDomainDataSmdParams object
...
// NewPostDomainDataSmdParamsWithHTTPClient creates a new PostDomainDataSmdParams object
...
/*PostDomainDataSmdParams contains all the parameters to send to the API endpoint
for the post domain data smd operation typically these are written to a http.Request
*/
...
func (o *PostDomainDataSmdParams) WithDomainDataSmdPost(domainDataSmdPost *models.PostDomainDataSmdParamsBody) *PostDomainDataSmdParams {
	o.SetDomainDataSmdPost(domainDataSmdPost)
	return o
}
...
func (o *PostDomainDataSmdParams) SetDomainDataSmdPost(domainDataSmdPost *models.PostDomainDataSmdParamsBody) {
	o.DomainDataSmdPost = domainDataSmdPost
}
...
func (o *PostDomainDataSmdParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DomainDataSmdPost != nil {
		if err := r.SetBodyParam(o.DomainDataSmdPost); err != nil {
			return err
		}
	}

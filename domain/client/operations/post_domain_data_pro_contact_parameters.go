...
// NewPostDomainDataProContactParams creates a new PostDomainDataProContactParams object
// with the default values initialized.
func NewPostDomainDataProContactParams() *PostDomainDataProContactParams {
	var ()
	return &PostDomainDataProContactParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostDomainDataProContactParamsWithTimeout creates a new PostDomainDataProContactParams object
...
// NewPostDomainDataProContactParamsWithContext creates a new PostDomainDataProContactParams object
...
// NewPostDomainDataProContactParamsWithHTTPClient creates a new PostDomainDataProContactParams object
...
/*PostDomainDataProContactParams contains all the parameters to send to the API endpoint
for the post domain data pro contact operation typically these are written to a http.Request
*/
...
func (o *PostDomainDataProContactParams) WithDomainDataProContactPost(domainDataProContactPost *models.PostDomainDataProContactParamsBody) *PostDomainDataProContactParams {
	o.SetDomainDataProContactPost(domainDataProContactPost)
	return o
}
...
func (o *PostDomainDataProContactParams) SetDomainDataProContactPost(domainDataProContactPost *models.PostDomainDataProContactParamsBody) {
	o.DomainDataProContactPost = domainDataProContactPost
}
...
func (o *PostDomainDataProContactParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DomainDataProContactPost != nil {
		if err := r.SetBodyParam(o.DomainDataProContactPost); err != nil {
			return err
		}
	}

...
// NewGetDomainZoneZoneNameDnssecParams creates a new GetDomainZoneZoneNameDnssecParams object
// with the default values initialized.
func NewGetDomainZoneZoneNameDnssecParams() *GetDomainZoneZoneNameDnssecParams {
	var ()
	return &GetDomainZoneZoneNameDnssecParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetDomainZoneZoneNameDnssecParamsWithTimeout creates a new GetDomainZoneZoneNameDnssecParams object
...
// NewGetDomainZoneZoneNameDnssecParamsWithContext creates a new GetDomainZoneZoneNameDnssecParams object
...
// NewGetDomainZoneZoneNameDnssecParamsWithHTTPClient creates a new GetDomainZoneZoneNameDnssecParams object
...
/*GetDomainZoneZoneNameDnssecParams contains all the parameters to send to the API endpoint
for the get domain zone zone name dnssec operation typically these are written to a http.Request
*/

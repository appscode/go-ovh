...
func (o *PutDomainServiceNameServiceInfosReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutDomainServiceNameServiceInfosOK()
	...
	default:
		result := NewPutDomainServiceNameServiceInfosDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutDomainServiceNameServiceInfosOK() *PutDomainServiceNameServiceInfosOK {
	return &PutDomainServiceNameServiceInfosOK{}
}
...
func (o *PutDomainServiceNameServiceInfosOK) Error() string {
	return fmt.Sprintf("[PUT /domain/{serviceName}/serviceInfos][%d] putDomainServiceNameServiceInfosOK ", 200)
}

func (o *PutDomainServiceNameServiceInfosOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutDomainServiceNameServiceInfosDefault(code int) *PutDomainServiceNameServiceInfosDefault {
	return &PutDomainServiceNameServiceInfosDefault{
		_statusCode: code,
	}
}
...
func (o *PutDomainServiceNameServiceInfosDefault) Error() string {
	return fmt.Sprintf("[PUT /domain/{serviceName}/serviceInfos][%d] PutDomainServiceNameServiceInfos default  %+v", o._statusCode, o.Payload)
}

func (o *PutDomainServiceNameServiceInfosDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutDomainServiceNameServiceInfosDefaultBody)

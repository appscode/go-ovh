...
func (o *PutDomainServiceNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutDomainServiceNameOK()
	...
	default:
		result := NewPutDomainServiceNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PutDomainServiceNameOK) Error() string {
	return fmt.Sprintf("[PUT /domain/{serviceName}][%d] putDomainServiceNameOK ", 200)
}

func (o *PutDomainServiceNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutDomainServiceNameDefault(code int) *PutDomainServiceNameDefault {
	return &PutDomainServiceNameDefault{
		_statusCode: code,
	}
}
...
func (o *PutDomainServiceNameDefault) Error() string {
	return fmt.Sprintf("[PUT /domain/{serviceName}][%d] PutDomainServiceName default  %+v", o._statusCode, o.Payload)
}

func (o *PutDomainServiceNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutDomainServiceNameDefaultBody)

...
func (o *PostDomainDataAfnicCorporationTrademarkInformationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostDomainDataAfnicCorporationTrademarkInformationOK()
	...
	default:
		result := NewPostDomainDataAfnicCorporationTrademarkInformationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostDomainDataAfnicCorporationTrademarkInformationOK() *PostDomainDataAfnicCorporationTrademarkInformationOK {
	return &PostDomainDataAfnicCorporationTrademarkInformationOK{}
}
...
func (o *PostDomainDataAfnicCorporationTrademarkInformationOK) Error() string {
	return fmt.Sprintf("[POST /domain/data/afnicCorporationTrademarkInformation][%d] postDomainDataAfnicCorporationTrademarkInformationOK  %+v", 200, o.Payload)
}

func (o *PostDomainDataAfnicCorporationTrademarkInformationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostDomainDataAfnicCorporationTrademarkInformationDefault(code int) *PostDomainDataAfnicCorporationTrademarkInformationDefault {
	return &PostDomainDataAfnicCorporationTrademarkInformationDefault{
		_statusCode: code,
	}
}
...
func (o *PostDomainDataAfnicCorporationTrademarkInformationDefault) Error() string {
	return fmt.Sprintf("[POST /domain/data/afnicCorporationTrademarkInformation][%d] PostDomainDataAfnicCorporationTrademarkInformation default  %+v", o._statusCode, o.Payload)
}

func (o *PostDomainDataAfnicCorporationTrademarkInformationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostDomainDataAfnicCorporationTrademarkInformationDefaultBody)

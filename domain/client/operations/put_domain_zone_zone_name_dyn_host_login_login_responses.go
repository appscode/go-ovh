...
func (o *PutDomainZoneZoneNameDynHostLoginLoginReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutDomainZoneZoneNameDynHostLoginLoginOK()
	...
	default:
		result := NewPutDomainZoneZoneNameDynHostLoginLoginDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutDomainZoneZoneNameDynHostLoginLoginOK() *PutDomainZoneZoneNameDynHostLoginLoginOK {
	return &PutDomainZoneZoneNameDynHostLoginLoginOK{}
}
...
func (o *PutDomainZoneZoneNameDynHostLoginLoginOK) Error() string {
	return fmt.Sprintf("[PUT /domain/zone/{zoneName}/dynHost/login/{login}][%d] putDomainZoneZoneNameDynHostLoginLoginOK ", 200)
}

func (o *PutDomainZoneZoneNameDynHostLoginLoginOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutDomainZoneZoneNameDynHostLoginLoginDefault(code int) *PutDomainZoneZoneNameDynHostLoginLoginDefault {
	return &PutDomainZoneZoneNameDynHostLoginLoginDefault{
		_statusCode: code,
	}
}
...
func (o *PutDomainZoneZoneNameDynHostLoginLoginDefault) Error() string {
	return fmt.Sprintf("[PUT /domain/zone/{zoneName}/dynHost/login/{login}][%d] PutDomainZoneZoneNameDynHostLoginLogin default  %+v", o._statusCode, o.Payload)
}

func (o *PutDomainZoneZoneNameDynHostLoginLoginDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutDomainZoneZoneNameDynHostLoginLoginDefaultBody)

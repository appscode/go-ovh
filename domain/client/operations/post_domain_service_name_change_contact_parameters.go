...
// NewPostDomainServiceNameChangeContactParams creates a new PostDomainServiceNameChangeContactParams object
// with the default values initialized.
func NewPostDomainServiceNameChangeContactParams() *PostDomainServiceNameChangeContactParams {
	var ()
	return &PostDomainServiceNameChangeContactParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostDomainServiceNameChangeContactParamsWithTimeout creates a new PostDomainServiceNameChangeContactParams object
...
// NewPostDomainServiceNameChangeContactParamsWithContext creates a new PostDomainServiceNameChangeContactParams object
...
// NewPostDomainServiceNameChangeContactParamsWithHTTPClient creates a new PostDomainServiceNameChangeContactParams object
...
/*PostDomainServiceNameChangeContactParams contains all the parameters to send to the API endpoint
for the post domain service name change contact operation typically these are written to a http.Request
*/
...
func (o *PostDomainServiceNameChangeContactParams) WithDomainChangeContactPost(domainChangeContactPost *models.PostDomainServiceNameChangeContactParamsBody) *PostDomainServiceNameChangeContactParams {
	o.SetDomainChangeContactPost(domainChangeContactPost)
	return o
}
...
func (o *PostDomainServiceNameChangeContactParams) SetDomainChangeContactPost(domainChangeContactPost *models.PostDomainServiceNameChangeContactParamsBody) {
	o.DomainChangeContactPost = domainChangeContactPost
}
...
func (o *PostDomainServiceNameChangeContactParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DomainChangeContactPost != nil {
		if err := r.SetBodyParam(o.DomainChangeContactPost); err != nil {
			return err
		}
	}

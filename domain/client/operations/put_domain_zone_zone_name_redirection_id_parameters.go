...
// NewPutDomainZoneZoneNameRedirectionIDParams creates a new PutDomainZoneZoneNameRedirectionIDParams object
// with the default values initialized.
func NewPutDomainZoneZoneNameRedirectionIDParams() *PutDomainZoneZoneNameRedirectionIDParams {
	var ()
	return &PutDomainZoneZoneNameRedirectionIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutDomainZoneZoneNameRedirectionIDParamsWithTimeout creates a new PutDomainZoneZoneNameRedirectionIDParams object
...
// NewPutDomainZoneZoneNameRedirectionIDParamsWithContext creates a new PutDomainZoneZoneNameRedirectionIDParams object
...
// NewPutDomainZoneZoneNameRedirectionIDParamsWithHTTPClient creates a new PutDomainZoneZoneNameRedirectionIDParams object
...
/*PutDomainZoneZoneNameRedirectionIDParams contains all the parameters to send to the API endpoint
for the put domain zone zone name redirection ID operation typically these are written to a http.Request
*/
...
func (o *PutDomainZoneZoneNameRedirectionIDParams) WithDomainZoneRedirectionPut(domainZoneRedirectionPut *models.DomainZoneRedirection) *PutDomainZoneZoneNameRedirectionIDParams {
	o.SetDomainZoneRedirectionPut(domainZoneRedirectionPut)
	return o
}
...
func (o *PutDomainZoneZoneNameRedirectionIDParams) SetDomainZoneRedirectionPut(domainZoneRedirectionPut *models.DomainZoneRedirection) {
	o.DomainZoneRedirectionPut = domainZoneRedirectionPut
}
...
func (o *PutDomainZoneZoneNameRedirectionIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DomainZoneRedirectionPut != nil {
		if err := r.SetBodyParam(o.DomainZoneRedirectionPut); err != nil {
			return err
		}
	}

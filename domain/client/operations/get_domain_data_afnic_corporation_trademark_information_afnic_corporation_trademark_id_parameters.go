...
// NewGetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams creates a new GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams object
...
func NewGetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams() *GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams {
	var ()
	return &GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParamsWithTimeout creates a new GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams object
...
// NewGetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParamsWithContext creates a new GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams object
...
// NewGetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParamsWithHTTPClient creates a new GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams object
...
/*GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams contains all the parameters to send to the API endpoint
for the get domain data afnic corporation trademark information afnic corporation trademark ID operation typically these are written to a http.Request
*/
...
func (o *GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams) WithAfnicCorporationTrademarkID(afnicCorporationTrademarkID int64) *GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams {
	o.SetAfnicCorporationTrademarkID(afnicCorporationTrademarkID)
	return o
}
...
func (o *GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams) SetAfnicCorporationTrademarkID(afnicCorporationTrademarkID int64) {
	o.AfnicCorporationTrademarkID = afnicCorporationTrademarkID
}
...
func (o *GetDomainDataAfnicCorporationTrademarkInformationAfnicCorporationTrademarkIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param afnicCorporationTrademarkId
	if err := r.SetPathParam("afnicCorporationTrademarkId", swag.FormatInt64(o.AfnicCorporationTrademarkID)); err != nil {
		return err
	}

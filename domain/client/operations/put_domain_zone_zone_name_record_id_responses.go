...
func (o *PutDomainZoneZoneNameRecordIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutDomainZoneZoneNameRecordIDOK()
	...
	default:
		result := NewPutDomainZoneZoneNameRecordIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutDomainZoneZoneNameRecordIDOK() *PutDomainZoneZoneNameRecordIDOK {
	return &PutDomainZoneZoneNameRecordIDOK{}
}
...
func (o *PutDomainZoneZoneNameRecordIDOK) Error() string {
	return fmt.Sprintf("[PUT /domain/zone/{zoneName}/record/{id}][%d] putDomainZoneZoneNameRecordIdOK ", 200)
}

func (o *PutDomainZoneZoneNameRecordIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutDomainZoneZoneNameRecordIDDefault(code int) *PutDomainZoneZoneNameRecordIDDefault {
	return &PutDomainZoneZoneNameRecordIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutDomainZoneZoneNameRecordIDDefault) Error() string {
	return fmt.Sprintf("[PUT /domain/zone/{zoneName}/record/{id}][%d] PutDomainZoneZoneNameRecordID default  %+v", o._statusCode, o.Payload)
}

func (o *PutDomainZoneZoneNameRecordIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutDomainZoneZoneNameRecordIDDefaultBody)

...
// NewPostDomainServiceNameNameServerIDStatusParams creates a new PostDomainServiceNameNameServerIDStatusParams object
// with the default values initialized.
func NewPostDomainServiceNameNameServerIDStatusParams() *PostDomainServiceNameNameServerIDStatusParams {
	var ()
	return &PostDomainServiceNameNameServerIDStatusParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostDomainServiceNameNameServerIDStatusParamsWithTimeout creates a new PostDomainServiceNameNameServerIDStatusParams object
...
// NewPostDomainServiceNameNameServerIDStatusParamsWithContext creates a new PostDomainServiceNameNameServerIDStatusParams object
...
// NewPostDomainServiceNameNameServerIDStatusParamsWithHTTPClient creates a new PostDomainServiceNameNameServerIDStatusParams object
...
/*PostDomainServiceNameNameServerIDStatusParams contains all the parameters to send to the API endpoint
for the post domain service name name server ID status operation typically these are written to a http.Request
*/

...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameUDPFarmFarmIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameUDPFarmFarmIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameUDPFarmFarmIDOK() *PutIPLoadbalancingServiceNameUDPFarmFarmIDOK {
	return &PutIPLoadbalancingServiceNameUDPFarmFarmIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/farm/{farmId}][%d] putIpLoadbalancingServiceNameUdpFarmFarmIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameUDPFarmFarmIDDefault(code int) *PutIPLoadbalancingServiceNameUDPFarmFarmIDDefault {
	return &PutIPLoadbalancingServiceNameUDPFarmFarmIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/farm/{farmId}][%d] PutIPLoadbalancingServiceNameUDPFarmFarmID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameUDPFarmFarmIDDefaultBody)

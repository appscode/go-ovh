...
func (o *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK()
	...
	default:
		result := NewPostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK() *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK {
	return &PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK{}
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/http/farm/{farmId}/server][%d] postIpLoadbalancingServiceNameHttpFarmFarmIdServerOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault(code int) *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault {
	return &PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/http/farm/{farmId}/server][%d] PostIPLoadbalancingServiceNameHTTPFarmFarmIDServer default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadbalancingServiceNameHTTPFarmFarmIDServerDefaultBody)

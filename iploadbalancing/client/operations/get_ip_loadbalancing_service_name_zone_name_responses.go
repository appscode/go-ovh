...
func (o *GetIPLoadbalancingServiceNameZoneNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameZoneNameOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameZoneNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameZoneNameOK() *GetIPLoadbalancingServiceNameZoneNameOK {
	return &GetIPLoadbalancingServiceNameZoneNameOK{}
}
...
func (o *GetIPLoadbalancingServiceNameZoneNameOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/zone/{name}][%d] getIpLoadbalancingServiceNameZoneNameOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameZoneNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IPLBZoneIPZone)
...
func NewGetIPLoadbalancingServiceNameZoneNameDefault(code int) *GetIPLoadbalancingServiceNameZoneNameDefault {
	return &GetIPLoadbalancingServiceNameZoneNameDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameZoneNameDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/zone/{name}][%d] GetIPLoadbalancingServiceNameZoneName default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameZoneNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameZoneNameDefaultBody)

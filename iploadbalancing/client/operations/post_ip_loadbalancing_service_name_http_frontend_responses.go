...
func (o *PostIPLoadbalancingServiceNameHTTPFrontendReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadbalancingServiceNameHTTPFrontendOK()
	...
	default:
		result := NewPostIPLoadbalancingServiceNameHTTPFrontendDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadbalancingServiceNameHTTPFrontendOK() *PostIPLoadbalancingServiceNameHTTPFrontendOK {
	return &PostIPLoadbalancingServiceNameHTTPFrontendOK{}
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFrontendOK) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/http/frontend][%d] postIpLoadbalancingServiceNameHttpFrontendOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameHTTPFrontendOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadbalancingServiceNameHTTPFrontendDefault(code int) *PostIPLoadbalancingServiceNameHTTPFrontendDefault {
	return &PostIPLoadbalancingServiceNameHTTPFrontendDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFrontendDefault) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/http/frontend][%d] PostIPLoadbalancingServiceNameHTTPFrontend default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameHTTPFrontendDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadbalancingServiceNameHTTPFrontendDefaultBody)

...
// NewPostIPLoadbalancingServiceNameHTTPFarmParams creates a new PostIPLoadbalancingServiceNameHTTPFarmParams object
// with the default values initialized.
func NewPostIPLoadbalancingServiceNameHTTPFarmParams() *PostIPLoadbalancingServiceNameHTTPFarmParams {
	var ()
	return &PostIPLoadbalancingServiceNameHTTPFarmParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPLoadbalancingServiceNameHTTPFarmParamsWithTimeout creates a new PostIPLoadbalancingServiceNameHTTPFarmParams object
...
// NewPostIPLoadbalancingServiceNameHTTPFarmParamsWithContext creates a new PostIPLoadbalancingServiceNameHTTPFarmParams object
...
// NewPostIPLoadbalancingServiceNameHTTPFarmParamsWithHTTPClient creates a new PostIPLoadbalancingServiceNameHTTPFarmParams object
...
/*PostIPLoadbalancingServiceNameHTTPFarmParams contains all the parameters to send to the API endpoint
for the post IP loadbalancing service name HTTP farm operation typically these are written to a http.Request
*/
...
func (o *PostIPLoadbalancingServiceNameHTTPFarmParams) WithIPLBHTTPFarmPost(iPLBHTTPFarmPost *models.PostIPLoadbalancingServiceNameHTTPFarmParamsBody) *PostIPLoadbalancingServiceNameHTTPFarmParams {
	o.SetIPLBHTTPFarmPost(iPLBHTTPFarmPost)
	return o
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFarmParams) SetIPLBHTTPFarmPost(iPLBHTTPFarmPost *models.PostIPLoadbalancingServiceNameHTTPFarmParamsBody) {
	o.IPLBHTTPFarmPost = iPLBHTTPFarmPost
}
...
func (o *PostIPLoadbalancingServiceNameHTTPFarmParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLBHTTPFarmPost != nil {
		if err := r.SetBodyParam(o.IPLBHTTPFarmPost); err != nil {
			return err
		}
	}

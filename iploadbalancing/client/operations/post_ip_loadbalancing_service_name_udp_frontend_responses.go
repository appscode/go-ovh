...
func (o *PostIPLoadbalancingServiceNameUDPFrontendReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadbalancingServiceNameUDPFrontendOK()
	...
	default:
		result := NewPostIPLoadbalancingServiceNameUDPFrontendDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadbalancingServiceNameUDPFrontendOK() *PostIPLoadbalancingServiceNameUDPFrontendOK {
	return &PostIPLoadbalancingServiceNameUDPFrontendOK{}
}
...
func (o *PostIPLoadbalancingServiceNameUDPFrontendOK) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/udp/frontend][%d] postIpLoadbalancingServiceNameUdpFrontendOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameUDPFrontendOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadbalancingServiceNameUDPFrontendDefault(code int) *PostIPLoadbalancingServiceNameUDPFrontendDefault {
	return &PostIPLoadbalancingServiceNameUDPFrontendDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadbalancingServiceNameUDPFrontendDefault) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/udp/frontend][%d] PostIPLoadbalancingServiceNameUDPFrontend default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameUDPFrontendDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadbalancingServiceNameUDPFrontendDefaultBody)

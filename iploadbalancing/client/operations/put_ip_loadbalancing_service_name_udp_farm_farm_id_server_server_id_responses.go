...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK() *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK {
	return &PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server/{serverId}][%d] putIpLoadbalancingServiceNameUdpFarmFarmIdServerServerIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault(code int) *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault {
	return &PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server/{serverId}][%d] PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDDefaultBody)

...
func (o *GetIPLoadbalancingServiceNameQuotaHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameQuotaHistoryOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameQuotaHistoryDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameQuotaHistoryOK() *GetIPLoadbalancingServiceNameQuotaHistoryOK {
	return &GetIPLoadbalancingServiceNameQuotaHistoryOK{}
}
...
func (o *GetIPLoadbalancingServiceNameQuotaHistoryOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/quotaHistory][%d] getIpLoadbalancingServiceNameQuotaHistoryOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameQuotaHistoryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameQuotaHistoryDefault(code int) *GetIPLoadbalancingServiceNameQuotaHistoryDefault {
	return &GetIPLoadbalancingServiceNameQuotaHistoryDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameQuotaHistoryDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/quotaHistory][%d] GetIPLoadbalancingServiceNameQuotaHistory default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameQuotaHistoryDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameQuotaHistoryDefaultBody)

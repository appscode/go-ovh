...
func (o *GetIPLoadbalancingServiceNameAvailableRouteRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameAvailableRouteRulesOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameAvailableRouteRulesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameAvailableRouteRulesOK() *GetIPLoadbalancingServiceNameAvailableRouteRulesOK {
	return &GetIPLoadbalancingServiceNameAvailableRouteRulesOK{}
}
...
func (o *GetIPLoadbalancingServiceNameAvailableRouteRulesOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/availableRouteRules][%d] getIpLoadbalancingServiceNameAvailableRouteRulesOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameAvailableRouteRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameAvailableRouteRulesDefault(code int) *GetIPLoadbalancingServiceNameAvailableRouteRulesDefault {
	return &GetIPLoadbalancingServiceNameAvailableRouteRulesDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameAvailableRouteRulesDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/availableRouteRules][%d] GetIPLoadbalancingServiceNameAvailableRouteRules default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameAvailableRouteRulesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameAvailableRouteRulesDefaultBody)

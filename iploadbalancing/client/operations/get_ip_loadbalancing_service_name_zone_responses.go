...
func (o *GetIPLoadbalancingServiceNameZoneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameZoneOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameZoneDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameZoneOK() *GetIPLoadbalancingServiceNameZoneOK {
	return &GetIPLoadbalancingServiceNameZoneOK{}
}
...
func (o *GetIPLoadbalancingServiceNameZoneOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/zone][%d] getIpLoadbalancingServiceNameZoneOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameZoneOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameZoneDefault(code int) *GetIPLoadbalancingServiceNameZoneDefault {
	return &GetIPLoadbalancingServiceNameZoneDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameZoneDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/zone][%d] GetIPLoadbalancingServiceNameZone default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameZoneDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameZoneDefaultBody)

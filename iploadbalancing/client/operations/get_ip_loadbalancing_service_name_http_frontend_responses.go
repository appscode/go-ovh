...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameHTTPFrontendOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameHTTPFrontendDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameHTTPFrontendOK() *GetIPLoadbalancingServiceNameHTTPFrontendOK {
	return &GetIPLoadbalancingServiceNameHTTPFrontendOK{}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/frontend][%d] getIpLoadbalancingServiceNameHttpFrontendOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFrontendOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameHTTPFrontendDefault(code int) *GetIPLoadbalancingServiceNameHTTPFrontendDefault {
	return &GetIPLoadbalancingServiceNameHTTPFrontendDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/frontend][%d] GetIPLoadbalancingServiceNameHTTPFrontend default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFrontendDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameHTTPFrontendDefaultBody)

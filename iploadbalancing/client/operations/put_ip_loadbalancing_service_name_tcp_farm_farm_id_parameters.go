...
// NewPutIPLoadbalancingServiceNameTCPFarmFarmIDParams creates a new PutIPLoadbalancingServiceNameTCPFarmFarmIDParams object
// with the default values initialized.
func NewPutIPLoadbalancingServiceNameTCPFarmFarmIDParams() *PutIPLoadbalancingServiceNameTCPFarmFarmIDParams {
	var ()
	return &PutIPLoadbalancingServiceNameTCPFarmFarmIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutIPLoadbalancingServiceNameTCPFarmFarmIDParamsWithTimeout creates a new PutIPLoadbalancingServiceNameTCPFarmFarmIDParams object
...
// NewPutIPLoadbalancingServiceNameTCPFarmFarmIDParamsWithContext creates a new PutIPLoadbalancingServiceNameTCPFarmFarmIDParams object
...
// NewPutIPLoadbalancingServiceNameTCPFarmFarmIDParamsWithHTTPClient creates a new PutIPLoadbalancingServiceNameTCPFarmFarmIDParams object
...
/*PutIPLoadbalancingServiceNameTCPFarmFarmIDParams contains all the parameters to send to the API endpoint
for the put IP loadbalancing service name TCP farm farm ID operation typically these are written to a http.Request
*/
...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDParams) WithIPLBTCPFarmPut(iPLBTCPFarmPut *models.IPLBBackendTCPBackendTCP) *PutIPLoadbalancingServiceNameTCPFarmFarmIDParams {
	o.SetIPLBTCPFarmPut(iPLBTCPFarmPut)
	return o
}
...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDParams) SetIPLBTCPFarmPut(iPLBTCPFarmPut *models.IPLBBackendTCPBackendTCP) {
	o.IPLBTCPFarmPut = iPLBTCPFarmPut
}
...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLBTCPFarmPut != nil {
		if err := r.SetBodyParam(o.IPLBTCPFarmPut); err != nil {
			return err
		}
	}

...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK() *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK {
	return &GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK{}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/frontend/{frontendId}][%d] getIpLoadbalancingServiceNameHttpFrontendFrontendIdOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IPLBFrontendHTTPFrontendHTTP)
...
func NewGetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault(code int) *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault {
	return &GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/frontend/{frontendId}][%d] GetIPLoadbalancingServiceNameHTTPFrontendFrontendID default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameHTTPFrontendFrontendIDDefaultBody)

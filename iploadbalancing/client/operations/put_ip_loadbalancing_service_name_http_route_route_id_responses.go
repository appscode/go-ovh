...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDOK() *PutIPLoadbalancingServiceNameHTTPRouteRouteIDOK {
	return &PutIPLoadbalancingServiceNameHTTPRouteRouteIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/http/route/{routeId}][%d] putIpLoadbalancingServiceNameHttpRouteRouteIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault(code int) *PutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault {
	return &PutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/http/route/{routeId}][%d] PutIPLoadbalancingServiceNameHTTPRouteRouteID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameHTTPRouteRouteIDDefaultBody)

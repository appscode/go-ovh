...
// NewGetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams creates a new GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams object
...
func NewGetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams() *GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams {
	var ()
	return &GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParamsWithTimeout creates a new GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams object
...
// NewGetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParamsWithContext creates a new GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams object
...
// NewGetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParamsWithHTTPClient creates a new GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams object
...
/*GetIPLoadbalancingServiceNameHTTPFarmFarmIDServerServerIDParams contains all the parameters to send to the API endpoint
for the get IP loadbalancing service name HTTP farm farm ID server server ID operation typically these are written to a http.Request
*/

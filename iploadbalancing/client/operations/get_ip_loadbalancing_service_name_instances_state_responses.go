...
func (o *GetIPLoadbalancingServiceNameInstancesStateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameInstancesStateOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameInstancesStateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameInstancesStateOK() *GetIPLoadbalancingServiceNameInstancesStateOK {
	return &GetIPLoadbalancingServiceNameInstancesStateOK{}
}
...
func (o *GetIPLoadbalancingServiceNameInstancesStateOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/instancesState][%d] getIpLoadbalancingServiceNameInstancesStateOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameInstancesStateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameInstancesStateDefault(code int) *GetIPLoadbalancingServiceNameInstancesStateDefault {
	return &GetIPLoadbalancingServiceNameInstancesStateDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameInstancesStateDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/instancesState][%d] GetIPLoadbalancingServiceNameInstancesState default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameInstancesStateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameInstancesStateDefaultBody)

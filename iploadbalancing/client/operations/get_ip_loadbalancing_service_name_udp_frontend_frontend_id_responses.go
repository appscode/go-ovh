...
func (o *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK() *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK {
	return &GetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK{}
}
...
func (o *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}][%d] getIpLoadbalancingServiceNameUdpFrontendFrontendIdOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IPLBFrontendUDPFrontendUDP)
...
func NewGetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault(code int) *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault {
	return &GetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}][%d] GetIPLoadbalancingServiceNameUDPFrontendFrontendID default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameUDPFrontendFrontendIDDefaultBody)

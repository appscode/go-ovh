...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK() *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK {
	return &PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}][%d] putIpLoadbalancingServiceNameHttpRouteRouteIdRuleRuleIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault(code int) *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault {
	return &PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}][%d] PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameHTTPRouteRouteIDRuleRuleIDDefaultBody)

...
func (o *GetIPLoadbalancingServiceNameDefinedFrontendsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameDefinedFrontendsOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameDefinedFrontendsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameDefinedFrontendsOK() *GetIPLoadbalancingServiceNameDefinedFrontendsOK {
	return &GetIPLoadbalancingServiceNameDefinedFrontendsOK{}
}
...
func (o *GetIPLoadbalancingServiceNameDefinedFrontendsOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/definedFrontends][%d] getIpLoadbalancingServiceNameDefinedFrontendsOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameDefinedFrontendsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameDefinedFrontendsDefault(code int) *GetIPLoadbalancingServiceNameDefinedFrontendsDefault {
	return &GetIPLoadbalancingServiceNameDefinedFrontendsDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameDefinedFrontendsDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/definedFrontends][%d] GetIPLoadbalancingServiceNameDefinedFrontends default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameDefinedFrontendsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameDefinedFrontendsDefaultBody)

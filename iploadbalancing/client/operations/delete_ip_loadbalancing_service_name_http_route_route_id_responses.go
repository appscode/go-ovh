...
func (o *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK()
	...
	default:
		result := NewDeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK() *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK {
	return &DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK{}
}
...
func (o *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK) Error() string {
	return fmt.Sprintf("[DELETE /ipLoadbalancing/{serviceName}/http/route/{routeId}][%d] deleteIpLoadbalancingServiceNameHttpRouteRouteIdOK ", 200)
}

func (o *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault(code int) *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault {
	return &DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /ipLoadbalancing/{serviceName}/http/route/{routeId}][%d] DeleteIPLoadbalancingServiceNameHTTPRouteRouteID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteIPLoadbalancingServiceNameHTTPRouteRouteIDDefaultBody)

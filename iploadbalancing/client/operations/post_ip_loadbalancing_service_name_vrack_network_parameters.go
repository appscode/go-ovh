...
// NewPostIPLoadbalancingServiceNameVrackNetworkParams creates a new PostIPLoadbalancingServiceNameVrackNetworkParams object
// with the default values initialized.
func NewPostIPLoadbalancingServiceNameVrackNetworkParams() *PostIPLoadbalancingServiceNameVrackNetworkParams {
	var ()
	return &PostIPLoadbalancingServiceNameVrackNetworkParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPLoadbalancingServiceNameVrackNetworkParamsWithTimeout creates a new PostIPLoadbalancingServiceNameVrackNetworkParams object
...
// NewPostIPLoadbalancingServiceNameVrackNetworkParamsWithContext creates a new PostIPLoadbalancingServiceNameVrackNetworkParams object
...
// NewPostIPLoadbalancingServiceNameVrackNetworkParamsWithHTTPClient creates a new PostIPLoadbalancingServiceNameVrackNetworkParams object
...
/*PostIPLoadbalancingServiceNameVrackNetworkParams contains all the parameters to send to the API endpoint
for the post IP loadbalancing service name vrack network operation typically these are written to a http.Request
*/
...
func (o *PostIPLoadbalancingServiceNameVrackNetworkParams) WithIPLBVrackNetworkPost(iPLBVrackNetworkPost *models.PostIPLoadbalancingServiceNameVrackNetworkParamsBody) *PostIPLoadbalancingServiceNameVrackNetworkParams {
	o.SetIPLBVrackNetworkPost(iPLBVrackNetworkPost)
	return o
}
...
func (o *PostIPLoadbalancingServiceNameVrackNetworkParams) SetIPLBVrackNetworkPost(iPLBVrackNetworkPost *models.PostIPLoadbalancingServiceNameVrackNetworkParamsBody) {
	o.IPLBVrackNetworkPost = iPLBVrackNetworkPost
}
...
func (o *PostIPLoadbalancingServiceNameVrackNetworkParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLBVrackNetworkPost != nil {
		if err := r.SetBodyParam(o.IPLBVrackNetworkPost); err != nil {
			return err
		}
	}

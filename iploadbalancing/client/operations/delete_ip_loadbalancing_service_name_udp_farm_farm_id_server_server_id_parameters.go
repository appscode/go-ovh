...
// NewDeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams creates a new DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams object
...
func NewDeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams() *DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams {
	var ()
	return &DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParamsWithTimeout creates a new DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams object
...
// NewDeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParamsWithContext creates a new DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams object
...
// NewDeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParamsWithHTTPClient creates a new DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams object
...
/*DeleteIPLoadbalancingServiceNameUDPFarmFarmIDServerServerIDParams contains all the parameters to send to the API endpoint
for the delete IP loadbalancing service name UDP farm farm ID server server ID operation typically these are written to a http.Request
*/

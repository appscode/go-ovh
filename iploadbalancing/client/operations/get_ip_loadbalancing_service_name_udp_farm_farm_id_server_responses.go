...
func (o *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK() *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK {
	return &GetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK{}
}
...
func (o *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server][%d] getIpLoadbalancingServiceNameUdpFarmFarmIdServerOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault(code int) *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault {
	return &GetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server][%d] GetIPLoadbalancingServiceNameUDPFarmFarmIDServer default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameUDPFarmFarmIDServerDefaultBody)

...
// NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams creates a new GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams object
...
func NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams() *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams {
	var ()
	return &GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParamsWithTimeout creates a new GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams object
...
// NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParamsWithContext creates a new GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams object
...
// NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParamsWithHTTPClient creates a new GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams object
...
/*GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleParams contains all the parameters to send to the API endpoint
for the get IP loadbalancing service name HTTP route route ID rule operation typically these are written to a http.Request
*/

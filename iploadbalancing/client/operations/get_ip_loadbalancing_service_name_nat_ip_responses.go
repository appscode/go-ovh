...
func (o *GetIPLoadbalancingServiceNameNatIPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameNatIPOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameNatIPDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameNatIPOK() *GetIPLoadbalancingServiceNameNatIPOK {
	return &GetIPLoadbalancingServiceNameNatIPOK{}
}
...
func (o *GetIPLoadbalancingServiceNameNatIPOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/natIp][%d] getIpLoadbalancingServiceNameNatIpOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameNatIPOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameNatIPDefault(code int) *GetIPLoadbalancingServiceNameNatIPDefault {
	return &GetIPLoadbalancingServiceNameNatIPDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameNatIPDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/natIp][%d] GetIPLoadbalancingServiceNameNatIP default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameNatIPDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameNatIPDefaultBody)

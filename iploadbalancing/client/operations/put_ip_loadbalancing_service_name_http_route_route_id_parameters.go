...
// NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDParams creates a new PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams object
// with the default values initialized.
func NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDParams() *PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams {
	var ()
	return &PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDParamsWithTimeout creates a new PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams object
...
// NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDParamsWithContext creates a new PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams object
...
// NewPutIPLoadbalancingServiceNameHTTPRouteRouteIDParamsWithHTTPClient creates a new PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams object
...
/*PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams contains all the parameters to send to the API endpoint
for the put IP loadbalancing service name HTTP route route ID operation typically these are written to a http.Request
*/
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams) WithIPLBHTTPRoutePut(iPLBHTTPRoutePut *models.IPLBRouteHTTPRouteHTTP) *PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams {
	o.SetIPLBHTTPRoutePut(iPLBHTTPRoutePut)
	return o
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams) SetIPLBHTTPRoutePut(iPLBHTTPRoutePut *models.IPLBRouteHTTPRouteHTTP) {
	o.IPLBHTTPRoutePut = iPLBHTTPRoutePut
}
...
func (o *PutIPLoadbalancingServiceNameHTTPRouteRouteIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLBHTTPRoutePut != nil {
		if err := r.SetBodyParam(o.IPLBHTTPRoutePut); err != nil {
			return err
		}
	}

...
// NewPostIPLoadbalancingServiceNameRefreshParams creates a new PostIPLoadbalancingServiceNameRefreshParams object
// with the default values initialized.
func NewPostIPLoadbalancingServiceNameRefreshParams() *PostIPLoadbalancingServiceNameRefreshParams {
	var ()
	return &PostIPLoadbalancingServiceNameRefreshParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPLoadbalancingServiceNameRefreshParamsWithTimeout creates a new PostIPLoadbalancingServiceNameRefreshParams object
...
// NewPostIPLoadbalancingServiceNameRefreshParamsWithContext creates a new PostIPLoadbalancingServiceNameRefreshParams object
...
// NewPostIPLoadbalancingServiceNameRefreshParamsWithHTTPClient creates a new PostIPLoadbalancingServiceNameRefreshParams object
...
/*PostIPLoadbalancingServiceNameRefreshParams contains all the parameters to send to the API endpoint
for the post IP loadbalancing service name refresh operation typically these are written to a http.Request
*/
...
func (o *PostIPLoadbalancingServiceNameRefreshParams) WithIPLBRefreshPost(iPLBRefreshPost *models.PostIPLoadbalancingServiceNameRefreshParamsBody) *PostIPLoadbalancingServiceNameRefreshParams {
	o.SetIPLBRefreshPost(iPLBRefreshPost)
	return o
}
...
func (o *PostIPLoadbalancingServiceNameRefreshParams) SetIPLBRefreshPost(iPLBRefreshPost *models.PostIPLoadbalancingServiceNameRefreshParamsBody) {
	o.IPLBRefreshPost = iPLBRefreshPost
}
...
func (o *PostIPLoadbalancingServiceNameRefreshParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLBRefreshPost != nil {
		if err := r.SetBodyParam(o.IPLBRefreshPost); err != nil {
			return err
		}
	}

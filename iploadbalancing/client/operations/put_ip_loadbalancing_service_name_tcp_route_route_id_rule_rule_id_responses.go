...
func (o *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK() *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK {
	return &PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule/{ruleId}][%d] putIpLoadbalancingServiceNameTcpRouteRouteIdRuleRuleIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault(code int) *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault {
	return &PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule/{ruleId}][%d] PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameTCPRouteRouteIDRuleRuleIDDefaultBody)

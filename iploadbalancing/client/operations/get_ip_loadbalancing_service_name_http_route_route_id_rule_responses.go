...
func (o *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK() *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK {
	return &GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK{}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/route/{routeId}/rule][%d] getIpLoadbalancingServiceNameHttpRouteRouteIdRuleOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault(code int) *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault {
	return &GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/route/{routeId}/rule][%d] GetIPLoadbalancingServiceNameHTTPRouteRouteIDRule default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameHTTPRouteRouteIDRuleDefaultBody)

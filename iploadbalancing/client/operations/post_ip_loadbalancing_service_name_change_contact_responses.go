...
func (o *PostIPLoadbalancingServiceNameChangeContactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadbalancingServiceNameChangeContactOK()
	...
	default:
		result := NewPostIPLoadbalancingServiceNameChangeContactDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadbalancingServiceNameChangeContactOK() *PostIPLoadbalancingServiceNameChangeContactOK {
	return &PostIPLoadbalancingServiceNameChangeContactOK{}
}
...
func (o *PostIPLoadbalancingServiceNameChangeContactOK) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/changeContact][%d] postIpLoadbalancingServiceNameChangeContactOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameChangeContactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadbalancingServiceNameChangeContactDefault(code int) *PostIPLoadbalancingServiceNameChangeContactDefault {
	return &PostIPLoadbalancingServiceNameChangeContactDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadbalancingServiceNameChangeContactDefault) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/changeContact][%d] PostIPLoadbalancingServiceNameChangeContact default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameChangeContactDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadbalancingServiceNameChangeContactDefaultBody)

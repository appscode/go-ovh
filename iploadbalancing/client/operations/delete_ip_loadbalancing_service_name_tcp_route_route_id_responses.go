...
func (o *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK()
	...
	default:
		result := NewDeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK() *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK {
	return &DeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK{}
}
...
func (o *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK) Error() string {
	return fmt.Sprintf("[DELETE /ipLoadbalancing/{serviceName}/tcp/route/{routeId}][%d] deleteIpLoadbalancingServiceNameTcpRouteRouteIdOK ", 200)
}

func (o *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault(code int) *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault {
	return &DeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /ipLoadbalancing/{serviceName}/tcp/route/{routeId}][%d] DeleteIPLoadbalancingServiceNameTCPRouteRouteID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteIPLoadbalancingServiceNameTCPRouteRouteIDDefaultBody)

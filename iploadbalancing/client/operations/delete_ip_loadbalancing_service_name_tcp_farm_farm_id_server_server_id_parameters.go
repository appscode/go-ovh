...
// NewDeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams creates a new DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
func NewDeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams() *DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams {
	var ()
	return &DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithTimeout creates a new DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
// NewDeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithContext creates a new DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
// NewDeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithHTTPClient creates a new DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
/*DeleteIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams contains all the parameters to send to the API endpoint
for the delete IP loadbalancing service name TCP farm farm ID server server ID operation typically these are written to a http.Request
*/

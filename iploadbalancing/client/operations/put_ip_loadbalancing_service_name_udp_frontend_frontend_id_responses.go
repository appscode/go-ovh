...
func (o *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK() *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK {
	return &PutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}][%d] putIpLoadbalancingServiceNameUdpFrontendFrontendIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault(code int) *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault {
	return &PutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}][%d] PutIPLoadbalancingServiceNameUDPFrontendFrontendID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameUDPFrontendFrontendIDDefaultBody)

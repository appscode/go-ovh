...
// NewGetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams creates a new GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
func NewGetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams() *GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams {
	var ()
	return &GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithTimeout creates a new GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
// NewGetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithContext creates a new GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
// NewGetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParamsWithHTTPClient creates a new GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams object
...
/*GetIPLoadbalancingServiceNameTCPFarmFarmIDServerServerIDParams contains all the parameters to send to the API endpoint
for the get IP loadbalancing service name TCP farm farm ID server server ID operation typically these are written to a http.Request
*/

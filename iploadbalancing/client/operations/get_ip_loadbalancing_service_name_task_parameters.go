...
for the get IP loadbalancing service name task operation typically these are written to a http.Request
*/
...
func (o *GetIPLoadbalancingServiceNameTaskParams) WithDoneDateFrom(doneDateFrom *strfmt.DateTime) *GetIPLoadbalancingServiceNameTaskParams {
	o.SetDoneDateFrom(doneDateFrom)
	return o
}
...
func (o *GetIPLoadbalancingServiceNameTaskParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DoneDateFrom != nil {

		// query param doneDate.from
		var qrDoneDateFrom strfmt.DateTime
		if o.DoneDateFrom != nil {
			qrDoneDateFrom = *o.DoneDateFrom
		}
		qDoneDateFrom := qrDoneDateFrom.String()
		if qDoneDateFrom != "" {
			if err := r.SetQueryParam("doneDate.from", qDoneDateFrom); err != nil {
				return err
			}
		}
	...
	if o.DoneDateTo != nil {
		...
		// query param doneDate.to
		var qrDoneDateTo strfmt.DateTime
		if o.DoneDateTo != nil {
			qrDoneDateTo = *o.DoneDateTo
		}
		qDoneDateTo := qrDoneDateTo.String()
		if qDoneDateTo != "" {
			if err := r.SetQueryParam("doneDate.to", qDoneDateTo); err != nil {
				return err
			}
		}

...
func (o *GetIPLoadbalancingServiceNameHTTPFarmReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadbalancingServiceNameHTTPFarmOK()
	...
	default:
		result := NewGetIPLoadbalancingServiceNameHTTPFarmDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadbalancingServiceNameHTTPFarmOK() *GetIPLoadbalancingServiceNameHTTPFarmOK {
	return &GetIPLoadbalancingServiceNameHTTPFarmOK{}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFarmOK) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/farm][%d] getIpLoadbalancingServiceNameHttpFarmOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFarmOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadbalancingServiceNameHTTPFarmDefault(code int) *GetIPLoadbalancingServiceNameHTTPFarmDefault {
	return &GetIPLoadbalancingServiceNameHTTPFarmDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadbalancingServiceNameHTTPFarmDefault) Error() string {
	return fmt.Sprintf("[GET /ipLoadbalancing/{serviceName}/http/farm][%d] GetIPLoadbalancingServiceNameHTTPFarm default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadbalancingServiceNameHTTPFarmDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadbalancingServiceNameHTTPFarmDefaultBody)

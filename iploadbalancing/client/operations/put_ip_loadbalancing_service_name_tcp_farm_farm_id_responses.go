...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPLoadbalancingServiceNameTCPFarmFarmIDOK()
	...
	default:
		result := NewPutIPLoadbalancingServiceNameTCPFarmFarmIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPLoadbalancingServiceNameTCPFarmFarmIDOK() *PutIPLoadbalancingServiceNameTCPFarmFarmIDOK {
	return &PutIPLoadbalancingServiceNameTCPFarmFarmIDOK{}
}
...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDOK) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/tcp/farm/{farmId}][%d] putIpLoadbalancingServiceNameTcpFarmFarmIdOK ", 200)
}

func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPLoadbalancingServiceNameTCPFarmFarmIDDefault(code int) *PutIPLoadbalancingServiceNameTCPFarmFarmIDDefault {
	return &PutIPLoadbalancingServiceNameTCPFarmFarmIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDDefault) Error() string {
	return fmt.Sprintf("[PUT /ipLoadbalancing/{serviceName}/tcp/farm/{farmId}][%d] PutIPLoadbalancingServiceNameTCPFarmFarmID default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPLoadbalancingServiceNameTCPFarmFarmIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPLoadbalancingServiceNameTCPFarmFarmIDDefaultBody)

...
func (o *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK()
	...
	default:
		result := NewPostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK() *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK {
	return &PostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK{}
}
...
func (o *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server][%d] postIpLoadbalancingServiceNameUdpFarmFarmIdServerOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault(code int) *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault {
	return &PostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault) Error() string {
	return fmt.Sprintf("[POST /ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server][%d] PostIPLoadbalancingServiceNameUDPFarmFarmIDServer default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadbalancingServiceNameUDPFarmFarmIDServerDefaultBody)

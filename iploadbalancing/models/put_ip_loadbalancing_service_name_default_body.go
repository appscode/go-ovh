...
// PutIPLoadbalancingServiceNameDefaultBody put Ip loadbalancing service name default body
// swagger:model putIpLoadbalancingServiceNameDefaultBody
...
func (m *PutIPLoadbalancingServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPLoadbalancingServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPLoadbalancingServiceNameDefaultBody

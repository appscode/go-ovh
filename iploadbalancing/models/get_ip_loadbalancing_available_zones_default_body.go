...
// GetIPLoadbalancingAvailableZonesDefaultBody get Ip loadbalancing available zones default body
// swagger:model getIpLoadbalancingAvailableZonesDefaultBody
...
func (m *GetIPLoadbalancingAvailableZonesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadbalancingAvailableZonesDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadbalancingAvailableZonesDefaultBody

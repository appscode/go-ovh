...
// IPLBBackendTCPCustomerServerBackendTCPServer TCP Farm's Server
// swagger:model iplb.BackendTcpCustomerServer.BackendTCPServer
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateAddress(formats strfmt.Registry) error {
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateBackendID(formats strfmt.Registry) error {
...
var iplbBackendTcpCustomerServerBackendTcpServerTypeProxyProtocolVersionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		iplbBackendTcpCustomerServerBackendTcpServerTypeProxyProtocolVersionPropEnum = append(iplbBackendTcpCustomerServerBackendTcpServerTypeProxyProtocolVersionPropEnum, v)
	}
}
...
// prop value enum
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateProxyProtocolVersionEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, iplbBackendTcpCustomerServerBackendTcpServerTypeProxyProtocolVersionPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateProxyProtocolVersion(formats strfmt.Registry) error {
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateServerID(formats strfmt.Registry) error {
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateServerState(formats strfmt.Registry) error {
...
var iplbBackendTcpCustomerServerBackendTcpServerTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		iplbBackendTcpCustomerServerBackendTcpServerTypeStatusPropEnum = append(iplbBackendTcpCustomerServerBackendTcpServerTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, iplbBackendTcpCustomerServerBackendTcpServerTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *IPLBBackendTCPCustomerServerBackendTCPServer) validateStatus(formats strfmt.Registry) error {
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IPLBBackendTCPCustomerServerBackendTCPServer) UnmarshalBinary(b []byte) error {
	var res IPLBBackendTCPCustomerServerBackendTCPServer

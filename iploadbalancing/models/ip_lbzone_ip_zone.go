...
// IPLBZoneIPZone Zone
// swagger:model iplb.Zone.IpZone
...
func (m *IPLBZoneIPZone) validateName(formats strfmt.Registry) error {
...
func (m *IPLBZoneIPZone) validateState(formats strfmt.Registry) error {

...
// GetIPLoadbalancingServiceNameSslDefaultBody get Ip loadbalancing service name ssl default body
// swagger:model getIpLoadbalancingServiceNameSslDefaultBody
...
func (m *GetIPLoadbalancingServiceNameSslDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadbalancingServiceNameSslDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadbalancingServiceNameSslDefaultBody

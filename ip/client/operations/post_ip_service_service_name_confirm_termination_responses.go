...
func (o *PostIPServiceServiceNameConfirmTerminationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPServiceServiceNameConfirmTerminationOK()
	...
	default:
		result := NewPostIPServiceServiceNameConfirmTerminationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPServiceServiceNameConfirmTerminationOK() *PostIPServiceServiceNameConfirmTerminationOK {
	return &PostIPServiceServiceNameConfirmTerminationOK{}
}
...
func (o *PostIPServiceServiceNameConfirmTerminationOK) Error() string {
	return fmt.Sprintf("[POST /ip/service/{serviceName}/confirmTermination][%d] postIpServiceServiceNameConfirmTerminationOK  %+v", 200, o.Payload)
}

func (o *PostIPServiceServiceNameConfirmTerminationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPServiceServiceNameConfirmTerminationDefault(code int) *PostIPServiceServiceNameConfirmTerminationDefault {
	return &PostIPServiceServiceNameConfirmTerminationDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPServiceServiceNameConfirmTerminationDefault) Error() string {
	return fmt.Sprintf("[POST /ip/service/{serviceName}/confirmTermination][%d] PostIPServiceServiceNameConfirmTermination default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPServiceServiceNameConfirmTerminationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPServiceServiceNameConfirmTerminationDefaultBody)

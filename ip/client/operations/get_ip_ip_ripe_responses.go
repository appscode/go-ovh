...
func (o *GetIPIPRipeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetIPIPRipeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetIPIPRipeOK) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/ripe][%d] getIpIpRipeOK  %+v", 200, o.Payload)
}

func (o *GetIPIPRipeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IPRipeInfos)
...
func (o *GetIPIPRipeDefault) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/ripe][%d] GetIPIPRipe default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPIPRipeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPIPRipeDefaultBody)

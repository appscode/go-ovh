...
func (o *PutIPIPMitigationIPOnMitigationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutIPIPMitigationIPOnMitigationOK()
	...
	default:
		result := NewPutIPIPMitigationIPOnMitigationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutIPIPMitigationIPOnMitigationOK() *PutIPIPMitigationIPOnMitigationOK {
	return &PutIPIPMitigationIPOnMitigationOK{}
}
...
func (o *PutIPIPMitigationIPOnMitigationOK) Error() string {
	return fmt.Sprintf("[PUT /ip/{ip}/mitigation/{ipOnMitigation}][%d] putIpIpMitigationIpOnMitigationOK ", 200)
}

func (o *PutIPIPMitigationIPOnMitigationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutIPIPMitigationIPOnMitigationDefault(code int) *PutIPIPMitigationIPOnMitigationDefault {
	return &PutIPIPMitigationIPOnMitigationDefault{
		_statusCode: code,
	}
}
...
func (o *PutIPIPMitigationIPOnMitigationDefault) Error() string {
	return fmt.Sprintf("[PUT /ip/{ip}/mitigation/{ipOnMitigation}][%d] PutIPIPMitigationIPOnMitigation default  %+v", o._statusCode, o.Payload)
}

func (o *PutIPIPMitigationIPOnMitigationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutIPIPMitigationIPOnMitigationDefaultBody)

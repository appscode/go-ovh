...
func (o *GetIPLoadBalancingOK) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing][%d] getIpLoadBalancingOK  %+v", 200, o.Payload)
}
...
func (o *GetIPLoadBalancingDefault) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing][%d] GetIPLoadBalancing default  %+v", o._statusCode, o.Payload)
}

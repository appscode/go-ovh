...
func (o *GetIPIPArpIPBlockedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPIPArpIPBlockedOK()
	...
	default:
		result := NewGetIPIPArpIPBlockedDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetIPIPArpIPBlockedOK) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/arp/{ipBlocked}][%d] getIpIpArpIpBlockedOK  %+v", 200, o.Payload)
}

func (o *GetIPIPArpIPBlockedOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IPArpBlockedIP)
...
func NewGetIPIPArpIPBlockedDefault(code int) *GetIPIPArpIPBlockedDefault {
	return &GetIPIPArpIPBlockedDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPIPArpIPBlockedDefault) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/arp/{ipBlocked}][%d] GetIPIPArpIPBlocked default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPIPArpIPBlockedDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPIPArpIPBlockedDefaultBody)

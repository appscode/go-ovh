...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostIPLoadBalancingServiceNamePortsRedirectionOK()
	...
	default:
		result := NewPostIPLoadBalancingServiceNamePortsRedirectionDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostIPLoadBalancingServiceNamePortsRedirectionOK() *PostIPLoadBalancingServiceNamePortsRedirectionOK {
	return &PostIPLoadBalancingServiceNamePortsRedirectionOK{}
}
...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionOK) Error() string {
	return fmt.Sprintf("[POST /ip/loadBalancing/{serviceName}/portsRedirection][%d] postIpLoadBalancingServiceNamePortsRedirectionOK  %+v", 200, o.Payload)
}

func (o *PostIPLoadBalancingServiceNamePortsRedirectionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostIPLoadBalancingServiceNamePortsRedirectionDefault(code int) *PostIPLoadBalancingServiceNamePortsRedirectionDefault {
	return &PostIPLoadBalancingServiceNamePortsRedirectionDefault{
		_statusCode: code,
	}
}
...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionDefault) Error() string {
	return fmt.Sprintf("[POST /ip/loadBalancing/{serviceName}/portsRedirection][%d] PostIPLoadBalancingServiceNamePortsRedirection default  %+v", o._statusCode, o.Payload)
}

func (o *PostIPLoadBalancingServiceNamePortsRedirectionDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostIPLoadBalancingServiceNamePortsRedirectionDefaultBody)

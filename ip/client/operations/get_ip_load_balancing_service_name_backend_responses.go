...
func (o *GetIPLoadBalancingServiceNameBackendReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPLoadBalancingServiceNameBackendOK()
	...
	default:
		result := NewGetIPLoadBalancingServiceNameBackendDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetIPLoadBalancingServiceNameBackendOK() *GetIPLoadBalancingServiceNameBackendOK {
	return &GetIPLoadBalancingServiceNameBackendOK{}
}
...
func (o *GetIPLoadBalancingServiceNameBackendOK) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing/{serviceName}/backend][%d] getIpLoadBalancingServiceNameBackendOK  %+v", 200, o.Payload)
}

func (o *GetIPLoadBalancingServiceNameBackendOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetIPLoadBalancingServiceNameBackendDefault(code int) *GetIPLoadBalancingServiceNameBackendDefault {
	return &GetIPLoadBalancingServiceNameBackendDefault{
		_statusCode: code,
	}
}
...
func (o *GetIPLoadBalancingServiceNameBackendDefault) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing/{serviceName}/backend][%d] GetIPLoadBalancingServiceNameBackend default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPLoadBalancingServiceNameBackendDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPLoadBalancingServiceNameBackendDefaultBody)

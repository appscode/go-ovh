...
func (o *GetIPLoadBalancingServiceNameServiceInfosOK) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing/{serviceName}/serviceInfos][%d] getIpLoadBalancingServiceNameServiceInfosOK  %+v", 200, o.Payload)
}
...
func (o *GetIPLoadBalancingServiceNameServiceInfosDefault) Error() string {
	return fmt.Sprintf("[GET /ip/loadBalancing/{serviceName}/serviceInfos][%d] GetIPLoadBalancingServiceNameServiceInfos default  %+v", o._statusCode, o.Payload)
}

...
// NewPostIPLoadBalancingServiceNamePortsRedirectionParams creates a new PostIPLoadBalancingServiceNamePortsRedirectionParams object
// with the default values initialized.
func NewPostIPLoadBalancingServiceNamePortsRedirectionParams() *PostIPLoadBalancingServiceNamePortsRedirectionParams {
	var ()
	return &PostIPLoadBalancingServiceNamePortsRedirectionParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPLoadBalancingServiceNamePortsRedirectionParamsWithTimeout creates a new PostIPLoadBalancingServiceNamePortsRedirectionParams object
...
// NewPostIPLoadBalancingServiceNamePortsRedirectionParamsWithContext creates a new PostIPLoadBalancingServiceNamePortsRedirectionParams object
...
// NewPostIPLoadBalancingServiceNamePortsRedirectionParamsWithHTTPClient creates a new PostIPLoadBalancingServiceNamePortsRedirectionParams object
...
/*PostIPLoadBalancingServiceNamePortsRedirectionParams contains all the parameters to send to the API endpoint
for the post IP load balancing service name ports redirection operation typically these are written to a http.Request
*/
...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionParams) WithIPLoadBalancingPortsRedirectionPost(iPLoadBalancingPortsRedirectionPost *models.IPLoadBalancingIPLoadBalancingPort) *PostIPLoadBalancingServiceNamePortsRedirectionParams {
	o.SetIPLoadBalancingPortsRedirectionPost(iPLoadBalancingPortsRedirectionPost)
	return o
}
...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionParams) SetIPLoadBalancingPortsRedirectionPost(iPLoadBalancingPortsRedirectionPost *models.IPLoadBalancingIPLoadBalancingPort) {
	o.IPLoadBalancingPortsRedirectionPost = iPLoadBalancingPortsRedirectionPost
}
...
func (o *PostIPLoadBalancingServiceNamePortsRedirectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPLoadBalancingPortsRedirectionPost != nil {
		if err := r.SetBodyParam(o.IPLoadBalancingPortsRedirectionPost); err != nil {
			return err
		}
	}

...
func (o *GetIPIPAntihackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetIPIPAntihackDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetIPIPAntihackOK) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/antihack][%d] getIpIpAntihackOK  %+v", 200, o.Payload)
}

func (o *GetIPIPAntihackOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetIPIPAntihackDefault) Error() string {
	return fmt.Sprintf("[GET /ip/{ip}/antihack][%d] GetIPIPAntihack default  %+v", o._statusCode, o.Payload)
}

func (o *GetIPIPAntihackDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetIPIPAntihackDefaultBody)

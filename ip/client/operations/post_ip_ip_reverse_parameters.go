...
// NewPostIPIPReverseParams creates a new PostIPIPReverseParams object
// with the default values initialized.
func NewPostIPIPReverseParams() *PostIPIPReverseParams {
	var ()
	return &PostIPIPReverseParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPIPReverseParamsWithTimeout creates a new PostIPIPReverseParams object
...
// NewPostIPIPReverseParamsWithContext creates a new PostIPIPReverseParams object
...
// NewPostIPIPReverseParamsWithHTTPClient creates a new PostIPIPReverseParams object
...
/*PostIPIPReverseParams contains all the parameters to send to the API endpoint
for the post IP IP reverse operation typically these are written to a http.Request
*/
...
func (o *PostIPIPReverseParams) WithIPReversePost(iPReversePost *models.PostIPIPReverseParamsBody) *PostIPIPReverseParams {
	o.SetIPReversePost(iPReversePost)
	return o
}
...
func (o *PostIPIPReverseParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPReversePost != nil {
		if err := r.SetBodyParam(o.IPReversePost); err != nil {
			return err
		}
	}

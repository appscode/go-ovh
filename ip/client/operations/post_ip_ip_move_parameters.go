...
// NewPostIPIPMoveParams creates a new PostIPIPMoveParams object
// with the default values initialized.
func NewPostIPIPMoveParams() *PostIPIPMoveParams {
	var ()
	return &PostIPIPMoveParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostIPIPMoveParamsWithTimeout creates a new PostIPIPMoveParams object
...
// NewPostIPIPMoveParamsWithContext creates a new PostIPIPMoveParams object
...
// NewPostIPIPMoveParamsWithHTTPClient creates a new PostIPIPMoveParams object
...
/*PostIPIPMoveParams contains all the parameters to send to the API endpoint
for the post IP IP move operation typically these are written to a http.Request
*/
...
func (o *PostIPIPMoveParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPMovePost != nil {
		if err := r.SetBodyParam(o.IPMovePost); err != nil {
			return err
		}
	}

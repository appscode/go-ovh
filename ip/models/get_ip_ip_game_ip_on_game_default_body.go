...
// GetIPIPGameIPOnGameDefaultBody get Ip Ip game Ip on game default body
// swagger:model getIpIpGameIpOnGameDefaultBody
...
func (m *GetIPIPGameIPOnGameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPGameIPOnGameDefaultBody

...
// GetIPLoadBalancingServiceNameTaskTaskIDDefaultBody get Ip load balancing service name task task Id default body
// swagger:model getIpLoadBalancingServiceNameTaskTaskIdDefaultBody
...
func (m *GetIPLoadBalancingServiceNameTaskTaskIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameTaskTaskIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameTaskTaskIDDefaultBody

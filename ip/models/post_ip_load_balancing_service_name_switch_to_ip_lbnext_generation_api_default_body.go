...
// PostIPLoadBalancingServiceNameSwitchToIPLBNextGenerationAPIDefaultBody post Ip load balancing service name switch to Ip l b next generation Api default body
// swagger:model postIpLoadBalancingServiceNameSwitchToIpLBNextGenerationApiDefaultBody
...
func (m *PostIPLoadBalancingServiceNameSwitchToIPLBNextGenerationAPIDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameSwitchToIPLBNextGenerationAPIDefaultBody

...
// GetIPLoadBalancingServiceNameBackendBackendDefaultBody get Ip load balancing service name backend backend default body
// swagger:model getIpLoadBalancingServiceNameBackendBackendDefaultBody
...
func (m *GetIPLoadBalancingServiceNameBackendBackendDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameBackendBackendDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameBackendBackendDefaultBody

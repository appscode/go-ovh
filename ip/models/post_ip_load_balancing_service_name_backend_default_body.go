...
// PostIPLoadBalancingServiceNameBackendDefaultBody post Ip load balancing service name backend default body
// swagger:model postIpLoadBalancingServiceNameBackendDefaultBody
...
func (m *PostIPLoadBalancingServiceNameBackendDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPLoadBalancingServiceNameBackendDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameBackendDefaultBody

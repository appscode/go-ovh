...
// PutIPLoadBalancingServiceNameServiceInfosDefaultBody put Ip load balancing service name service infos default body
// swagger:model putIpLoadBalancingServiceNameServiceInfosDefaultBody
...
func (m *PutIPLoadBalancingServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPLoadBalancingServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPLoadBalancingServiceNameServiceInfosDefaultBody

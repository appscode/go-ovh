...
// GetIPIPLicenseCloudLinuxDefaultBody get Ip Ip license cloud linux default body
// swagger:model getIpIpLicenseCloudLinuxDefaultBody
...
func (m *GetIPIPLicenseCloudLinuxDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseCloudLinuxDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseCloudLinuxDefaultBody

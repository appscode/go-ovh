...
// PostIPIPFirewallIPOnFirewallRuleDefaultBody post Ip Ip firewall Ip on firewall rule default body
// swagger:model postIpIpFirewallIpOnFirewallRuleDefaultBody
...
func (m *PostIPIPFirewallIPOnFirewallRuleDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPFirewallIPOnFirewallRuleDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPFirewallIPOnFirewallRuleDefaultBody

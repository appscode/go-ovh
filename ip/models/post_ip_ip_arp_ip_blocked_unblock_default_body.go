...
// PostIPIPArpIPBlockedUnblockDefaultBody post Ip Ip arp Ip blocked unblock default body
// swagger:model postIpIpArpIpBlockedUnblockDefaultBody
...
func (m *PostIPIPArpIPBlockedUnblockDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPArpIPBlockedUnblockDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPArpIPBlockedUnblockDefaultBody

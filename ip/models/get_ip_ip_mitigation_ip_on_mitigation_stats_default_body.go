...
// GetIPIPMitigationIPOnMitigationStatsDefaultBody get Ip Ip mitigation Ip on mitigation stats default body
// swagger:model getIpIpMitigationIpOnMitigationStatsDefaultBody
...
func (m *GetIPIPMitigationIPOnMitigationStatsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPMitigationIPOnMitigationStatsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMitigationIPOnMitigationStatsDefaultBody

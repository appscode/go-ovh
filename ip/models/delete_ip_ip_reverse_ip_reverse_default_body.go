...
// DeleteIPIPReverseIPReverseDefaultBody delete Ip Ip reverse Ip reverse default body
// swagger:model deleteIpIpReverseIpReverseDefaultBody
...
func (m *DeleteIPIPReverseIPReverseDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteIPIPReverseIPReverseDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPIPReverseIPReverseDefaultBody

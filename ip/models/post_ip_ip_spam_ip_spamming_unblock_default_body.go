...
// PostIPIPSpamIPSpammingUnblockDefaultBody post Ip Ip spam Ip spamming unblock default body
// swagger:model postIpIpSpamIpSpammingUnblockDefaultBody
...
func (m *PostIPIPSpamIPSpammingUnblockDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPSpamIPSpammingUnblockDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPSpamIPSpammingUnblockDefaultBody

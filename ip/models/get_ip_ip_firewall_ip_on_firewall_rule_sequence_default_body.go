...
// GetIPIPFirewallIPOnFirewallRuleSequenceDefaultBody get Ip Ip firewall Ip on firewall rule sequence default body
// swagger:model getIpIpFirewallIpOnFirewallRuleSequenceDefaultBody
...
func (m *GetIPIPFirewallIPOnFirewallRuleSequenceDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPFirewallIPOnFirewallRuleSequenceDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPFirewallIPOnFirewallRuleSequenceDefaultBody

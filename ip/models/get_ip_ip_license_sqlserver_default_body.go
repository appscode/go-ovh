...
// GetIPIPLicenseSqlserverDefaultBody get Ip Ip license sqlserver default body
// swagger:model getIpIpLicenseSqlserverDefaultBody
...
func (m *GetIPIPLicenseSqlserverDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseSqlserverDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseSqlserverDefaultBody

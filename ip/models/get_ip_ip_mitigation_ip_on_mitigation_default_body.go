...
// GetIPIPMitigationIPOnMitigationDefaultBody get Ip Ip mitigation Ip on mitigation default body
// swagger:model getIpIpMitigationIpOnMitigationDefaultBody
...
func (m *GetIPIPMitigationIPOnMitigationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPMitigationIPOnMitigationDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMitigationIPOnMitigationDefaultBody

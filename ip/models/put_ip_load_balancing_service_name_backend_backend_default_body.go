...
// PutIPLoadBalancingServiceNameBackendBackendDefaultBody put Ip load balancing service name backend backend default body
// swagger:model putIpLoadBalancingServiceNameBackendBackendDefaultBody
...
func (m *PutIPLoadBalancingServiceNameBackendBackendDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPLoadBalancingServiceNameBackendBackendDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPLoadBalancingServiceNameBackendBackendDefaultBody

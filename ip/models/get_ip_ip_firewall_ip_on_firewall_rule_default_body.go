...
// GetIPIPFirewallIPOnFirewallRuleDefaultBody get Ip Ip firewall Ip on firewall rule default body
// swagger:model getIpIpFirewallIpOnFirewallRuleDefaultBody
...
func (m *GetIPIPFirewallIPOnFirewallRuleDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPFirewallIPOnFirewallRuleDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPFirewallIPOnFirewallRuleDefaultBody

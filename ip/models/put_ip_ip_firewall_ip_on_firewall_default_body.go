...
// PutIPIPFirewallIPOnFirewallDefaultBody put Ip Ip firewall Ip on firewall default body
// swagger:model putIpIpFirewallIpOnFirewallDefaultBody
...
func (m *PutIPIPFirewallIPOnFirewallDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPIPFirewallIPOnFirewallDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPIPFirewallIPOnFirewallDefaultBody

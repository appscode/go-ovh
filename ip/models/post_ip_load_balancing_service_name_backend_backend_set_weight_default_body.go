...
// PostIPLoadBalancingServiceNameBackendBackendSetWeightDefaultBody post Ip load balancing service name backend backend set weight default body
// swagger:model postIpLoadBalancingServiceNameBackendBackendSetWeightDefaultBody
...
func (m *PostIPLoadBalancingServiceNameBackendBackendSetWeightDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameBackendBackendSetWeightDefaultBody

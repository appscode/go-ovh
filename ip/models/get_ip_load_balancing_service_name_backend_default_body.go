...
// GetIPLoadBalancingServiceNameBackendDefaultBody get Ip load balancing service name backend default body
// swagger:model getIpLoadBalancingServiceNameBackendDefaultBody
...
func (m *GetIPLoadBalancingServiceNameBackendDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameBackendDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameBackendDefaultBody

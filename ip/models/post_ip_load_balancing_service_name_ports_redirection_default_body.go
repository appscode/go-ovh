...
// PostIPLoadBalancingServiceNamePortsRedirectionDefaultBody post Ip load balancing service name ports redirection default body
// swagger:model postIpLoadBalancingServiceNamePortsRedirectionDefaultBody
...
func (m *PostIPLoadBalancingServiceNamePortsRedirectionDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNamePortsRedirectionDefaultBody

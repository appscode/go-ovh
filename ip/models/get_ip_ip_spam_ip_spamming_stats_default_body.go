...
// GetIPIPSpamIPSpammingStatsDefaultBody get Ip Ip spam Ip spamming stats default body
// swagger:model getIpIpSpamIpSpammingStatsDefaultBody
...
func (m *GetIPIPSpamIPSpammingStatsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPSpamIPSpammingStatsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPSpamIPSpammingStatsDefaultBody

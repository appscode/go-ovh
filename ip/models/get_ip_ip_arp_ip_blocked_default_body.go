...
// GetIPIPArpIPBlockedDefaultBody get Ip Ip arp Ip blocked default body
// swagger:model getIpIpArpIpBlockedDefaultBody
...
func (m *GetIPIPArpIPBlockedDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPArpIPBlockedDefaultBody

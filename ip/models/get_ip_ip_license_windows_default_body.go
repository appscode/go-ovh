...
// GetIPIPLicenseWindowsDefaultBody get Ip Ip license windows default body
// swagger:model getIpIpLicenseWindowsDefaultBody
...
func (m *GetIPIPLicenseWindowsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseWindowsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseWindowsDefaultBody

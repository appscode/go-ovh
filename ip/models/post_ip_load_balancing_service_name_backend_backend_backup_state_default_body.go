...
// PostIPLoadBalancingServiceNameBackendBackendBackupStateDefaultBody post Ip load balancing service name backend backend backup state default body
// swagger:model postIpLoadBalancingServiceNameBackendBackendBackupStateDefaultBody
...
func (m *PostIPLoadBalancingServiceNameBackendBackendBackupStateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameBackendBackendBackupStateDefaultBody

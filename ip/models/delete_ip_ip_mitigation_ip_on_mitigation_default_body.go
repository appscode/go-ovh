...
// DeleteIPIPMitigationIPOnMitigationDefaultBody delete Ip Ip mitigation Ip on mitigation default body
// swagger:model deleteIpIpMitigationIpOnMitigationDefaultBody
...
func (m *DeleteIPIPMitigationIPOnMitigationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteIPIPMitigationIPOnMitigationDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPIPMitigationIPOnMitigationDefaultBody

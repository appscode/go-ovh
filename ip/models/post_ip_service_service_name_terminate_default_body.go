...
// PostIPServiceServiceNameTerminateDefaultBody post Ip service service name terminate default body
// swagger:model postIpServiceServiceNameTerminateDefaultBody
...
func (m *PostIPServiceServiceNameTerminateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPServiceServiceNameTerminateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPServiceServiceNameTerminateDefaultBody

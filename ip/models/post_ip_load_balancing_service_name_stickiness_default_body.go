...
// PostIPLoadBalancingServiceNameStickinessDefaultBody post Ip load balancing service name stickiness default body
// swagger:model postIpLoadBalancingServiceNameStickinessDefaultBody
...
func (m *PostIPLoadBalancingServiceNameStickinessDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPLoadBalancingServiceNameStickinessDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameStickinessDefaultBody

...
// DeleteIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody delete Ip load balancing service name ports redirection src port default body
// swagger:model deleteIpLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody
...
func (m *DeleteIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody

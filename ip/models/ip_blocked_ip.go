...
func (m *IPBlockedIP) validateBlockedSince(formats strfmt.Registry) error {
...
func (m *IPBlockedIP) validateIPBlocked(formats strfmt.Registry) error {
...
var ipBlockedIpTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		ipBlockedIpTypeStatePropEnum = append(ipBlockedIpTypeStatePropEnum, v)
	}
}
...
// prop value enum
func (m *IPBlockedIP) validateStateEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, ipBlockedIpTypeStatePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *IPBlockedIP) validateState(formats strfmt.Registry) error {
...
func (m *IPBlockedIP) validateTime(formats strfmt.Registry) error {

...
// GetIPLoadBalancingServiceNameServiceInfosDefaultBody get Ip load balancing service name service infos default body
// swagger:model getIpLoadBalancingServiceNameServiceInfosDefaultBody
...
func (m *GetIPLoadBalancingServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameServiceInfosDefaultBody

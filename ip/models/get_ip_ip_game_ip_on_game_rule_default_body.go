...
// GetIPIPGameIPOnGameRuleDefaultBody get Ip Ip game Ip on game rule default body
// swagger:model getIpIpGameIpOnGameRuleDefaultBody
...
func (m *GetIPIPGameIPOnGameRuleDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPGameIPOnGameRuleDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPGameIPOnGameRuleDefaultBody

...
// PostIPIPMigrationTokenDefaultBody post Ip Ip migration token default body
// swagger:model postIpIpMigrationTokenDefaultBody
...
func (m *PostIPIPMigrationTokenDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPMigrationTokenDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPMigrationTokenDefaultBody

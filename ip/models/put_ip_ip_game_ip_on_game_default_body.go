...
// PutIPIPGameIPOnGameDefaultBody put Ip Ip game Ip on game default body
// swagger:model putIpIpGameIpOnGameDefaultBody
...
func (m *PutIPIPGameIPOnGameDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPIPGameIPOnGameDefaultBody

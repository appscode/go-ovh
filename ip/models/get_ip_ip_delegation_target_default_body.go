...
// GetIPIPDelegationTargetDefaultBody get Ip Ip delegation target default body
// swagger:model getIpIpDelegationTargetDefaultBody
...
func (m *GetIPIPDelegationTargetDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPDelegationTargetDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPDelegationTargetDefaultBody

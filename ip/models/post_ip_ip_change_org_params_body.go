...
// PostIPIPChangeOrgParamsBody post Ip Ip change org params body
// swagger:model postIpIpChangeOrgParamsBody
...
func (m *PostIPIPChangeOrgParamsBody) validateOrganisation(formats strfmt.Registry) error {
...
func (m *PostIPIPChangeOrgParamsBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPChangeOrgParamsBody

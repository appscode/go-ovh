...
// GetIPServiceServiceNameServiceInfosDefaultBody get Ip service service name service infos default body
// swagger:model getIpServiceServiceNameServiceInfosDefaultBody
...
func (m *GetIPServiceServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPServiceServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPServiceServiceNameServiceInfosDefaultBody

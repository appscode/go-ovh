...
// GetIPLoadBalancingServiceNameAllowedBackendsDefaultBody get Ip load balancing service name allowed backends default body
// swagger:model getIpLoadBalancingServiceNameAllowedBackendsDefaultBody
...
func (m *GetIPLoadBalancingServiceNameAllowedBackendsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameAllowedBackendsDefaultBody

...
// PostIPIPFirewallParamsBody post Ip Ip firewall params body
// swagger:model postIpIpFirewallParamsBody
...
func (m *PostIPIPFirewallParamsBody) validateIPOnFirewall(formats strfmt.Registry) error {

	if err := validate.Required("ipOnFirewall", "body", m.IPOnFirewall); err != nil {
		return err
	}
...
func (m *PostIPIPFirewallParamsBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPFirewallParamsBody

...
// GetIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody get Ip load balancing service name ports redirection src port default body
// swagger:model getIpLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody
...
func (m *GetIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNamePortsRedirectionSrcPortDefaultBody

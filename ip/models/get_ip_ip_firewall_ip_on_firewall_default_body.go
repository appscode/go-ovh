...
// GetIPIPFirewallIPOnFirewallDefaultBody get Ip Ip firewall Ip on firewall default body
// swagger:model getIpIpFirewallIpOnFirewallDefaultBody
...
func (m *GetIPIPFirewallIPOnFirewallDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPFirewallIPOnFirewallDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPFirewallIPOnFirewallDefaultBody

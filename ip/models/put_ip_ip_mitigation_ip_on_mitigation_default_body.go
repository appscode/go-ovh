...
// PutIPIPMitigationIPOnMitigationDefaultBody put Ip Ip mitigation Ip on mitigation default body
// swagger:model putIpIpMitigationIpOnMitigationDefaultBody
...
func (m *PutIPIPMitigationIPOnMitigationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPIPMitigationIPOnMitigationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPIPMitigationIPOnMitigationDefaultBody

...
// GetIPIPMigrationTokenDefaultBody get Ip Ip migration token default body
// swagger:model getIpIpMigrationTokenDefaultBody
...
func (m *GetIPIPMigrationTokenDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPMigrationTokenDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMigrationTokenDefaultBody

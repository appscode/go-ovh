...
// GetIPIPGameIPOnGameRuleIDDefaultBody get Ip Ip game Ip on game rule Id default body
// swagger:model getIpIpGameIpOnGameRuleIdDefaultBody
...
func (m *GetIPIPGameIPOnGameRuleIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPGameIPOnGameRuleIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPGameIPOnGameRuleIDDefaultBody

...
// PostIPIPMitigationProfilesDefaultBody post Ip Ip mitigation profiles default body
// swagger:model postIpIpMitigationProfilesDefaultBody
...
func (m *PostIPIPMitigationProfilesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPMitigationProfilesDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPMitigationProfilesDefaultBody

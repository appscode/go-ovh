...
// PostIPLoadBalancingServiceNameRestoreSslDefaultBody post Ip load balancing service name restore ssl default body
// swagger:model postIpLoadBalancingServiceNameRestoreSslDefaultBody
...
func (m *PostIPLoadBalancingServiceNameRestoreSslDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPLoadBalancingServiceNameRestoreSslDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameRestoreSslDefaultBody

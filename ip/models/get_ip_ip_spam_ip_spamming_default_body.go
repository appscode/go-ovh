...
// GetIPIPSpamIPSpammingDefaultBody get Ip Ip spam Ip spamming default body
// swagger:model getIpIpSpamIpSpammingDefaultBody
...
func (m *GetIPIPSpamIPSpammingDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPSpamIPSpammingDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPSpamIPSpammingDefaultBody

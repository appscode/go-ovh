...
// GetIPLoadBalancingServiceNameDefaultBody get Ip load balancing service name default body
// swagger:model getIpLoadBalancingServiceNameDefaultBody
...
func (m *GetIPLoadBalancingServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameDefaultBody

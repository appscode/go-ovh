...
// PutIPIPMitigationProfilesIPMitigationProfileDefaultBody put Ip Ip mitigation profiles Ip mitigation profile default body
// swagger:model putIpIpMitigationProfilesIpMitigationProfileDefaultBody
...
func (m *PutIPIPMitigationProfilesIPMitigationProfileDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPIPMitigationProfilesIPMitigationProfileDefaultBody

...
// DeleteIPIPFirewallIPOnFirewallDefaultBody delete Ip Ip firewall Ip on firewall default body
// swagger:model deleteIpIpFirewallIpOnFirewallDefaultBody
...
func (m *DeleteIPIPFirewallIPOnFirewallDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteIPIPFirewallIPOnFirewallDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPIPFirewallIPOnFirewallDefaultBody

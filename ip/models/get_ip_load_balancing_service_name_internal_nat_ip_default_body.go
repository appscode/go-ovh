...
// GetIPLoadBalancingServiceNameInternalNatIPDefaultBody get Ip load balancing service name internal nat Ip default body
// swagger:model getIpLoadBalancingServiceNameInternalNatIpDefaultBody
...
func (m *GetIPLoadBalancingServiceNameInternalNatIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameInternalNatIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameInternalNatIPDefaultBody

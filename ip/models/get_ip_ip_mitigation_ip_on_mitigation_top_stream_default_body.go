...
// GetIPIPMitigationIPOnMitigationTopStreamDefaultBody get Ip Ip mitigation Ip on mitigation top stream default body
// swagger:model getIpIpMitigationIpOnMitigationTopStreamDefaultBody
...
func (m *GetIPIPMitigationIPOnMitigationTopStreamDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPMitigationIPOnMitigationTopStreamDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMitigationIPOnMitigationTopStreamDefaultBody

...
// GetIPLoadBalancingServiceNamePortsRedirectionDefaultBody get Ip load balancing service name ports redirection default body
// swagger:model getIpLoadBalancingServiceNamePortsRedirectionDefaultBody
...
func (m *GetIPLoadBalancingServiceNamePortsRedirectionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNamePortsRedirectionDefaultBody

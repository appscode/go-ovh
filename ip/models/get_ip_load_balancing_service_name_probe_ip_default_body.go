...
// GetIPLoadBalancingServiceNameProbeIPDefaultBody get Ip load balancing service name probe Ip default body
// swagger:model getIpLoadBalancingServiceNameProbeIpDefaultBody
...
func (m *GetIPLoadBalancingServiceNameProbeIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameProbeIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameProbeIPDefaultBody

...
// GetIPIPReverseIPReverseDefaultBody get Ip Ip reverse Ip reverse default body
// swagger:model getIpIpReverseIpReverseDefaultBody
...
func (m *GetIPIPReverseIPReverseDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPReverseIPReverseDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPReverseIPReverseDefaultBody

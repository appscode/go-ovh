...
// GetIPIPLicenseVirtuozzoDefaultBody get Ip Ip license virtuozzo default body
// swagger:model getIpIpLicenseVirtuozzoDefaultBody
...
func (m *GetIPIPLicenseVirtuozzoDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseVirtuozzoDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseVirtuozzoDefaultBody

...
// PostIPServiceServiceNameConfirmTerminationDefaultBody post Ip service service name confirm termination default body
// swagger:model postIpServiceServiceNameConfirmTerminationDefaultBody
...
func (m *PostIPServiceServiceNameConfirmTerminationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPServiceServiceNameConfirmTerminationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPServiceServiceNameConfirmTerminationDefaultBody

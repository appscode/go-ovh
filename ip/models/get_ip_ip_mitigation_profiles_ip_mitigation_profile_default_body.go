...
// GetIPIPMitigationProfilesIPMitigationProfileDefaultBody get Ip Ip mitigation profiles Ip mitigation profile default body
// swagger:model getIpIpMitigationProfilesIpMitigationProfileDefaultBody
...
func (m *GetIPIPMitigationProfilesIPMitigationProfileDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMitigationProfilesIPMitigationProfileDefaultBody

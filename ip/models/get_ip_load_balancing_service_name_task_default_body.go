...
// GetIPLoadBalancingServiceNameTaskDefaultBody get Ip load balancing service name task default body
// swagger:model getIpLoadBalancingServiceNameTaskDefaultBody
...
func (m *GetIPLoadBalancingServiceNameTaskDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPLoadBalancingServiceNameTaskDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPLoadBalancingServiceNameTaskDefaultBody

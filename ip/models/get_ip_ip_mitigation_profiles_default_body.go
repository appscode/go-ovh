...
// GetIPIPMitigationProfilesDefaultBody get Ip Ip mitigation profiles default body
// swagger:model getIpIpMitigationProfilesDefaultBody
...
func (m *GetIPIPMitigationProfilesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPMitigationProfilesDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPMitigationProfilesDefaultBody

...
// DeleteIPLoadBalancingServiceNameBackendBackendDefaultBody delete Ip load balancing service name backend backend default body
// swagger:model deleteIpLoadBalancingServiceNameBackendBackendDefaultBody
...
func (m *DeleteIPLoadBalancingServiceNameBackendBackendDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPLoadBalancingServiceNameBackendBackendDefaultBody

...
// PostIPIPAntihackIPBlockedUnblockDefaultBody post Ip Ip antihack Ip blocked unblock default body
// swagger:model postIpIpAntihackIpBlockedUnblockDefaultBody
...
func (m *PostIPIPAntihackIPBlockedUnblockDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPAntihackIPBlockedUnblockDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPAntihackIPBlockedUnblockDefaultBody

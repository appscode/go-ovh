...
// PostIPServiceServiceNameChangeContactDefaultBody post Ip service service name change contact default body
// swagger:model postIpServiceServiceNameChangeContactDefaultBody
...
func (m *PostIPServiceServiceNameChangeContactDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPServiceServiceNameChangeContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPServiceServiceNameChangeContactDefaultBody

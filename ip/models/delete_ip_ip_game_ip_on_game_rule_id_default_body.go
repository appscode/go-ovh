...
// DeleteIPIPGameIPOnGameRuleIDDefaultBody delete Ip Ip game Ip on game rule Id default body
// swagger:model deleteIpIpGameIpOnGameRuleIdDefaultBody
...
func (m *DeleteIPIPGameIPOnGameRuleIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteIPIPGameIPOnGameRuleIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPIPGameIPOnGameRuleIDDefaultBody

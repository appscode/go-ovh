...
// DeleteIPIPDelegationTargetDefaultBody delete Ip Ip delegation target default body
// swagger:model deleteIpIpDelegationTargetDefaultBody
...
func (m *DeleteIPIPDelegationTargetDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteIPIPDelegationTargetDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteIPIPDelegationTargetDefaultBody

...
// PostIPLoadBalancingServiceNameBackendBackendSetWeightParamsBody post Ip load balancing service name backend backend set weight params body
// swagger:model postIpLoadBalancingServiceNameBackendBackendSetWeightParamsBody
...
func (m *PostIPLoadBalancingServiceNameBackendBackendSetWeightParamsBody) validateWeight(formats strfmt.Registry) error {
...
func (m *PostIPLoadBalancingServiceNameBackendBackendSetWeightParamsBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameBackendBackendSetWeightParamsBody

...
// PutIPServiceServiceNameDefaultBody put Ip service service name default body
// swagger:model putIpServiceServiceNameDefaultBody
...
func (m *PutIPServiceServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutIPServiceServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutIPServiceServiceNameDefaultBody

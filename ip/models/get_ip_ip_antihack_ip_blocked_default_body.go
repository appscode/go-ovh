...
// GetIPIPAntihackIPBlockedDefaultBody get Ip Ip antihack Ip blocked default body
// swagger:model getIpIpAntihackIpBlockedDefaultBody
...
func (m *GetIPIPAntihackIPBlockedDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPAntihackIPBlockedDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPAntihackIPBlockedDefaultBody

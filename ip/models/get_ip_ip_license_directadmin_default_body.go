...
// GetIPIPLicenseDirectadminDefaultBody get Ip Ip license directadmin default body
// swagger:model getIpIpLicenseDirectadminDefaultBody
...
func (m *GetIPIPLicenseDirectadminDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseDirectadminDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseDirectadminDefaultBody

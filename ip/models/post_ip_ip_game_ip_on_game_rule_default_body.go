...
// PostIPIPGameIPOnGameRuleDefaultBody post Ip Ip game Ip on game rule default body
// swagger:model postIpIpGameIpOnGameRuleDefaultBody
...
func (m *PostIPIPGameIPOnGameRuleDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPIPGameIPOnGameRuleDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPIPGameIPOnGameRuleDefaultBody

...
// PostIPLoadBalancingServiceNameImportCustomSslDefaultBody post Ip load balancing service name import custom ssl default body
// swagger:model postIpLoadBalancingServiceNameImportCustomSslDefaultBody
...
func (m *PostIPLoadBalancingServiceNameImportCustomSslDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostIPLoadBalancingServiceNameImportCustomSslDefaultBody

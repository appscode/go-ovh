...
// GetIPIPLicenseCpanelDefaultBody get Ip Ip license cpanel default body
// swagger:model getIpIpLicenseCpanelDefaultBody
...
func (m *GetIPIPLicenseCpanelDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseCpanelDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseCpanelDefaultBody

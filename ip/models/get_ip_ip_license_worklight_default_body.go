...
// GetIPIPLicenseWorklightDefaultBody get Ip Ip license worklight default body
// swagger:model getIpIpLicenseWorklightDefaultBody
...
func (m *GetIPIPLicenseWorklightDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPIPLicenseWorklightDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPIPLicenseWorklightDefaultBody

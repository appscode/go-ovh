...
// GetIPServiceServiceNameDefaultBody get Ip service service name default body
// swagger:model getIpServiceServiceNameDefaultBody
...
func (m *GetIPServiceServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIPServiceServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetIPServiceServiceNameDefaultBody

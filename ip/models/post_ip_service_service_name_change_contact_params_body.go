...
// PostIPServiceServiceNameChangeContactParamsBody post Ip service service name change contact params body
// swagger:model postIpServiceServiceNameChangeContactParamsBody
...
func (m *PostIPServiceServiceNameChangeContactParamsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostIPServiceServiceNameChangeContactParamsBody) UnmarshalBinary(b []byte) error {
	var res PostIPServiceServiceNameChangeContactParamsBody

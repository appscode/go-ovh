...
// PostVrackServiceNameLegacyVrackDefaultBody post vrack service name legacy vrack default body
// swagger:model postVrackServiceNameLegacyVrackDefaultBody
...
func (m *PostVrackServiceNameLegacyVrackDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostVrackServiceNameLegacyVrackDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVrackServiceNameLegacyVrackDefaultBody

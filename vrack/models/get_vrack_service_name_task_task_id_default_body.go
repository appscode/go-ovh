...
// GetVrackServiceNameTaskTaskIDDefaultBody get vrack service name task task Id default body
// swagger:model getVrackServiceNameTaskTaskIdDefaultBody
...
func (m *GetVrackServiceNameTaskTaskIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameTaskTaskIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameTaskTaskIDDefaultBody

...
// VrackIPLB ipLoadbalancing in vrack
// swagger:model vrack.Iplb
...
func (m *VrackIPLB) validateIPLB(formats strfmt.Registry) error {
...
func (m *VrackIPLB) validateVrack(formats strfmt.Registry) error {

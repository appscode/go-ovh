...
// GetVrackServiceNameCloudProjectDefaultBody get vrack service name cloud project default body
// swagger:model getVrackServiceNameCloudProjectDefaultBody
...
func (m *GetVrackServiceNameCloudProjectDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameCloudProjectDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameCloudProjectDefaultBody

...
// GetVrackServiceNameLegacyVrackDefaultBody get vrack service name legacy vrack default body
// swagger:model getVrackServiceNameLegacyVrackDefaultBody
...
func (m *GetVrackServiceNameLegacyVrackDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameLegacyVrackDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameLegacyVrackDefaultBody

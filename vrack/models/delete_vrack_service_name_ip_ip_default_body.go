...
// DeleteVrackServiceNameIPIPDefaultBody delete vrack service name Ip Ip default body
// swagger:model deleteVrackServiceNameIpIpDefaultBody
...
func (m *DeleteVrackServiceNameIPIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteVrackServiceNameIPIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVrackServiceNameIPIPDefaultBody

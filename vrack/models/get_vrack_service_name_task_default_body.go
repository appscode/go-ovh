...
// GetVrackServiceNameTaskDefaultBody get vrack service name task default body
// swagger:model getVrackServiceNameTaskDefaultBody
...
func (m *GetVrackServiceNameTaskDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameTaskDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameTaskDefaultBody

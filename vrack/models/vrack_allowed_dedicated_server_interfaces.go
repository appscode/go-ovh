...
// VrackAllowedDedicatedServerInterfaces A structure giving all dedicated server interfaces allowed for this vrack
// swagger:model vrack.AllowedDedicatedServerInterfaces
...
func (m *VrackAllowedDedicatedServerInterfaces) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VrackAllowedDedicatedServerInterfaces) UnmarshalBinary(b []byte) error {
	var res VrackAllowedDedicatedServerInterfaces

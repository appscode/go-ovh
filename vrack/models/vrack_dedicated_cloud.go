...
// swagger:model vrack.DedicatedCloud
...
func (m *VrackDedicatedCloud) validateDedicatedCloud(formats strfmt.Registry) error {
...
func (m *VrackDedicatedCloud) validateVrack(formats strfmt.Registry) error {

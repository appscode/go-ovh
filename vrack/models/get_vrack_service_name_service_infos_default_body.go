...
// GetVrackServiceNameServiceInfosDefaultBody get vrack service name service infos default body
// swagger:model getVrackServiceNameServiceInfosDefaultBody
...
func (m *GetVrackServiceNameServiceInfosDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameServiceInfosDefaultBody

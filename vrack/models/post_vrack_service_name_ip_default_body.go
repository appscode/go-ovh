...
// PostVrackServiceNameIPDefaultBody post vrack service name Ip default body
// swagger:model postVrackServiceNameIpDefaultBody
...
func (m *PostVrackServiceNameIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostVrackServiceNameIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVrackServiceNameIPDefaultBody

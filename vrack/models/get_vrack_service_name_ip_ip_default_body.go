...
// GetVrackServiceNameIPIPDefaultBody get vrack service name Ip Ip default body
// swagger:model getVrackServiceNameIpIpDefaultBody
...
func (m *GetVrackServiceNameIPIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameIPIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameIPIPDefaultBody

...
// swagger:model dedicated.Server.MrtgTimestampValue
...
func (m *DedicatedServerMrtgTimestampValue) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DedicatedServerMrtgTimestampValue) validateValue(formats strfmt.Registry) error {
...
func (m *DedicatedServerMrtgTimestampValue) UnmarshalBinary(b []byte) error {
	var res DedicatedServerMrtgTimestampValue

...
// PostVrackServiceNameCloudProjectDefaultBody post vrack service name cloud project default body
// swagger:model postVrackServiceNameCloudProjectDefaultBody
...
func (m *PostVrackServiceNameCloudProjectDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostVrackServiceNameCloudProjectDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVrackServiceNameCloudProjectDefaultBody

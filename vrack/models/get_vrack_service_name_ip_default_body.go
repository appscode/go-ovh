...
// GetVrackServiceNameIPDefaultBody get vrack service name Ip default body
// swagger:model getVrackServiceNameIpDefaultBody
...
func (m *GetVrackServiceNameIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetVrackServiceNameIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVrackServiceNameIPDefaultBody

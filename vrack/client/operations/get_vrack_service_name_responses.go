...
func (o *GetVrackServiceNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVrackServiceNameOK()
	...
	default:
		result := NewGetVrackServiceNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetVrackServiceNameOK) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}][%d] getVrackServiceNameOK  %+v", 200, o.Payload)
}

func (o *GetVrackServiceNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVrackServiceNameDefault(code int) *GetVrackServiceNameDefault {
	return &GetVrackServiceNameDefault{
		_statusCode: code,
	}
}
...
func (o *GetVrackServiceNameDefault) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}][%d] GetVrackServiceName default  %+v", o._statusCode, o.Payload)
}

func (o *GetVrackServiceNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVrackServiceNameDefaultBody)

...
func (o *GetVrackServiceNameLegacyVrackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVrackServiceNameLegacyVrackOK()
	...
	default:
		result := NewGetVrackServiceNameLegacyVrackDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVrackServiceNameLegacyVrackOK() *GetVrackServiceNameLegacyVrackOK {
	return &GetVrackServiceNameLegacyVrackOK{}
}
...
func (o *GetVrackServiceNameLegacyVrackOK) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/legacyVrack][%d] getVrackServiceNameLegacyVrackOK  %+v", 200, o.Payload)
}

func (o *GetVrackServiceNameLegacyVrackOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVrackServiceNameLegacyVrackDefault(code int) *GetVrackServiceNameLegacyVrackDefault {
	return &GetVrackServiceNameLegacyVrackDefault{
		_statusCode: code,
	}
}
...
func (o *GetVrackServiceNameLegacyVrackDefault) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/legacyVrack][%d] GetVrackServiceNameLegacyVrack default  %+v", o._statusCode, o.Payload)
}

func (o *GetVrackServiceNameLegacyVrackDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVrackServiceNameLegacyVrackDefaultBody)

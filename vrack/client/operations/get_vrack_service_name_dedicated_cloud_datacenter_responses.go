...
func (o *GetVrackServiceNameDedicatedCloudDatacenterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVrackServiceNameDedicatedCloudDatacenterOK()
	...
	default:
		result := NewGetVrackServiceNameDedicatedCloudDatacenterDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVrackServiceNameDedicatedCloudDatacenterOK() *GetVrackServiceNameDedicatedCloudDatacenterOK {
	return &GetVrackServiceNameDedicatedCloudDatacenterOK{}
}
...
func (o *GetVrackServiceNameDedicatedCloudDatacenterOK) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/dedicatedCloudDatacenter][%d] getVrackServiceNameDedicatedCloudDatacenterOK  %+v", 200, o.Payload)
}

func (o *GetVrackServiceNameDedicatedCloudDatacenterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVrackServiceNameDedicatedCloudDatacenterDefault(code int) *GetVrackServiceNameDedicatedCloudDatacenterDefault {
	return &GetVrackServiceNameDedicatedCloudDatacenterDefault{
		_statusCode: code,
	}
}
...
func (o *GetVrackServiceNameDedicatedCloudDatacenterDefault) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/dedicatedCloudDatacenter][%d] GetVrackServiceNameDedicatedCloudDatacenter default  %+v", o._statusCode, o.Payload)
}

func (o *GetVrackServiceNameDedicatedCloudDatacenterDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVrackServiceNameDedicatedCloudDatacenterDefaultBody)

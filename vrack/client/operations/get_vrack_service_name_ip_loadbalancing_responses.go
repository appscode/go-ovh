...
func (o *GetVrackServiceNameIPLoadbalancingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVrackServiceNameIPLoadbalancingOK()
	...
	default:
		result := NewGetVrackServiceNameIPLoadbalancingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVrackServiceNameIPLoadbalancingOK() *GetVrackServiceNameIPLoadbalancingOK {
	return &GetVrackServiceNameIPLoadbalancingOK{}
}
...
func (o *GetVrackServiceNameIPLoadbalancingOK) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/ipLoadbalancing][%d] getVrackServiceNameIpLoadbalancingOK  %+v", 200, o.Payload)
}

func (o *GetVrackServiceNameIPLoadbalancingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVrackServiceNameIPLoadbalancingDefault(code int) *GetVrackServiceNameIPLoadbalancingDefault {
	return &GetVrackServiceNameIPLoadbalancingDefault{
		_statusCode: code,
	}
}
...
func (o *GetVrackServiceNameIPLoadbalancingDefault) Error() string {
	return fmt.Sprintf("[GET /vrack/{serviceName}/ipLoadbalancing][%d] GetVrackServiceNameIPLoadbalancing default  %+v", o._statusCode, o.Payload)
}

func (o *GetVrackServiceNameIPLoadbalancingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVrackServiceNameIPLoadbalancingDefaultBody)

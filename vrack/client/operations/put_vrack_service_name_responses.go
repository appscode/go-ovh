...
func (o *PutVrackServiceNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutVrackServiceNameOK()
	...
	default:
		result := NewPutVrackServiceNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PutVrackServiceNameOK) Error() string {
	return fmt.Sprintf("[PUT /vrack/{serviceName}][%d] putVrackServiceNameOK ", 200)
}

func (o *PutVrackServiceNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutVrackServiceNameDefault(code int) *PutVrackServiceNameDefault {
	return &PutVrackServiceNameDefault{
		_statusCode: code,
	}
}
...
func (o *PutVrackServiceNameDefault) Error() string {
	return fmt.Sprintf("[PUT /vrack/{serviceName}][%d] PutVrackServiceName default  %+v", o._statusCode, o.Payload)
}

func (o *PutVrackServiceNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutVrackServiceNameDefaultBody)

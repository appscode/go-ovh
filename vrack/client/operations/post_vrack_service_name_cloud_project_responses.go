...
func (o *PostVrackServiceNameCloudProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostVrackServiceNameCloudProjectOK()
	...
	default:
		result := NewPostVrackServiceNameCloudProjectDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostVrackServiceNameCloudProjectOK() *PostVrackServiceNameCloudProjectOK {
	return &PostVrackServiceNameCloudProjectOK{}
}
...
func (o *PostVrackServiceNameCloudProjectOK) Error() string {
	return fmt.Sprintf("[POST /vrack/{serviceName}/cloudProject][%d] postVrackServiceNameCloudProjectOK  %+v", 200, o.Payload)
}

func (o *PostVrackServiceNameCloudProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostVrackServiceNameCloudProjectDefault(code int) *PostVrackServiceNameCloudProjectDefault {
	return &PostVrackServiceNameCloudProjectDefault{
		_statusCode: code,
	}
}
...
func (o *PostVrackServiceNameCloudProjectDefault) Error() string {
	return fmt.Sprintf("[POST /vrack/{serviceName}/cloudProject][%d] PostVrackServiceNameCloudProject default  %+v", o._statusCode, o.Payload)
}

func (o *PostVrackServiceNameCloudProjectDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostVrackServiceNameCloudProjectDefaultBody)

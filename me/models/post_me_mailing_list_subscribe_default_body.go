...
// PostMeMailingListSubscribeDefaultBody post me mailing list subscribe default body
// swagger:model postMeMailingListSubscribeDefaultBody
...
func (m *PostMeMailingListSubscribeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeMailingListSubscribeDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeMailingListSubscribeDefaultBody

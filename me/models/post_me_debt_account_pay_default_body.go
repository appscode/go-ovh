...
// PostMeDebtAccountPayDefaultBody post me debt account pay default body
// swagger:model postMeDebtAccountPayDefaultBody
...
func (m *PostMeDebtAccountPayDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeDebtAccountPayDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeDebtAccountPayDefaultBody

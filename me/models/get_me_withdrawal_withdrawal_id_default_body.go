...
// GetMeWithdrawalWithdrawalIDDefaultBody get me withdrawal withdrawal Id default body
// swagger:model getMeWithdrawalWithdrawalIdDefaultBody
...
func (m *GetMeWithdrawalWithdrawalIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeWithdrawalWithdrawalIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeWithdrawalWithdrawalIDDefaultBody

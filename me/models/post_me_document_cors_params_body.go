...
// PostMeDocumentCorsParamsBody post me document cors params body
// swagger:model postMeDocumentCorsParamsBody
...
func (m *PostMeDocumentCorsParamsBody) validateOrigin(formats strfmt.Registry) error {
...
func (m *PostMeDocumentCorsParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeDocumentCorsParamsBody

...
// PostMeAgreementsIDAcceptDefaultBody post me agreements Id accept default body
// swagger:model postMeAgreementsIdAcceptDefaultBody
...
func (m *PostMeAgreementsIDAcceptDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeAgreementsIDAcceptDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeAgreementsIDAcceptDefaultBody

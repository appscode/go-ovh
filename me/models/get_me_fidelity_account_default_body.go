...
// GetMeFidelityAccountDefaultBody get me fidelity account default body
// swagger:model getMeFidelityAccountDefaultBody
...
func (m *GetMeFidelityAccountDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeFidelityAccountDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeFidelityAccountDefaultBody

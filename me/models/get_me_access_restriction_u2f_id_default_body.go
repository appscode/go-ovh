...
// GetMeAccessRestrictionU2fIDDefaultBody get me access restriction u2f Id default body
// swagger:model getMeAccessRestrictionU2fIdDefaultBody
...
func (m *GetMeAccessRestrictionU2fIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionU2fIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionU2fIDDefaultBody

...
// GetMePaymentMeanCreditCardDefaultBody get me payment mean credit card default body
// swagger:model getMePaymentMeanCreditCardDefaultBody
...
func (m *GetMePaymentMeanCreditCardDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanCreditCardDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanCreditCardDefaultBody

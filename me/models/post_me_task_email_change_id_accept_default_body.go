...
// PostMeTaskEmailChangeIDAcceptDefaultBody post me task email change Id accept default body
// swagger:model postMeTaskEmailChangeIdAcceptDefaultBody
...
func (m *PostMeTaskEmailChangeIDAcceptDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskEmailChangeIDAcceptDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskEmailChangeIDAcceptDefaultBody

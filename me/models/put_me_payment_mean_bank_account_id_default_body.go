...
// PutMePaymentMeanBankAccountIDDefaultBody put me payment mean bank account Id default body
// swagger:model putMePaymentMeanBankAccountIdDefaultBody
...
func (m *PutMePaymentMeanBankAccountIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMePaymentMeanBankAccountIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMePaymentMeanBankAccountIDDefaultBody

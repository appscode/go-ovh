...
// PutMeAccessRestrictionSmsIDDefaultBody put me access restriction sms Id default body
// swagger:model putMeAccessRestrictionSmsIdDefaultBody
...
func (m *PutMeAccessRestrictionSmsIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeAccessRestrictionSmsIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeAccessRestrictionSmsIDDefaultBody

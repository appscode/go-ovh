...
// NichandleAccessRestrictionSmsSecret Describe secret key
// swagger:model nichandle.AccessRestriction.SmsSecret
...
func (m *NichandleAccessRestrictionSmsSecret) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionSmsSecret) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionSmsSecret

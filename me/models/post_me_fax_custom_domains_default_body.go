...
// PostMeFaxCustomDomainsDefaultBody post me fax custom domains default body
// swagger:model postMeFaxCustomDomainsDefaultBody
...
func (m *PostMeFaxCustomDomainsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeFaxCustomDomainsDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeFaxCustomDomainsDefaultBody

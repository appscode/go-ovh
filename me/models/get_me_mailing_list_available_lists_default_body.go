...
// GetMeMailingListAvailableListsDefaultBody get me mailing list available lists default body
// swagger:model getMeMailingListAvailableListsDefaultBody
...
func (m *GetMeMailingListAvailableListsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeMailingListAvailableListsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeMailingListAvailableListsDefaultBody

...
// PostMeTelephonySettingsDefaultBody post me telephony settings default body
// swagger:model postMeTelephonySettingsDefaultBody
...
func (m *PostMeTelephonySettingsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTelephonySettingsDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTelephonySettingsDefaultBody

...
// PostMeOrderOrderIDDebtPayDefaultBody post me order order Id debt pay default body
// swagger:model postMeOrderOrderIdDebtPayDefaultBody
...
func (m *PostMeOrderOrderIDDebtPayDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeOrderOrderIDDebtPayDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeOrderOrderIDDebtPayDefaultBody

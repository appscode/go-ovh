...
// GetMeOrderOrderIDRefundDefaultBody get me order order Id refund default body
// swagger:model getMeOrderOrderIdRefundDefaultBody
...
func (m *GetMeOrderOrderIDRefundDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDRefundDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDRefundDefaultBody

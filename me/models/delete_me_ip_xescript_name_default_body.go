...
// DeleteMeIPXEScriptNameDefaultBody delete me Ip x e script name default body
// swagger:model deleteMeIpXEScriptNameDefaultBody
...
func (m *DeleteMeIPXEScriptNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeIPXEScriptNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeIPXEScriptNameDefaultBody

...
func (m *NichandleIPXE) validateName(formats strfmt.Registry) error {
...
func (m *NichandleIPXE) validateScript(formats strfmt.Registry) error {

	if err := validate.RequiredString("script", "body", string(m.Script)); err != nil {
		return err
	}

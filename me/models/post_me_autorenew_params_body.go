...
// PostMeAutorenewParamsBody post me autorenew params body
// swagger:model postMeAutorenewParamsBody
...
func (m *PostMeAutorenewParamsBody) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRenewDay(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *PostMeAutorenewParamsBody) validateRenewDay(formats strfmt.Registry) error {

	if err := validate.Required("renewDay", "body", m.RenewDay); err != nil {
		return err
	}
...
func (m *PostMeAutorenewParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeAutorenewParamsBody

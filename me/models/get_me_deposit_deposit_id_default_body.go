...
// GetMeDepositDepositIDDefaultBody get me deposit deposit Id default body
// swagger:model getMeDepositDepositIdDefaultBody
...
func (m *GetMeDepositDepositIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDepositDepositIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDepositDepositIDDefaultBody

...
// NichandleAccessRestrictionSOTPValidate Describe SOTP validation status
// swagger:model nichandle.AccessRestriction.SOTPValidate
...
func (m *NichandleAccessRestrictionSOTPValidate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionSOTPValidate) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionSOTPValidate

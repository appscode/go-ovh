...
// swagger:model nichandle.AccessRestriction.SmsAccount
...
func (m *NichandleAccessRestrictionSmsAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionSmsAccount) validateCreationDate(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionSmsAccount) validateID(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionSmsAccount) validatePhoneNumber(formats strfmt.Registry) error {

	if err := validate.RequiredString("phoneNumber", "body", string(m.PhoneNumber)); err != nil {
		return err
	}
...
var nichandleAccessRestrictionSmsAccountTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		nichandleAccessRestrictionSmsAccountTypeStatusPropEnum = append(nichandleAccessRestrictionSmsAccountTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *NichandleAccessRestrictionSmsAccount) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, nichandleAccessRestrictionSmsAccountTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *NichandleAccessRestrictionSmsAccount) validateStatus(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionSmsAccount) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionSmsAccount

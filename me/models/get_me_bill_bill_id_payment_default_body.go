...
// GetMeBillBillIDPaymentDefaultBody get me bill bill Id payment default body
// swagger:model getMeBillBillIdPaymentDefaultBody
...
func (m *GetMeBillBillIDPaymentDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeBillBillIDPaymentDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeBillBillIDPaymentDefaultBody

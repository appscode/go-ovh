...
// GetMeOrderOrderIDPaymentMeansDefaultBody get me order order Id payment means default body
// swagger:model getMeOrderOrderIdPaymentMeansDefaultBody
...
func (m *GetMeOrderOrderIDPaymentMeansDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDPaymentMeansDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDPaymentMeansDefaultBody

...
// GetMeRefundRefundIDDetailsDefaultBody get me refund refund Id details default body
// swagger:model getMeRefundRefundIdDetailsDefaultBody
...
func (m *GetMeRefundRefundIDDetailsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeRefundRefundIDDetailsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeRefundRefundIDDetailsDefaultBody

...
// GetMeNotificationEmailHistoryDefaultBody get me notification email history default body
// swagger:model getMeNotificationEmailHistoryDefaultBody
...
func (m *GetMeNotificationEmailHistoryDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeNotificationEmailHistoryDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeNotificationEmailHistoryDefaultBody

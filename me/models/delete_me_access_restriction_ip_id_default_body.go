...
// DeleteMeAccessRestrictionIPIDDefaultBody delete me access restriction Ip Id default body
// swagger:model deleteMeAccessRestrictionIpIdDefaultBody
...
func (m *DeleteMeAccessRestrictionIPIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeAccessRestrictionIPIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeAccessRestrictionIPIDDefaultBody

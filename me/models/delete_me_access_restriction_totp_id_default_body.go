...
// DeleteMeAccessRestrictionTotpIDDefaultBody delete me access restriction totp Id default body
// swagger:model deleteMeAccessRestrictionTotpIdDefaultBody
...
func (m *DeleteMeAccessRestrictionTotpIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeAccessRestrictionTotpIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeAccessRestrictionTotpIDDefaultBody

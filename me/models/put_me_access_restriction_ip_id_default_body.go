...
// PutMeAccessRestrictionIPIDDefaultBody put me access restriction Ip Id default body
// swagger:model putMeAccessRestrictionIpIdDefaultBody
...
func (m *PutMeAccessRestrictionIPIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeAccessRestrictionIPIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeAccessRestrictionIPIDDefaultBody

...
// GetMeAccessRestrictionU2fDefaultBody get me access restriction u2f default body
// swagger:model getMeAccessRestrictionU2fDefaultBody
...
func (m *GetMeAccessRestrictionU2fDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionU2fDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionU2fDefaultBody

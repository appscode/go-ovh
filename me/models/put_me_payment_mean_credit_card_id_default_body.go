...
// PutMePaymentMeanCreditCardIDDefaultBody put me payment mean credit card Id default body
// swagger:model putMePaymentMeanCreditCardIdDefaultBody
...
func (m *PutMePaymentMeanCreditCardIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMePaymentMeanCreditCardIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMePaymentMeanCreditCardIDDefaultBody

...
// PostMeSSHKeyParamsBody post me Ssh key params body
// swagger:model postMeSshKeyParamsBody
...
func (m *PostMeSSHKeyParamsBody) validateKey(formats strfmt.Registry) error {
...
func (m *PostMeSSHKeyParamsBody) validateKeyName(formats strfmt.Registry) error {
...
func (m *PostMeSSHKeyParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeSSHKeyParamsBody

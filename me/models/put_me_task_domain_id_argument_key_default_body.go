...
// PutMeTaskDomainIDArgumentKeyDefaultBody put me task domain Id argument key default body
// swagger:model putMeTaskDomainIdArgumentKeyDefaultBody
...
func (m *PutMeTaskDomainIDArgumentKeyDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeTaskDomainIDArgumentKeyDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeTaskDomainIDArgumentKeyDefaultBody

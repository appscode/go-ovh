...
// GetMeBillBillIDDetailsDefaultBody get me bill bill Id details default body
// swagger:model getMeBillBillIdDetailsDefaultBody
...
func (m *GetMeBillBillIDDetailsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeBillBillIDDetailsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeBillBillIDDetailsDefaultBody

...
// PostMeInstallationTemplateDefaultBody post me installation template default body
// swagger:model postMeInstallationTemplateDefaultBody
...
func (m *PostMeInstallationTemplateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeInstallationTemplateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeInstallationTemplateDefaultBody

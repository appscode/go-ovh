...
// GetMeAccessRestrictionSmsDefaultBody get me access restriction sms default body
// swagger:model getMeAccessRestrictionSmsDefaultBody
...
func (m *GetMeAccessRestrictionSmsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionSmsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionSmsDefaultBody

...
// PostMeAccessRestrictionTotpDefaultBody post me access restriction totp default body
// swagger:model postMeAccessRestrictionTotpDefaultBody
...
func (m *PostMeAccessRestrictionTotpDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeAccessRestrictionTotpDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeAccessRestrictionTotpDefaultBody

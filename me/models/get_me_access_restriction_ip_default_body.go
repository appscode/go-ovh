...
// GetMeAccessRestrictionIPDefaultBody get me access restriction Ip default body
// swagger:model getMeAccessRestrictionIpDefaultBody
...
func (m *GetMeAccessRestrictionIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionIPDefaultBody

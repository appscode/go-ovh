...
// GetMeDepositDepositIDPaymentDefaultBody get me deposit deposit Id payment default body
// swagger:model getMeDepositDepositIdPaymentDefaultBody
...
func (m *GetMeDepositDepositIDPaymentDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDepositDepositIDPaymentDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDepositDepositIDPaymentDefaultBody

...
// GetMeRefundRefundIDPaymentDefaultBody get me refund refund Id payment default body
// swagger:model getMeRefundRefundIdPaymentDefaultBody
...
func (m *GetMeRefundRefundIDPaymentDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeRefundRefundIDPaymentDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeRefundRefundIDPaymentDefaultBody

...
// GetMeAccessRestrictionTotpIDDefaultBody get me access restriction totp Id default body
// swagger:model getMeAccessRestrictionTotpIdDefaultBody
...
func (m *GetMeAccessRestrictionTotpIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionTotpIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionTotpIDDefaultBody

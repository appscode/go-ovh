...
// GetMeTaskDomainIDArgumentDefaultBody get me task domain Id argument default body
// swagger:model getMeTaskDomainIdArgumentDefaultBody
...
func (m *GetMeTaskDomainIDArgumentDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskDomainIDArgumentDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskDomainIDArgumentDefaultBody

...
// PostMeTaskContactChangeIDRefuseDefaultBody post me task contact change Id refuse default body
// swagger:model postMeTaskContactChangeIdRefuseDefaultBody
...
func (m *PostMeTaskContactChangeIDRefuseDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskContactChangeIDRefuseDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskContactChangeIDRefuseDefaultBody

...
// GetMeBillBillIDDebtDefaultBody get me bill bill Id debt default body
// swagger:model getMeBillBillIdDebtDefaultBody
...
func (m *GetMeBillBillIDDebtDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeBillBillIDDebtDefaultBody

...
// BillingCreditBalanceMouvementSubObject Mouvement sub object
// swagger:model billing.Credit.Balance.Mouvement.SubObject
...
func (m *BillingCreditBalanceMouvementSubObject) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingCreditBalanceMouvementSubObject) UnmarshalBinary(b []byte) error {
	var res BillingCreditBalanceMouvementSubObject

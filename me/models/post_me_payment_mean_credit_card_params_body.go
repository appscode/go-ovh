...
// PostMePaymentMeanCreditCardParamsBody post me payment mean credit card params body
// swagger:model postMePaymentMeanCreditCardParamsBody
...
func (m *PostMePaymentMeanCreditCardParamsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePaymentMeanCreditCardParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMePaymentMeanCreditCardParamsBody

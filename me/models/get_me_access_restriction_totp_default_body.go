...
// GetMeAccessRestrictionTotpDefaultBody get me access restriction totp default body
// swagger:model getMeAccessRestrictionTotpDefaultBody
...
func (m *GetMeAccessRestrictionTotpDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionTotpDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionTotpDefaultBody

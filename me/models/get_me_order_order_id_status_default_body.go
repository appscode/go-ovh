...
// GetMeOrderOrderIDStatusDefaultBody get me order order Id status default body
// swagger:model getMeOrderOrderIdStatusDefaultBody
...
func (m *GetMeOrderOrderIDStatusDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDStatusDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDStatusDefaultBody

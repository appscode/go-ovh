...
// PostMeIPOrganisationDefaultBody post me Ip organisation default body
// swagger:model postMeIpOrganisationDefaultBody
...
func (m *PostMeIPOrganisationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeIPOrganisationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeIPOrganisationDefaultBody

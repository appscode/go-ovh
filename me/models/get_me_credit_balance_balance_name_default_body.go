...
// GetMeCreditBalanceBalanceNameDefaultBody get me credit balance balance name default body
// swagger:model getMeCreditBalanceBalanceNameDefaultBody
...
func (m *GetMeCreditBalanceBalanceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeCreditBalanceBalanceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeCreditBalanceBalanceNameDefaultBody

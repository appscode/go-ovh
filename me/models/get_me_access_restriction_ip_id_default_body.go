...
// GetMeAccessRestrictionIPIDDefaultBody get me access restriction Ip Id default body
// swagger:model getMeAccessRestrictionIpIdDefaultBody
...
func (m *GetMeAccessRestrictionIPIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionIPIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionIPIDDefaultBody

...
// NichandleAccessRestrictionU2FSignRequest Describe U2F SignRequest
// swagger:model nichandle.AccessRestriction.U2FSignRequest
...
func (m *NichandleAccessRestrictionU2FSignRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionU2FSignRequest) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionU2FSignRequest

...
// GetMeContactContactIDFieldsDefaultBody get me contact contact Id fields default body
// swagger:model getMeContactContactIdFieldsDefaultBody
...
func (m *GetMeContactContactIDFieldsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeContactContactIDFieldsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeContactContactIDFieldsDefaultBody

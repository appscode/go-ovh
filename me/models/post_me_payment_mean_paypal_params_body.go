...
// PostMePaymentMeanPaypalParamsBody post me payment mean paypal params body
// swagger:model postMePaymentMeanPaypalParamsBody
...
func (m *PostMePaymentMeanPaypalParamsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePaymentMeanPaypalParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMePaymentMeanPaypalParamsBody

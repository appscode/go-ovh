...
// GetMeDepositDepositIDDetailsDefaultBody get me deposit deposit Id details default body
// swagger:model getMeDepositDepositIdDetailsDefaultBody
...
func (m *GetMeDepositDepositIDDetailsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDepositDepositIDDetailsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDepositDepositIDDetailsDefaultBody

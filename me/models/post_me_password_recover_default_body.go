...
// PostMePasswordRecoverDefaultBody post me password recover default body
// swagger:model postMePasswordRecoverDefaultBody
...
func (m *PostMePasswordRecoverDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePasswordRecoverDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMePasswordRecoverDefaultBody

...
// BillingItemDetailOrderConfiguration Configuration of order
// swagger:model billing.ItemDetail.OrderConfiguration
...
func (m *BillingItemDetailOrderConfiguration) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingItemDetailOrderConfiguration) UnmarshalBinary(b []byte) error {
	var res BillingItemDetailOrderConfiguration

...
// PostMeTaskDomainIDCancelDefaultBody post me task domain Id cancel default body
// swagger:model postMeTaskDomainIdCancelDefaultBody
...
func (m *PostMeTaskDomainIDCancelDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskDomainIDCancelDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskDomainIDCancelDefaultBody

...
// GetMeBillBillIDDebtOperationDefaultBody get me bill bill Id debt operation default body
// swagger:model getMeBillBillIdDebtOperationDefaultBody
...
func (m *GetMeBillBillIDDebtOperationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeBillBillIDDebtOperationDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeBillBillIDDebtOperationDefaultBody

...
// GetMeAccessRestrictionBackupCodeDefaultBody get me access restriction backup code default body
// swagger:model getMeAccessRestrictionBackupCodeDefaultBody
...
func (m *GetMeAccessRestrictionBackupCodeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAccessRestrictionBackupCodeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAccessRestrictionBackupCodeDefaultBody

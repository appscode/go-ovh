...
// PostMeTaskDomainIDRelaunchDefaultBody post me task domain Id relaunch default body
// swagger:model postMeTaskDomainIdRelaunchDefaultBody
...
func (m *PostMeTaskDomainIDRelaunchDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskDomainIDRelaunchDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskDomainIDRelaunchDefaultBody

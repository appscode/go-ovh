...
// GetMePaymentMeanCreditCardIDDefaultBody get me payment mean credit card Id default body
// swagger:model getMePaymentMeanCreditCardIdDefaultBody
...
func (m *GetMePaymentMeanCreditCardIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanCreditCardIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanCreditCardIDDefaultBody

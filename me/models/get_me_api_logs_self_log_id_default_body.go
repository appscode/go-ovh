...
// GetMeAPILogsSelfLogIDDefaultBody get me Api logs self log Id default body
// swagger:model getMeApiLogsSelfLogIdDefaultBody
...
func (m *GetMeAPILogsSelfLogIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAPILogsSelfLogIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAPILogsSelfLogIDDefaultBody

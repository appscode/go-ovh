...
// PostMeFidelityAccountCreditOrderDefaultBody post me fidelity account credit order default body
// swagger:model postMeFidelityAccountCreditOrderDefaultBody
...
func (m *PostMeFidelityAccountCreditOrderDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeFidelityAccountCreditOrderDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeFidelityAccountCreditOrderDefaultBody

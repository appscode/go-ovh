...
// BillingItemDetail Extensions of a detail
// swagger:model billing.ItemDetail
...
func (m *BillingItemDetail) validateOrder(formats strfmt.Registry) error {

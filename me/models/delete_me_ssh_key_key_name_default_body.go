...
// DeleteMeSSHKeyKeyNameDefaultBody delete me Ssh key key name default body
// swagger:model deleteMeSshKeyKeyNameDefaultBody
...
func (m *DeleteMeSSHKeyKeyNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeSSHKeyKeyNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeSSHKeyKeyNameDefaultBody

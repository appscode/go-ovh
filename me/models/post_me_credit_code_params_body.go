...
// PostMeCreditCodeParamsBody post me credit code params body
// swagger:model postMeCreditCodeParamsBody
...
func (m *PostMeCreditCodeParamsBody) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateInputCode(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *PostMeCreditCodeParamsBody) validateInputCode(formats strfmt.Registry) error {

	if err := validate.Required("inputCode", "body", m.InputCode); err != nil {
		return err
	}
...
func (m *PostMeCreditCodeParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeCreditCodeParamsBody

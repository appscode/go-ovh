...
// GetMeOrderOrderIDBillDefaultBody get me order order Id bill default body
// swagger:model getMeOrderOrderIdBillDefaultBody
...
func (m *GetMeOrderOrderIDBillDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDBillDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDBillDefaultBody

...
// BillingWithdrawalDetail Information about a Withdrawal entry
// swagger:model billing.WithdrawalDetail
...
func (m *BillingWithdrawalDetail) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateWithdrawalDetailID(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *BillingWithdrawalDetail) validateDescription(formats strfmt.Registry) error {
...
func (m *BillingWithdrawalDetail) validateDomain(formats strfmt.Registry) error {
...
func (m *BillingWithdrawalDetail) validateQuantity(formats strfmt.Registry) error {
...
func (m *BillingWithdrawalDetail) validateTotalPrice(formats strfmt.Registry) error {
...
func (m *BillingWithdrawalDetail) validateUnitPrice(formats strfmt.Registry) error {
...
func (m *BillingWithdrawalDetail) validateWithdrawalDetailID(formats strfmt.Registry) error {

	if err := validate.RequiredString("withdrawalDetailId", "body", string(m.WithdrawalDetailID)); err != nil {
		return err
	}
...
func (m *BillingWithdrawalDetail) UnmarshalBinary(b []byte) error {
	var res BillingWithdrawalDetail

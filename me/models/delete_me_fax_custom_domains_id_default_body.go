...
// DeleteMeFaxCustomDomainsIDDefaultBody delete me fax custom domains Id default body
// swagger:model deleteMeFaxCustomDomainsIdDefaultBody
...
func (m *DeleteMeFaxCustomDomainsIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeFaxCustomDomainsIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeFaxCustomDomainsIDDefaultBody

...
// GetMeTaskDomainIDProgressbarDefaultBody get me task domain Id progressbar default body
// swagger:model getMeTaskDomainIdProgressbarDefaultBody
...
func (m *GetMeTaskDomainIDProgressbarDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskDomainIDProgressbarDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskDomainIDProgressbarDefaultBody

...
// PostMeVoucherCheckValidityParamsBody post me voucher check validity params body
// swagger:model postMeVoucherCheckValidityParamsBody
...
func (m *PostMeVoucherCheckValidityParamsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeVoucherCheckValidityParamsBody) validateVoucher(formats strfmt.Registry) error {
...
func (m *PostMeVoucherCheckValidityParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeVoucherCheckValidityParamsBody

...
// PostMePaymentMeanPaypalDefaultBody post me payment mean paypal default body
// swagger:model postMePaymentMeanPaypalDefaultBody
...
func (m *PostMePaymentMeanPaypalDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePaymentMeanPaypalDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMePaymentMeanPaypalDefaultBody

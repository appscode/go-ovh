...
// GetMeContactContactIDDefaultBody get me contact contact Id default body
// swagger:model getMeContactContactIdDefaultBody
...
func (m *GetMeContactContactIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeContactContactIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeContactContactIDDefaultBody

...
// PostMeTaskDomainIDAccelerateDefaultBody post me task domain Id accelerate default body
// swagger:model postMeTaskDomainIdAccelerateDefaultBody
...
func (m *PostMeTaskDomainIDAccelerateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskDomainIDAccelerateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskDomainIDAccelerateDefaultBody

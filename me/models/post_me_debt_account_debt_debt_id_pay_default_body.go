...
// PostMeDebtAccountDebtDebtIDPayDefaultBody post me debt account debt debt Id pay default body
// swagger:model postMeDebtAccountDebtDebtIdPayDefaultBody
...
func (m *PostMeDebtAccountDebtDebtIDPayDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeDebtAccountDebtDebtIDPayDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeDebtAccountDebtDebtIDPayDefaultBody

...
// GetMeTaskEmailChangeIDDefaultBody get me task email change Id default body
// swagger:model getMeTaskEmailChangeIdDefaultBody
...
func (m *GetMeTaskEmailChangeIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskEmailChangeIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskEmailChangeIDDefaultBody

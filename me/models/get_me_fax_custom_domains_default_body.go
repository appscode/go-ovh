...
// GetMeFaxCustomDomainsDefaultBody get me fax custom domains default body
// swagger:model getMeFaxCustomDomainsDefaultBody
...
func (m *GetMeFaxCustomDomainsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeFaxCustomDomainsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeFaxCustomDomainsDefaultBody

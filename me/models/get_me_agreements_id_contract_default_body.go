...
// GetMeAgreementsIDContractDefaultBody get me agreements Id contract default body
// swagger:model getMeAgreementsIdContractDefaultBody
...
func (m *GetMeAgreementsIDContractDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAgreementsIDContractDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAgreementsIDContractDefaultBody

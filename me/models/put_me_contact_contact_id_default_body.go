...
// PutMeContactContactIDDefaultBody put me contact contact Id default body
// swagger:model putMeContactContactIdDefaultBody
...
func (m *PutMeContactContactIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeContactContactIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeContactContactIDDefaultBody

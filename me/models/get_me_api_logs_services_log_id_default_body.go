...
// GetMeAPILogsServicesLogIDDefaultBody get me Api logs services log Id default body
// swagger:model getMeApiLogsServicesLogIdDefaultBody
...
func (m *GetMeAPILogsServicesLogIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAPILogsServicesLogIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAPILogsServicesLogIDDefaultBody

...
// DeleteMePaymentMeanCreditCardIDDefaultBody delete me payment mean credit card Id default body
// swagger:model deleteMePaymentMeanCreditCardIdDefaultBody
...
func (m *DeleteMePaymentMeanCreditCardIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMePaymentMeanCreditCardIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMePaymentMeanCreditCardIDDefaultBody

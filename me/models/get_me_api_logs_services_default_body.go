...
// GetMeAPILogsServicesDefaultBody get me Api logs services default body
// swagger:model getMeApiLogsServicesDefaultBody
...
func (m *GetMeAPILogsServicesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAPILogsServicesDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAPILogsServicesDefaultBody

...
// PostMeAccessRestrictionIPDefaultBody post me access restriction Ip default body
// swagger:model postMeAccessRestrictionIpDefaultBody
...
func (m *PostMeAccessRestrictionIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeAccessRestrictionIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeAccessRestrictionIPDefaultBody

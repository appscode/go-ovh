...
// PostMeOrderOrderIDRetractionDefaultBody post me order order Id retraction default body
// swagger:model postMeOrderOrderIdRetractionDefaultBody
...
func (m *PostMeOrderOrderIDRetractionDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeOrderOrderIDRetractionDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeOrderOrderIDRetractionDefaultBody

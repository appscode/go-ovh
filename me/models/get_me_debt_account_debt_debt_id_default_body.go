...
// GetMeDebtAccountDebtDebtIDDefaultBody get me debt account debt debt Id default body
// swagger:model getMeDebtAccountDebtDebtIdDefaultBody
...
func (m *GetMeDebtAccountDebtDebtIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDebtAccountDebtDebtIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDebtAccountDebtDebtIDDefaultBody

...
// GetMeFaxCustomDomainsIDDefaultBody get me fax custom domains Id default body
// swagger:model getMeFaxCustomDomainsIdDefaultBody
...
func (m *GetMeFaxCustomDomainsIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeFaxCustomDomainsIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeFaxCustomDomainsIDDefaultBody

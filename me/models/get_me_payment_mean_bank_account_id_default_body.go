...
// GetMePaymentMeanBankAccountIDDefaultBody get me payment mean bank account Id default body
// swagger:model getMePaymentMeanBankAccountIdDefaultBody
...
func (m *GetMePaymentMeanBankAccountIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanBankAccountIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanBankAccountIDDefaultBody

...
// GetMeNotificationEmailHistoryIDDefaultBody get me notification email history Id default body
// swagger:model getMeNotificationEmailHistoryIdDefaultBody
...
func (m *GetMeNotificationEmailHistoryIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeNotificationEmailHistoryIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeNotificationEmailHistoryIDDefaultBody

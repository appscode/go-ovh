...
// GetMeOrderOrderIDPaymentDefaultBody get me order order Id payment default body
// swagger:model getMeOrderOrderIdPaymentDefaultBody
...
func (m *GetMeOrderOrderIDPaymentDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDPaymentDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDPaymentDefaultBody

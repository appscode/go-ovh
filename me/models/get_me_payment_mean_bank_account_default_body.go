...
// GetMePaymentMeanBankAccountDefaultBody get me payment mean bank account default body
// swagger:model getMePaymentMeanBankAccountDefaultBody
...
func (m *GetMePaymentMeanBankAccountDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanBankAccountDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanBankAccountDefaultBody

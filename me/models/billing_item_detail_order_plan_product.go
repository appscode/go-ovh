...
// BillingItemDetailOrderPlanProduct Product data from order
// swagger:model billing.ItemDetail.OrderPlanProduct
...
func (m *BillingItemDetailOrderPlanProduct) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingItemDetailOrderPlanProduct) UnmarshalBinary(b []byte) error {
	var res BillingItemDetailOrderPlanProduct

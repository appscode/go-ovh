...
// GetMeAPICredentialCredentialIDDefaultBody get me Api credential credential Id default body
// swagger:model getMeApiCredentialCredentialIdDefaultBody
...
func (m *GetMeAPICredentialCredentialIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAPICredentialCredentialIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAPICredentialCredentialIDDefaultBody

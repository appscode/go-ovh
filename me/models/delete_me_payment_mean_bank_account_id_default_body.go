...
// DeleteMePaymentMeanBankAccountIDDefaultBody delete me payment mean bank account Id default body
// swagger:model deleteMePaymentMeanBankAccountIdDefaultBody
...
func (m *DeleteMePaymentMeanBankAccountIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMePaymentMeanBankAccountIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMePaymentMeanBankAccountIDDefaultBody

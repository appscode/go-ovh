...
// TelephonyLineDescriptionSettings Line description policies settings
// swagger:model telephony.LineDescriptionSettings
...
func (m *TelephonyLineDescriptionSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TelephonyLineDescriptionSettings) UnmarshalBinary(b []byte) error {
	var res TelephonyLineDescriptionSettings

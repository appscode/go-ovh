...
// PutMeAccessRestrictionTotpIDDefaultBody put me access restriction totp Id default body
// swagger:model putMeAccessRestrictionTotpIdDefaultBody
...
func (m *PutMeAccessRestrictionTotpIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeAccessRestrictionTotpIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeAccessRestrictionTotpIDDefaultBody

...
// PutMePaymentMeanPaypalIDDefaultBody put me payment mean paypal Id default body
// swagger:model putMePaymentMeanPaypalIdDefaultBody
...
func (m *PutMePaymentMeanPaypalIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMePaymentMeanPaypalIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMePaymentMeanPaypalIDDefaultBody

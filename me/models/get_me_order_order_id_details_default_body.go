...
// GetMeOrderOrderIDDetailsDefaultBody get me order order Id details default body
// swagger:model getMeOrderOrderIdDetailsDefaultBody
...
func (m *GetMeOrderOrderIDDetailsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDDetailsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDDetailsDefaultBody

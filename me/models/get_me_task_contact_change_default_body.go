...
// GetMeTaskContactChangeDefaultBody get me task contact change default body
// swagger:model getMeTaskContactChangeDefaultBody
...
func (m *GetMeTaskContactChangeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskContactChangeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskContactChangeDefaultBody

...
// PutMeAccessRestrictionU2fIDDefaultBody put me access restriction u2f Id default body
// swagger:model putMeAccessRestrictionU2fIdDefaultBody
...
func (m *PutMeAccessRestrictionU2fIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeAccessRestrictionU2fIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeAccessRestrictionU2fIDDefaultBody

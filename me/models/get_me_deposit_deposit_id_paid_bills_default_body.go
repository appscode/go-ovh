...
// GetMeDepositDepositIDPaidBillsDefaultBody get me deposit deposit Id paid bills default body
// swagger:model getMeDepositDepositIdPaidBillsDefaultBody
...
func (m *GetMeDepositDepositIDPaidBillsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDepositDepositIDPaidBillsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDepositDepositIDPaidBillsDefaultBody

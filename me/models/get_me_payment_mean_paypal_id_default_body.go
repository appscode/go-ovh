...
// GetMePaymentMeanPaypalIDDefaultBody get me payment mean paypal Id default body
// swagger:model getMePaymentMeanPaypalIdDefaultBody
...
func (m *GetMePaymentMeanPaypalIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanPaypalIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanPaypalIDDefaultBody

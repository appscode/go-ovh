...
// GetMeTaskEmailChangeDefaultBody get me task email change default body
// swagger:model getMeTaskEmailChangeDefaultBody
...
func (m *GetMeTaskEmailChangeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskEmailChangeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskEmailChangeDefaultBody

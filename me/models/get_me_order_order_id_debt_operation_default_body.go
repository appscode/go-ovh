...
// GetMeOrderOrderIDDebtOperationDefaultBody get me order order Id debt operation default body
// swagger:model getMeOrderOrderIdDebtOperationDefaultBody
...
func (m *GetMeOrderOrderIDDebtOperationDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeOrderOrderIDDebtOperationDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeOrderOrderIDDebtOperationDefaultBody

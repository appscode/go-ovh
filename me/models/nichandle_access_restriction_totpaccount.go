...
// swagger:model nichandle.AccessRestriction.TOTPAccount
...
func (m *NichandleAccessRestrictionTOTPAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionTOTPAccount) validateCreationDate(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionTOTPAccount) validateID(formats strfmt.Registry) error {
...
var nichandleAccessRestrictionTOTPAccountTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		nichandleAccessRestrictionTOTPAccountTypeStatusPropEnum = append(nichandleAccessRestrictionTOTPAccountTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *NichandleAccessRestrictionTOTPAccount) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, nichandleAccessRestrictionTOTPAccountTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *NichandleAccessRestrictionTOTPAccount) validateStatus(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionTOTPAccount) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionTOTPAccount

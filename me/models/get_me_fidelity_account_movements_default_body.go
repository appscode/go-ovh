...
// GetMeFidelityAccountMovementsDefaultBody get me fidelity account movements default body
// swagger:model getMeFidelityAccountMovementsDefaultBody
...
func (m *GetMeFidelityAccountMovementsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeFidelityAccountMovementsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeFidelityAccountMovementsDefaultBody

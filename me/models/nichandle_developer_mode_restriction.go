...
// NichandleDeveloperModeRestriction Login restrictions on a development version of the Manager
// swagger:model nichandle.DeveloperModeRestriction
...
func (m *NichandleDeveloperModeRestriction) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleDeveloperModeRestriction) UnmarshalBinary(b []byte) error {
	var res NichandleDeveloperModeRestriction

...
// GetMeInstallationTemplateDefaultBody get me installation template default body
// swagger:model getMeInstallationTemplateDefaultBody
...
func (m *GetMeInstallationTemplateDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeInstallationTemplateDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeInstallationTemplateDefaultBody

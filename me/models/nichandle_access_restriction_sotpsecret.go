...
// NichandleAccessRestrictionSOTPSecret Describe SOTP secret keys
// swagger:model nichandle.AccessRestriction.SOTPSecret
...
func (m *NichandleAccessRestrictionSOTPSecret) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NichandleAccessRestrictionSOTPSecret) validateCodes(formats strfmt.Registry) error {
...
func (m *NichandleAccessRestrictionSOTPSecret) UnmarshalBinary(b []byte) error {
	var res NichandleAccessRestrictionSOTPSecret

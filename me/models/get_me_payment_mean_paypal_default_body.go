...
// GetMePaymentMeanPaypalDefaultBody get me payment mean paypal default body
// swagger:model getMePaymentMeanPaypalDefaultBody
...
func (m *GetMePaymentMeanPaypalDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMePaymentMeanPaypalDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMePaymentMeanPaypalDefaultBody

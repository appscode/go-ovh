...
// PostMeBillBillIDDebtPayDefaultBody post me bill bill Id debt pay default body
// swagger:model postMeBillBillIdDebtPayDefaultBody
...
func (m *PostMeBillBillIDDebtPayDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeBillBillIDDebtPayDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeBillBillIDDebtPayDefaultBody

...
// PostMeVoucherCheckValidityDefaultBody post me voucher check validity default body
// swagger:model postMeVoucherCheckValidityDefaultBody
...
func (m *PostMeVoucherCheckValidityDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeVoucherCheckValidityDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeVoucherCheckValidityDefaultBody

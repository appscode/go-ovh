...
// GetMeTelephonySettingsDefaultBody get me telephony settings default body
// swagger:model getMeTelephonySettingsDefaultBody
...
func (m *GetMeTelephonySettingsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTelephonySettingsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTelephonySettingsDefaultBody

...
// PostMeAccessRestrictionSmsDefaultBody post me access restriction sms default body
// swagger:model postMeAccessRestrictionSmsDefaultBody
...
func (m *PostMeAccessRestrictionSmsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeAccessRestrictionSmsDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeAccessRestrictionSmsDefaultBody

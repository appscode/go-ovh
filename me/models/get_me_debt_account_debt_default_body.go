...
// GetMeDebtAccountDebtDefaultBody get me debt account debt default body
// swagger:model getMeDebtAccountDebtDefaultBody
...
func (m *GetMeDebtAccountDebtDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeDebtAccountDebtDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeDebtAccountDebtDefaultBody

...
// GetMeAPIApplicationApplicationIDDefaultBody get me Api application application Id default body
// swagger:model getMeApiApplicationApplicationIdDefaultBody
...
func (m *GetMeAPIApplicationApplicationIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeAPIApplicationApplicationIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeAPIApplicationApplicationIDDefaultBody

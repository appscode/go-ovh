...
// swagger:model billing.Order.AssociatedObject
...
var billingOrderAssociatedObjectTypeTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Bill","Deposit","Refund","Withdrawal"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		billingOrderAssociatedObjectTypeTypePropEnum = append(billingOrderAssociatedObjectTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *BillingOrderAssociatedObject) validateTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, billingOrderAssociatedObjectTypeTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *BillingOrderAssociatedObject) validateType(formats strfmt.Registry) error {
...
func (m *BillingOrderAssociatedObject) UnmarshalBinary(b []byte) error {
	var res BillingOrderAssociatedObject

...
// PostMeDocumentParamsBody post me document params body
// swagger:model postMeDocumentParamsBody
...
func (m *PostMeDocumentParamsBody) validateName(formats strfmt.Registry) error {
...
func (m *PostMeDocumentParamsBody) UnmarshalBinary(b []byte) error {
	var res PostMeDocumentParamsBody

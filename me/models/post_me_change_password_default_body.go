...
// PostMeChangePasswordDefaultBody post me change password default body
// swagger:model postMeChangePasswordDefaultBody
...
func (m *PostMeChangePasswordDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeChangePasswordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeChangePasswordDefaultBody

...
// GetMeSLAIDCanBeAppliedDefaultBody get me Sla Id can be applied default body
// swagger:model getMeSlaIdCanBeAppliedDefaultBody
...
func (m *GetMeSLAIDCanBeAppliedDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeSLAIDCanBeAppliedDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeSLAIDCanBeAppliedDefaultBody

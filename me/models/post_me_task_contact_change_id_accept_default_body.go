...
// PostMeTaskContactChangeIDAcceptDefaultBody post me task contact change Id accept default body
// swagger:model postMeTaskContactChangeIdAcceptDefaultBody
...
func (m *PostMeTaskContactChangeIDAcceptDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeTaskContactChangeIDAcceptDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeTaskContactChangeIDAcceptDefaultBody

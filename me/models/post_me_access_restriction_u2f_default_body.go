...
// PostMeAccessRestrictionU2fDefaultBody post me access restriction u2f default body
// swagger:model postMeAccessRestrictionU2fDefaultBody
...
func (m *PostMeAccessRestrictionU2fDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMeAccessRestrictionU2fDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMeAccessRestrictionU2fDefaultBody

...
// DeleteMePaymentMeanPaypalIDDefaultBody delete me payment mean paypal Id default body
// swagger:model deleteMePaymentMeanPaypalIdDefaultBody
...
func (m *DeleteMePaymentMeanPaypalIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMePaymentMeanPaypalIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMePaymentMeanPaypalIDDefaultBody

...
// GetMeIPXEScriptNameDefaultBody get me Ip x e script name default body
// swagger:model getMeIpXEScriptNameDefaultBody
...
func (m *GetMeIPXEScriptNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeIPXEScriptNameDefaultBody

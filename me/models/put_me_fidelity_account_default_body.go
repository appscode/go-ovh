...
// PutMeFidelityAccountDefaultBody put me fidelity account default body
// swagger:model putMeFidelityAccountDefaultBody
...
func (m *PutMeFidelityAccountDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutMeFidelityAccountDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutMeFidelityAccountDefaultBody

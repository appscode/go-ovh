...
// GetMeTaskDomainIDArgumentKeyDefaultBody get me task domain Id argument key default body
// swagger:model getMeTaskDomainIdArgumentKeyDefaultBody
...
func (m *GetMeTaskDomainIDArgumentKeyDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskDomainIDArgumentKeyDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskDomainIDArgumentKeyDefaultBody

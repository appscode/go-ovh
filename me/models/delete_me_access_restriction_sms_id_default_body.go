...
// DeleteMeAccessRestrictionSmsIDDefaultBody delete me access restriction sms Id default body
// swagger:model deleteMeAccessRestrictionSmsIdDefaultBody
...
func (m *DeleteMeAccessRestrictionSmsIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteMeAccessRestrictionSmsIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteMeAccessRestrictionSmsIDDefaultBody

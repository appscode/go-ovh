...
// PostMePaymentMeanBankAccountDefaultBody post me payment mean bank account default body
// swagger:model postMePaymentMeanBankAccountDefaultBody
...
func (m *PostMePaymentMeanBankAccountDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePaymentMeanBankAccountDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMePaymentMeanBankAccountDefaultBody

...
// swagger:model nichandle.SshKey
...
func (m *NichandleSSHKey) validateKey(formats strfmt.Registry) error {
...
func (m *NichandleSSHKey) validateKeyName(formats strfmt.Registry) error {

	if err := validate.RequiredString("keyName", "body", string(m.KeyName)); err != nil {
		return err
	}

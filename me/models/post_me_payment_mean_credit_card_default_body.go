...
// PostMePaymentMeanCreditCardDefaultBody post me payment mean credit card default body
// swagger:model postMePaymentMeanCreditCardDefaultBody
...
func (m *PostMePaymentMeanCreditCardDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostMePaymentMeanCreditCardDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostMePaymentMeanCreditCardDefaultBody

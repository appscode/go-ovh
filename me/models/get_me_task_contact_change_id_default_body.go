...
// GetMeTaskContactChangeIDDefaultBody get me task contact change Id default body
// swagger:model getMeTaskContactChangeIdDefaultBody
...
func (m *GetMeTaskContactChangeIDDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetMeTaskContactChangeIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetMeTaskContactChangeIDDefaultBody

...
func (o *DeleteMeDocumentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteMeDocumentIDOK()
	...
	default:
		result := NewDeleteMeDocumentIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *DeleteMeDocumentIDOK) Error() string {
	return fmt.Sprintf("[DELETE /me/document/{id}][%d] deleteMeDocumentIdOK ", 200)
}

func (o *DeleteMeDocumentIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteMeDocumentIDDefault(code int) *DeleteMeDocumentIDDefault {
	return &DeleteMeDocumentIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteMeDocumentIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /me/document/{id}][%d] DeleteMeDocumentID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteMeDocumentIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteMeDocumentIDDefaultBody)

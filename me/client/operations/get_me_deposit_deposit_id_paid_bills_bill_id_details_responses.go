...
func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeDepositDepositIDPaidBillsBillIDDetailsOK()
	...
	default:
		result := NewGetMeDepositDepositIDPaidBillsBillIDDetailsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetMeDepositDepositIDPaidBillsBillIDDetailsOK() *GetMeDepositDepositIDPaidBillsBillIDDetailsOK {
	return &GetMeDepositDepositIDPaidBillsBillIDDetailsOK{}
}
...
func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsOK) Error() string {
	return fmt.Sprintf("[GET /me/deposit/{depositId}/paidBills/{billId}/details][%d] getMeDepositDepositIdPaidBillsBillIdDetailsOK  %+v", 200, o.Payload)
}

func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeDepositDepositIDPaidBillsBillIDDetailsDefault(code int) *GetMeDepositDepositIDPaidBillsBillIDDetailsDefault {
	return &GetMeDepositDepositIDPaidBillsBillIDDetailsDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsDefault) Code() int {
	return o._statusCode
}

func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsDefault) Error() string {
	return fmt.Sprintf("[GET /me/deposit/{depositId}/paidBills/{billId}/details][%d] GetMeDepositDepositIDPaidBillsBillIDDetails default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeDepositDepositIDPaidBillsBillIDDetailsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeDepositDepositIDPaidBillsBillIDDetailsDefaultBody)

...
// NewGetMeAgreementsIDContractParams creates a new GetMeAgreementsIDContractParams object
// with the default values initialized.
func NewGetMeAgreementsIDContractParams() *GetMeAgreementsIDContractParams {
	var ()
	return &GetMeAgreementsIDContractParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeAgreementsIDContractParamsWithTimeout creates a new GetMeAgreementsIDContractParams object
...
// NewGetMeAgreementsIDContractParamsWithContext creates a new GetMeAgreementsIDContractParams object
...
// NewGetMeAgreementsIDContractParamsWithHTTPClient creates a new GetMeAgreementsIDContractParams object
...
/*GetMeAgreementsIDContractParams contains all the parameters to send to the API endpoint
for the get me agreements ID contract operation typically these are written to a http.Request
*/
...
func (o *GetMeAgreementsIDContractParams) WithTimeout(timeout time.Duration) *GetMeAgreementsIDContractParams {
...
func (o *GetMeAgreementsIDContractParams) WithContext(ctx context.Context) *GetMeAgreementsIDContractParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeAgreementsIDContractParams) WithHTTPClient(client *http.Client) *GetMeAgreementsIDContractParams {
...
func (o *GetMeAgreementsIDContractParams) WithID(id int64) *GetMeAgreementsIDContractParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get me agreements ID contract params
func (o *GetMeAgreementsIDContractParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *GetMeAgreementsIDContractParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

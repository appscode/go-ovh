...
// NewPostMeDocumentParams creates a new PostMeDocumentParams object
// with the default values initialized.
func NewPostMeDocumentParams() *PostMeDocumentParams {
	var ()
	return &PostMeDocumentParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeDocumentParamsWithTimeout creates a new PostMeDocumentParams object
...
// NewPostMeDocumentParamsWithContext creates a new PostMeDocumentParams object
...
// NewPostMeDocumentParamsWithHTTPClient creates a new PostMeDocumentParams object
...
/*PostMeDocumentParams contains all the parameters to send to the API endpoint
for the post me document operation typically these are written to a http.Request
*/
...
func (o *PostMeDocumentParams) WithContext(ctx context.Context) *PostMeDocumentParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeDocumentParams) WithMeDocumentPost(meDocumentPost *models.PostMeDocumentParamsBody) *PostMeDocumentParams {
	o.SetMeDocumentPost(meDocumentPost)
	return o
}
...
func (o *PostMeDocumentParams) SetMeDocumentPost(meDocumentPost *models.PostMeDocumentParamsBody) {
	o.MeDocumentPost = meDocumentPost
}
...
func (o *PostMeDocumentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeDocumentPost != nil {
		if err := r.SetBodyParam(o.MeDocumentPost); err != nil {
			return err
		}
	}

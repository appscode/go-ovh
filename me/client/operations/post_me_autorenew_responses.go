...
func (o *PostMeAutorenewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPostMeAutorenewDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PostMeAutorenewOK) Error() string {
	return fmt.Sprintf("[POST /me/autorenew][%d] postMeAutorenewOK ", 200)
}

func (o *PostMeAutorenewOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PostMeAutorenewDefault) Error() string {
	return fmt.Sprintf("[POST /me/autorenew][%d] PostMeAutorenew default  %+v", o._statusCode, o.Payload)
}

func (o *PostMeAutorenewDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMeAutorenewDefaultBody)

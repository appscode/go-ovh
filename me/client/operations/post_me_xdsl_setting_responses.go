...
func (o *PostMeXdslSettingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPostMeXdslSettingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PostMeXdslSettingOK) Error() string {
	return fmt.Sprintf("[POST /me/xdsl/setting][%d] postMeXdslSettingOK ", 200)
}

func (o *PostMeXdslSettingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostMeXdslSettingDefault(code int) *PostMeXdslSettingDefault {
	return &PostMeXdslSettingDefault{
		_statusCode: code,
	}
}
...
func (o *PostMeXdslSettingDefault) Error() string {
	return fmt.Sprintf("[POST /me/xdsl/setting][%d] PostMeXdslSetting default  %+v", o._statusCode, o.Payload)
}

func (o *PostMeXdslSettingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMeXdslSettingDefaultBody)

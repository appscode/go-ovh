...
func (o *DeleteMeInstallationTemplateTemplateNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteMeInstallationTemplateTemplateNameOK()
	...
	default:
		result := NewDeleteMeInstallationTemplateTemplateNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteMeInstallationTemplateTemplateNameOK() *DeleteMeInstallationTemplateTemplateNameOK {
	return &DeleteMeInstallationTemplateTemplateNameOK{}
}
...
func (o *DeleteMeInstallationTemplateTemplateNameOK) Error() string {
	return fmt.Sprintf("[DELETE /me/installationTemplate/{templateName}][%d] deleteMeInstallationTemplateTemplateNameOK ", 200)
}

func (o *DeleteMeInstallationTemplateTemplateNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteMeInstallationTemplateTemplateNameDefault(code int) *DeleteMeInstallationTemplateTemplateNameDefault {
	return &DeleteMeInstallationTemplateTemplateNameDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteMeInstallationTemplateTemplateNameDefault) Code() int {
	return o._statusCode
}

func (o *DeleteMeInstallationTemplateTemplateNameDefault) Error() string {
	return fmt.Sprintf("[DELETE /me/installationTemplate/{templateName}][%d] DeleteMeInstallationTemplateTemplateName default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteMeInstallationTemplateTemplateNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteMeInstallationTemplateTemplateNameDefaultBody)

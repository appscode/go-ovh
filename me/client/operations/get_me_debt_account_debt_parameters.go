...
// NewGetMeDebtAccountDebtParams creates a new GetMeDebtAccountDebtParams object
// with the default values initialized.
func NewGetMeDebtAccountDebtParams() *GetMeDebtAccountDebtParams {

	return &GetMeDebtAccountDebtParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeDebtAccountDebtParamsWithTimeout creates a new GetMeDebtAccountDebtParams object
...
// NewGetMeDebtAccountDebtParamsWithContext creates a new GetMeDebtAccountDebtParams object
...
// NewGetMeDebtAccountDebtParamsWithHTTPClient creates a new GetMeDebtAccountDebtParams object
...
/*GetMeDebtAccountDebtParams contains all the parameters to send to the API endpoint
for the get me debt account debt operation typically these are written to a http.Request
*/
...
func (o *GetMeDebtAccountDebtParams) WithTimeout(timeout time.Duration) *GetMeDebtAccountDebtParams {
...
func (o *GetMeDebtAccountDebtParams) WithContext(ctx context.Context) *GetMeDebtAccountDebtParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeDebtAccountDebtParams) WithHTTPClient(client *http.Client) *GetMeDebtAccountDebtParams {
...
func (o *GetMeDebtAccountDebtParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewGetMeSubAccountParams creates a new GetMeSubAccountParams object
// with the default values initialized.
func NewGetMeSubAccountParams() *GetMeSubAccountParams {

	return &GetMeSubAccountParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeSubAccountParamsWithTimeout creates a new GetMeSubAccountParams object
...
// NewGetMeSubAccountParamsWithContext creates a new GetMeSubAccountParams object
...
// NewGetMeSubAccountParamsWithHTTPClient creates a new GetMeSubAccountParams object
...
/*GetMeSubAccountParams contains all the parameters to send to the API endpoint
for the get me sub account operation typically these are written to a http.Request
*/
...
func (o *GetMeSubAccountParams) WithContext(ctx context.Context) *GetMeSubAccountParams {
	o.SetContext(ctx)
	return o
}

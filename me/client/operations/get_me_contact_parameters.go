...
// NewGetMeContactParams creates a new GetMeContactParams object
// with the default values initialized.
func NewGetMeContactParams() *GetMeContactParams {

	return &GetMeContactParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeContactParamsWithTimeout creates a new GetMeContactParams object
...
// NewGetMeContactParamsWithContext creates a new GetMeContactParams object
...
// NewGetMeContactParamsWithHTTPClient creates a new GetMeContactParams object
...
/*GetMeContactParams contains all the parameters to send to the API endpoint
for the get me contact operation typically these are written to a http.Request
*/
...
func (o *GetMeContactParams) WithContext(ctx context.Context) *GetMeContactParams {
	o.SetContext(ctx)
	return o
}

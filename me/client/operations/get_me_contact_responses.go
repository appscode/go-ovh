...
func (o *GetMeContactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeContactDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeContactOK) Error() string {
	return fmt.Sprintf("[GET /me/contact][%d] getMeContactOK  %+v", 200, o.Payload)
}

func (o *GetMeContactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetMeContactDefault) Error() string {
	return fmt.Sprintf("[GET /me/contact][%d] GetMeContact default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeContactDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeContactDefaultBody)

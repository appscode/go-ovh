...
// NewPostMeDocumentCorsParams creates a new PostMeDocumentCorsParams object
// with the default values initialized.
func NewPostMeDocumentCorsParams() *PostMeDocumentCorsParams {
	var ()
	return &PostMeDocumentCorsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeDocumentCorsParamsWithTimeout creates a new PostMeDocumentCorsParams object
...
// NewPostMeDocumentCorsParamsWithContext creates a new PostMeDocumentCorsParams object
...
// NewPostMeDocumentCorsParamsWithHTTPClient creates a new PostMeDocumentCorsParams object
...
/*PostMeDocumentCorsParams contains all the parameters to send to the API endpoint
for the post me document cors operation typically these are written to a http.Request
*/
...
func (o *PostMeDocumentCorsParams) WithTimeout(timeout time.Duration) *PostMeDocumentCorsParams {
...
func (o *PostMeDocumentCorsParams) WithContext(ctx context.Context) *PostMeDocumentCorsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeDocumentCorsParams) WithMeDocumentCorsPost(meDocumentCorsPost *models.PostMeDocumentCorsParamsBody) *PostMeDocumentCorsParams {
	o.SetMeDocumentCorsPost(meDocumentCorsPost)
	return o
}
...
func (o *PostMeDocumentCorsParams) SetMeDocumentCorsPost(meDocumentCorsPost *models.PostMeDocumentCorsParamsBody) {
	o.MeDocumentCorsPost = meDocumentCorsPost
}

// WriteToRequest writes these params to a swagger request
func (o *PostMeDocumentCorsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeDocumentCorsPost != nil {
		if err := r.SetBodyParam(o.MeDocumentCorsPost); err != nil {
			return err
		}
	}

...
func (o *GetMeIPXEScriptReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeIPXEScriptDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeIPXEScriptOK) Error() string {
	return fmt.Sprintf("[GET /me/ipxeScript][%d] getMeIpXEScriptOK  %+v", 200, o.Payload)
}

func (o *GetMeIPXEScriptOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetMeIPXEScriptDefault) Error() string {
	return fmt.Sprintf("[GET /me/ipxeScript][%d] GetMeIPXEScript default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeIPXEScriptDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeIPXEScriptDefaultBody)

...
// NewGetMeSLAIDServicesParams creates a new GetMeSLAIDServicesParams object
// with the default values initialized.
func NewGetMeSLAIDServicesParams() *GetMeSLAIDServicesParams {
	var ()
	return &GetMeSLAIDServicesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeSLAIDServicesParamsWithTimeout creates a new GetMeSLAIDServicesParams object
...
// NewGetMeSLAIDServicesParamsWithContext creates a new GetMeSLAIDServicesParams object
...
// NewGetMeSLAIDServicesParamsWithHTTPClient creates a new GetMeSLAIDServicesParams object
...
/*GetMeSLAIDServicesParams contains all the parameters to send to the API endpoint
for the get me SLA ID services operation typically these are written to a http.Request
*/
...
func (o *GetMeSLAIDServicesParams) WithTimeout(timeout time.Duration) *GetMeSLAIDServicesParams {
...
func (o *GetMeSLAIDServicesParams) WithContext(ctx context.Context) *GetMeSLAIDServicesParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeSLAIDServicesParams) WithID(id int64) *GetMeSLAIDServicesParams {
	o.SetID(id)
	return o
}
...
func (o *GetMeSLAIDServicesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

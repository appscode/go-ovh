...
// NewGetMeOrderOrderIDPaymentMeansParams creates a new GetMeOrderOrderIDPaymentMeansParams object
// with the default values initialized.
func NewGetMeOrderOrderIDPaymentMeansParams() *GetMeOrderOrderIDPaymentMeansParams {
	var ()
	return &GetMeOrderOrderIDPaymentMeansParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeOrderOrderIDPaymentMeansParamsWithTimeout creates a new GetMeOrderOrderIDPaymentMeansParams object
...
// NewGetMeOrderOrderIDPaymentMeansParamsWithContext creates a new GetMeOrderOrderIDPaymentMeansParams object
...
// NewGetMeOrderOrderIDPaymentMeansParamsWithHTTPClient creates a new GetMeOrderOrderIDPaymentMeansParams object
...
/*GetMeOrderOrderIDPaymentMeansParams contains all the parameters to send to the API endpoint
for the get me order order ID payment means operation typically these are written to a http.Request
*/
...
func (o *GetMeOrderOrderIDPaymentMeansParams) WithTimeout(timeout time.Duration) *GetMeOrderOrderIDPaymentMeansParams {
...
func (o *GetMeOrderOrderIDPaymentMeansParams) WithContext(ctx context.Context) *GetMeOrderOrderIDPaymentMeansParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get me order order ID payment means params
func (o *GetMeOrderOrderIDPaymentMeansParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get me order order ID payment means params
func (o *GetMeOrderOrderIDPaymentMeansParams) WithHTTPClient(client *http.Client) *GetMeOrderOrderIDPaymentMeansParams {
...
func (o *GetMeOrderOrderIDPaymentMeansParams) WithOrderID(orderID int64) *GetMeOrderOrderIDPaymentMeansParams {
...
func (o *GetMeOrderOrderIDPaymentMeansParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

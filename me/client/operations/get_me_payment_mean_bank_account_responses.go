...
func (o *GetMePaymentMeanBankAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMePaymentMeanBankAccountOK()
	...
	default:
		result := NewGetMePaymentMeanBankAccountDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetMePaymentMeanBankAccountOK() *GetMePaymentMeanBankAccountOK {
	return &GetMePaymentMeanBankAccountOK{}
}
...
func (o *GetMePaymentMeanBankAccountOK) Error() string {
	return fmt.Sprintf("[GET /me/paymentMean/bankAccount][%d] getMePaymentMeanBankAccountOK  %+v", 200, o.Payload)
}

func (o *GetMePaymentMeanBankAccountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMePaymentMeanBankAccountDefault(code int) *GetMePaymentMeanBankAccountDefault {
	return &GetMePaymentMeanBankAccountDefault{
		_statusCode: code,
	}
}
...
func (o *GetMePaymentMeanBankAccountDefault) Code() int {
	return o._statusCode
}

func (o *GetMePaymentMeanBankAccountDefault) Error() string {
	return fmt.Sprintf("[GET /me/paymentMean/bankAccount][%d] GetMePaymentMeanBankAccount default  %+v", o._statusCode, o.Payload)
}

func (o *GetMePaymentMeanBankAccountDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMePaymentMeanBankAccountDefaultBody)

...
func (o *PostMeDocumentCorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostMeDocumentCorsOK()
	...
	default:
		result := NewPostMeDocumentCorsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PostMeDocumentCorsOK) Error() string {
	return fmt.Sprintf("[POST /me/document/cors][%d] postMeDocumentCorsOK ", 200)
}

func (o *PostMeDocumentCorsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostMeDocumentCorsDefault(code int) *PostMeDocumentCorsDefault {
	return &PostMeDocumentCorsDefault{
		_statusCode: code,
	}
}
...
func (o *PostMeDocumentCorsDefault) Error() string {
	return fmt.Sprintf("[POST /me/document/cors][%d] PostMeDocumentCors default  %+v", o._statusCode, o.Payload)
}

func (o *PostMeDocumentCorsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMeDocumentCorsDefaultBody)

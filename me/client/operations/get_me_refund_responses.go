...
func (o *GetMeRefundReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeRefundDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeRefundOK) Error() string {
	return fmt.Sprintf("[GET /me/refund][%d] getMeRefundOK  %+v", 200, o.Payload)
}

func (o *GetMeRefundOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetMeRefundDefault) Error() string {
	return fmt.Sprintf("[GET /me/refund][%d] GetMeRefund default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeRefundDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeRefundDefaultBody)

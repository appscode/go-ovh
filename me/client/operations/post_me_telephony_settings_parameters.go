...
// NewPostMeTelephonySettingsParams creates a new PostMeTelephonySettingsParams object
// with the default values initialized.
func NewPostMeTelephonySettingsParams() *PostMeTelephonySettingsParams {
	var ()
	return &PostMeTelephonySettingsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeTelephonySettingsParamsWithTimeout creates a new PostMeTelephonySettingsParams object
...
// NewPostMeTelephonySettingsParamsWithContext creates a new PostMeTelephonySettingsParams object
...
// NewPostMeTelephonySettingsParamsWithHTTPClient creates a new PostMeTelephonySettingsParams object
...
/*PostMeTelephonySettingsParams contains all the parameters to send to the API endpoint
for the post me telephony settings operation typically these are written to a http.Request
*/
...
func (o *PostMeTelephonySettingsParams) WithTimeout(timeout time.Duration) *PostMeTelephonySettingsParams {
...
func (o *PostMeTelephonySettingsParams) WithContext(ctx context.Context) *PostMeTelephonySettingsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeTelephonySettingsParams) WithHTTPClient(client *http.Client) *PostMeTelephonySettingsParams {
...
func (o *PostMeTelephonySettingsParams) WithMeTelephonySettingsPost(meTelephonySettingsPost *models.PostMeTelephonySettingsParamsBody) *PostMeTelephonySettingsParams {
	o.SetMeTelephonySettingsPost(meTelephonySettingsPost)
	return o
}
...
func (o *PostMeTelephonySettingsParams) SetMeTelephonySettingsPost(meTelephonySettingsPost *models.PostMeTelephonySettingsParamsBody) {
	o.MeTelephonySettingsPost = meTelephonySettingsPost
}

// WriteToRequest writes these params to a swagger request
func (o *PostMeTelephonySettingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeTelephonySettingsPost != nil {
		if err := r.SetBodyParam(o.MeTelephonySettingsPost); err != nil {
			return err
		}
	}

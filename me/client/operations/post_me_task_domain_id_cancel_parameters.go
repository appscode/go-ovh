...
// NewPostMeTaskDomainIDCancelParams creates a new PostMeTaskDomainIDCancelParams object
// with the default values initialized.
func NewPostMeTaskDomainIDCancelParams() *PostMeTaskDomainIDCancelParams {
	var ()
	return &PostMeTaskDomainIDCancelParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeTaskDomainIDCancelParamsWithTimeout creates a new PostMeTaskDomainIDCancelParams object
...
// NewPostMeTaskDomainIDCancelParamsWithContext creates a new PostMeTaskDomainIDCancelParams object
...
// NewPostMeTaskDomainIDCancelParamsWithHTTPClient creates a new PostMeTaskDomainIDCancelParams object
...
/*PostMeTaskDomainIDCancelParams contains all the parameters to send to the API endpoint
for the post me task domain ID cancel operation typically these are written to a http.Request
*/
...
func (o *PostMeTaskDomainIDCancelParams) WithTimeout(timeout time.Duration) *PostMeTaskDomainIDCancelParams {
...
func (o *PostMeTaskDomainIDCancelParams) WithContext(ctx context.Context) *PostMeTaskDomainIDCancelParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeTaskDomainIDCancelParams) WithHTTPClient(client *http.Client) *PostMeTaskDomainIDCancelParams {
...
func (o *PostMeTaskDomainIDCancelParams) WithID(id int64) *PostMeTaskDomainIDCancelParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the post me task domain ID cancel params
func (o *PostMeTaskDomainIDCancelParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *PostMeTaskDomainIDCancelParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

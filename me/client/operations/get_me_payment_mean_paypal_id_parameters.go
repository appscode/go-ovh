...
// NewGetMePaymentMeanPaypalIDParams creates a new GetMePaymentMeanPaypalIDParams object
// with the default values initialized.
func NewGetMePaymentMeanPaypalIDParams() *GetMePaymentMeanPaypalIDParams {
	var ()
	return &GetMePaymentMeanPaypalIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMePaymentMeanPaypalIDParamsWithTimeout creates a new GetMePaymentMeanPaypalIDParams object
...
// NewGetMePaymentMeanPaypalIDParamsWithContext creates a new GetMePaymentMeanPaypalIDParams object
...
// NewGetMePaymentMeanPaypalIDParamsWithHTTPClient creates a new GetMePaymentMeanPaypalIDParams object
...
/*GetMePaymentMeanPaypalIDParams contains all the parameters to send to the API endpoint
for the get me payment mean paypal ID operation typically these are written to a http.Request
*/
...
func (o *GetMePaymentMeanPaypalIDParams) WithTimeout(timeout time.Duration) *GetMePaymentMeanPaypalIDParams {
...
func (o *GetMePaymentMeanPaypalIDParams) WithContext(ctx context.Context) *GetMePaymentMeanPaypalIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMePaymentMeanPaypalIDParams) WithHTTPClient(client *http.Client) *GetMePaymentMeanPaypalIDParams {
...
func (o *GetMePaymentMeanPaypalIDParams) WithID(id int64) *GetMePaymentMeanPaypalIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get me payment mean paypal ID params
func (o *GetMePaymentMeanPaypalIDParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *GetMePaymentMeanPaypalIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *GetMeSLAReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeSLADefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeSLAOK) Error() string {
	return fmt.Sprintf("[GET /me/sla][%d] getMeSlaOK  %+v", 200, o.Payload)
}

func (o *GetMeSLAOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetMeSLADefault) Error() string {
	return fmt.Sprintf("[GET /me/sla][%d] GetMeSLA default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeSLADefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeSLADefaultBody)

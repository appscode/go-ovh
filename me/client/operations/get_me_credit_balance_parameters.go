...
// NewGetMeCreditBalanceParams creates a new GetMeCreditBalanceParams object
// with the default values initialized.
func NewGetMeCreditBalanceParams() *GetMeCreditBalanceParams {

	return &GetMeCreditBalanceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeCreditBalanceParamsWithTimeout creates a new GetMeCreditBalanceParams object
...
// NewGetMeCreditBalanceParamsWithContext creates a new GetMeCreditBalanceParams object
...
// NewGetMeCreditBalanceParamsWithHTTPClient creates a new GetMeCreditBalanceParams object
...
/*GetMeCreditBalanceParams contains all the parameters to send to the API endpoint
for the get me credit balance operation typically these are written to a http.Request
*/
...
func (o *GetMeCreditBalanceParams) WithTimeout(timeout time.Duration) *GetMeCreditBalanceParams {
...
func (o *GetMeCreditBalanceParams) WithContext(ctx context.Context) *GetMeCreditBalanceParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeCreditBalanceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

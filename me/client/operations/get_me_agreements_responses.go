...
func (o *GetMeAgreementsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeAgreementsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeAgreementsOK) Error() string {
	return fmt.Sprintf("[GET /me/agreements][%d] getMeAgreementsOK  %+v", 200, o.Payload)
}

func (o *GetMeAgreementsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetMeAgreementsDefault) Error() string {
	return fmt.Sprintf("[GET /me/agreements][%d] GetMeAgreements default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeAgreementsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeAgreementsDefaultBody)

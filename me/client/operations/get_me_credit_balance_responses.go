...
func (o *GetMeCreditBalanceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeCreditBalanceOK()
	...
	default:
		result := NewGetMeCreditBalanceDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeCreditBalanceOK) Error() string {
	return fmt.Sprintf("[GET /me/credit/balance][%d] getMeCreditBalanceOK  %+v", 200, o.Payload)
}

func (o *GetMeCreditBalanceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeCreditBalanceDefault(code int) *GetMeCreditBalanceDefault {
	return &GetMeCreditBalanceDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeCreditBalanceDefault) Error() string {
	return fmt.Sprintf("[GET /me/credit/balance][%d] GetMeCreditBalance default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeCreditBalanceDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeCreditBalanceDefaultBody)

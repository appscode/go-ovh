...
// NewPostMePaymentMeanPaypalParams creates a new PostMePaymentMeanPaypalParams object
// with the default values initialized.
func NewPostMePaymentMeanPaypalParams() *PostMePaymentMeanPaypalParams {
	var ()
	return &PostMePaymentMeanPaypalParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMePaymentMeanPaypalParamsWithTimeout creates a new PostMePaymentMeanPaypalParams object
...
// NewPostMePaymentMeanPaypalParamsWithContext creates a new PostMePaymentMeanPaypalParams object
...
// NewPostMePaymentMeanPaypalParamsWithHTTPClient creates a new PostMePaymentMeanPaypalParams object
...
/*PostMePaymentMeanPaypalParams contains all the parameters to send to the API endpoint
for the post me payment mean paypal operation typically these are written to a http.Request
*/
...
func (o *PostMePaymentMeanPaypalParams) WithTimeout(timeout time.Duration) *PostMePaymentMeanPaypalParams {
...
func (o *PostMePaymentMeanPaypalParams) WithContext(ctx context.Context) *PostMePaymentMeanPaypalParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMePaymentMeanPaypalParams) WithHTTPClient(client *http.Client) *PostMePaymentMeanPaypalParams {
...
func (o *PostMePaymentMeanPaypalParams) WithMePaymentMeanPaypalPost(mePaymentMeanPaypalPost *models.PostMePaymentMeanPaypalParamsBody) *PostMePaymentMeanPaypalParams {
	o.SetMePaymentMeanPaypalPost(mePaymentMeanPaypalPost)
	return o
}
...
func (o *PostMePaymentMeanPaypalParams) SetMePaymentMeanPaypalPost(mePaymentMeanPaypalPost *models.PostMePaymentMeanPaypalParamsBody) {
	o.MePaymentMeanPaypalPost = mePaymentMeanPaypalPost
}

// WriteToRequest writes these params to a swagger request
func (o *PostMePaymentMeanPaypalParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MePaymentMeanPaypalPost != nil {
		if err := r.SetBodyParam(o.MePaymentMeanPaypalPost); err != nil {
			return err
		}
	}

...
func (o *PostMeContactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPostMeContactDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PostMeContactOK) Error() string {
	return fmt.Sprintf("[POST /me/contact][%d] postMeContactOK  %+v", 200, o.Payload)
}

func (o *PostMeContactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PostMeContactDefault) Error() string {
	return fmt.Sprintf("[POST /me/contact][%d] PostMeContact default  %+v", o._statusCode, o.Payload)
}

func (o *PostMeContactDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMeContactDefaultBody)

...
// NewGetMeAPILogsSelfParams creates a new GetMeAPILogsSelfParams object
// with the default values initialized.
func NewGetMeAPILogsSelfParams() *GetMeAPILogsSelfParams {

	return &GetMeAPILogsSelfParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeAPILogsSelfParamsWithTimeout creates a new GetMeAPILogsSelfParams object
...
// NewGetMeAPILogsSelfParamsWithContext creates a new GetMeAPILogsSelfParams object
...
// NewGetMeAPILogsSelfParamsWithHTTPClient creates a new GetMeAPILogsSelfParams object
...
/*GetMeAPILogsSelfParams contains all the parameters to send to the API endpoint
for the get me API logs self operation typically these are written to a http.Request
*/
...
func (o *GetMeAPILogsSelfParams) WithTimeout(timeout time.Duration) *GetMeAPILogsSelfParams {
...
func (o *GetMeAPILogsSelfParams) WithContext(ctx context.Context) *GetMeAPILogsSelfParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeAPILogsSelfParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

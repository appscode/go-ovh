...
// NewPostMeXdslSettingParams creates a new PostMeXdslSettingParams object
// with the default values initialized.
func NewPostMeXdslSettingParams() *PostMeXdslSettingParams {
	var ()
	return &PostMeXdslSettingParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeXdslSettingParamsWithTimeout creates a new PostMeXdslSettingParams object
...
// NewPostMeXdslSettingParamsWithContext creates a new PostMeXdslSettingParams object
...
// NewPostMeXdslSettingParamsWithHTTPClient creates a new PostMeXdslSettingParams object
...
/*PostMeXdslSettingParams contains all the parameters to send to the API endpoint
for the post me xdsl setting operation typically these are written to a http.Request
*/
...
func (o *PostMeXdslSettingParams) WithTimeout(timeout time.Duration) *PostMeXdslSettingParams {
...
func (o *PostMeXdslSettingParams) WithContext(ctx context.Context) *PostMeXdslSettingParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeXdslSettingParams) WithMeXdslSettingPost(meXdslSettingPost *models.PostMeXdslSettingParamsBody) *PostMeXdslSettingParams {
	o.SetMeXdslSettingPost(meXdslSettingPost)
	return o
}
...
func (o *PostMeXdslSettingParams) SetMeXdslSettingPost(meXdslSettingPost *models.PostMeXdslSettingParamsBody) {
	o.MeXdslSettingPost = meXdslSettingPost
}

// WriteToRequest writes these params to a swagger request
func (o *PostMeXdslSettingParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeXdslSettingPost != nil {
		if err := r.SetBodyParam(o.MeXdslSettingPost); err != nil {
			return err
		}
	}

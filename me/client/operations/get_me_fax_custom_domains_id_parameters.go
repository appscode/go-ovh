...
// NewGetMeFaxCustomDomainsIDParams creates a new GetMeFaxCustomDomainsIDParams object
// with the default values initialized.
func NewGetMeFaxCustomDomainsIDParams() *GetMeFaxCustomDomainsIDParams {
	var ()
	return &GetMeFaxCustomDomainsIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeFaxCustomDomainsIDParamsWithTimeout creates a new GetMeFaxCustomDomainsIDParams object
...
// NewGetMeFaxCustomDomainsIDParamsWithContext creates a new GetMeFaxCustomDomainsIDParams object
...
// NewGetMeFaxCustomDomainsIDParamsWithHTTPClient creates a new GetMeFaxCustomDomainsIDParams object
...
/*GetMeFaxCustomDomainsIDParams contains all the parameters to send to the API endpoint
for the get me fax custom domains ID operation typically these are written to a http.Request
*/
...
func (o *GetMeFaxCustomDomainsIDParams) WithTimeout(timeout time.Duration) *GetMeFaxCustomDomainsIDParams {
...
func (o *GetMeFaxCustomDomainsIDParams) WithContext(ctx context.Context) *GetMeFaxCustomDomainsIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeFaxCustomDomainsIDParams) WithHTTPClient(client *http.Client) *GetMeFaxCustomDomainsIDParams {
...
func (o *GetMeFaxCustomDomainsIDParams) WithID(id int64) *GetMeFaxCustomDomainsIDParams {
	o.SetID(id)
	return o
}
...
func (o *GetMeFaxCustomDomainsIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

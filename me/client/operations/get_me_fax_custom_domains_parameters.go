...
// NewGetMeFaxCustomDomainsParams creates a new GetMeFaxCustomDomainsParams object
// with the default values initialized.
func NewGetMeFaxCustomDomainsParams() *GetMeFaxCustomDomainsParams {

	return &GetMeFaxCustomDomainsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeFaxCustomDomainsParamsWithTimeout creates a new GetMeFaxCustomDomainsParams object
...
// NewGetMeFaxCustomDomainsParamsWithContext creates a new GetMeFaxCustomDomainsParams object
...
// NewGetMeFaxCustomDomainsParamsWithHTTPClient creates a new GetMeFaxCustomDomainsParams object
...
/*GetMeFaxCustomDomainsParams contains all the parameters to send to the API endpoint
for the get me fax custom domains operation typically these are written to a http.Request
*/
...
func (o *GetMeFaxCustomDomainsParams) WithTimeout(timeout time.Duration) *GetMeFaxCustomDomainsParams {
...
func (o *GetMeFaxCustomDomainsParams) WithContext(ctx context.Context) *GetMeFaxCustomDomainsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeFaxCustomDomainsParams) WithHTTPClient(client *http.Client) *GetMeFaxCustomDomainsParams {
...
func (o *GetMeFaxCustomDomainsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

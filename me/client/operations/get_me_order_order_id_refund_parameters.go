...
// NewGetMeOrderOrderIDRefundParams creates a new GetMeOrderOrderIDRefundParams object
// with the default values initialized.
func NewGetMeOrderOrderIDRefundParams() *GetMeOrderOrderIDRefundParams {
	var ()
	return &GetMeOrderOrderIDRefundParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeOrderOrderIDRefundParamsWithTimeout creates a new GetMeOrderOrderIDRefundParams object
...
// NewGetMeOrderOrderIDRefundParamsWithContext creates a new GetMeOrderOrderIDRefundParams object
...
// NewGetMeOrderOrderIDRefundParamsWithHTTPClient creates a new GetMeOrderOrderIDRefundParams object
...
/*GetMeOrderOrderIDRefundParams contains all the parameters to send to the API endpoint
for the get me order order ID refund operation typically these are written to a http.Request
*/
...
func (o *GetMeOrderOrderIDRefundParams) WithTimeout(timeout time.Duration) *GetMeOrderOrderIDRefundParams {
...
func (o *GetMeOrderOrderIDRefundParams) WithContext(ctx context.Context) *GetMeOrderOrderIDRefundParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeOrderOrderIDRefundParams) WithHTTPClient(client *http.Client) *GetMeOrderOrderIDRefundParams {
...
func (o *GetMeOrderOrderIDRefundParams) WithOrderID(orderID int64) *GetMeOrderOrderIDRefundParams {
...
func (o *GetMeOrderOrderIDRefundParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewDeleteMeDocumentIDParams creates a new DeleteMeDocumentIDParams object
// with the default values initialized.
func NewDeleteMeDocumentIDParams() *DeleteMeDocumentIDParams {
	var ()
	return &DeleteMeDocumentIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteMeDocumentIDParamsWithTimeout creates a new DeleteMeDocumentIDParams object
...
// NewDeleteMeDocumentIDParamsWithContext creates a new DeleteMeDocumentIDParams object
...
// NewDeleteMeDocumentIDParamsWithHTTPClient creates a new DeleteMeDocumentIDParams object
...
/*DeleteMeDocumentIDParams contains all the parameters to send to the API endpoint
for the delete me document ID operation typically these are written to a http.Request
*/
...
func (o *DeleteMeDocumentIDParams) WithTimeout(timeout time.Duration) *DeleteMeDocumentIDParams {
...
func (o *DeleteMeDocumentIDParams) WithContext(ctx context.Context) *DeleteMeDocumentIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteMeDocumentIDParams) WithID(id string) *DeleteMeDocumentIDParams {
	o.SetID(id)
	return o
}
...
func (o *DeleteMeDocumentIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

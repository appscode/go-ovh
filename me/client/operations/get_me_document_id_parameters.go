...
// NewGetMeDocumentIDParams creates a new GetMeDocumentIDParams object
// with the default values initialized.
func NewGetMeDocumentIDParams() *GetMeDocumentIDParams {
	var ()
	return &GetMeDocumentIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeDocumentIDParamsWithTimeout creates a new GetMeDocumentIDParams object
...
// NewGetMeDocumentIDParamsWithContext creates a new GetMeDocumentIDParams object
...
// NewGetMeDocumentIDParamsWithHTTPClient creates a new GetMeDocumentIDParams object
...
/*GetMeDocumentIDParams contains all the parameters to send to the API endpoint
for the get me document ID operation typically these are written to a http.Request
*/
...
func (o *GetMeDocumentIDParams) WithContext(ctx context.Context) *GetMeDocumentIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeDocumentIDParams) WithID(id string) *GetMeDocumentIDParams {
	o.SetID(id)
	return o
}

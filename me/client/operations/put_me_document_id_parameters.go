...
// NewPutMeDocumentIDParams creates a new PutMeDocumentIDParams object
// with the default values initialized.
func NewPutMeDocumentIDParams() *PutMeDocumentIDParams {
	var ()
	return &PutMeDocumentIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutMeDocumentIDParamsWithTimeout creates a new PutMeDocumentIDParams object
...
// NewPutMeDocumentIDParamsWithContext creates a new PutMeDocumentIDParams object
...
// NewPutMeDocumentIDParamsWithHTTPClient creates a new PutMeDocumentIDParams object
...
/*PutMeDocumentIDParams contains all the parameters to send to the API endpoint
for the put me document ID operation typically these are written to a http.Request
*/
...
func (o *PutMeDocumentIDParams) WithContext(ctx context.Context) *PutMeDocumentIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutMeDocumentIDParams) WithID(id string) *PutMeDocumentIDParams {
	o.SetID(id)
	return o
}
...
func (o *PutMeDocumentIDParams) WithMeDocumentPut(meDocumentPut *models.NichandleDocumentDocument) *PutMeDocumentIDParams {
	o.SetMeDocumentPut(meDocumentPut)
	return o
}
...
func (o *PutMeDocumentIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeDocumentPut != nil {
		if err := r.SetBodyParam(o.MeDocumentPut); err != nil {
			return err
		}
	}

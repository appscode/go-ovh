...
// NewGetMeSLAIDStatusParams creates a new GetMeSLAIDStatusParams object
// with the default values initialized.
func NewGetMeSLAIDStatusParams() *GetMeSLAIDStatusParams {
	var ()
	return &GetMeSLAIDStatusParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeSLAIDStatusParamsWithTimeout creates a new GetMeSLAIDStatusParams object
...
// NewGetMeSLAIDStatusParamsWithContext creates a new GetMeSLAIDStatusParams object
...
// NewGetMeSLAIDStatusParamsWithHTTPClient creates a new GetMeSLAIDStatusParams object
...
/*GetMeSLAIDStatusParams contains all the parameters to send to the API endpoint
for the get me SLA ID status operation typically these are written to a http.Request
*/
...
func (o *GetMeSLAIDStatusParams) WithTimeout(timeout time.Duration) *GetMeSLAIDStatusParams {
...
func (o *GetMeSLAIDStatusParams) WithContext(ctx context.Context) *GetMeSLAIDStatusParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeSLAIDStatusParams) WithID(id int64) *GetMeSLAIDStatusParams {
	o.SetID(id)
	return o
}
...
func (o *GetMeSLAIDStatusParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

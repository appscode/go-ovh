...
// NewGetMeOrderOrderIDParams creates a new GetMeOrderOrderIDParams object
// with the default values initialized.
func NewGetMeOrderOrderIDParams() *GetMeOrderOrderIDParams {
	var ()
	return &GetMeOrderOrderIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeOrderOrderIDParamsWithTimeout creates a new GetMeOrderOrderIDParams object
...
// NewGetMeOrderOrderIDParamsWithContext creates a new GetMeOrderOrderIDParams object
...
// NewGetMeOrderOrderIDParamsWithHTTPClient creates a new GetMeOrderOrderIDParams object
...
/*GetMeOrderOrderIDParams contains all the parameters to send to the API endpoint
for the get me order order ID operation typically these are written to a http.Request
*/
...
func (o *GetMeOrderOrderIDParams) WithTimeout(timeout time.Duration) *GetMeOrderOrderIDParams {
...
func (o *GetMeOrderOrderIDParams) WithContext(ctx context.Context) *GetMeOrderOrderIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeOrderOrderIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

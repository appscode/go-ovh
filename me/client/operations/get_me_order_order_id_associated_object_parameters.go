...
// NewGetMeOrderOrderIDAssociatedObjectParams creates a new GetMeOrderOrderIDAssociatedObjectParams object
// with the default values initialized.
func NewGetMeOrderOrderIDAssociatedObjectParams() *GetMeOrderOrderIDAssociatedObjectParams {
	var ()
	return &GetMeOrderOrderIDAssociatedObjectParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeOrderOrderIDAssociatedObjectParamsWithTimeout creates a new GetMeOrderOrderIDAssociatedObjectParams object
...
// NewGetMeOrderOrderIDAssociatedObjectParamsWithContext creates a new GetMeOrderOrderIDAssociatedObjectParams object
...
// NewGetMeOrderOrderIDAssociatedObjectParamsWithHTTPClient creates a new GetMeOrderOrderIDAssociatedObjectParams object
...
/*GetMeOrderOrderIDAssociatedObjectParams contains all the parameters to send to the API endpoint
for the get me order order ID associated object operation typically these are written to a http.Request
*/
...
func (o *GetMeOrderOrderIDAssociatedObjectParams) WithTimeout(timeout time.Duration) *GetMeOrderOrderIDAssociatedObjectParams {
...
func (o *GetMeOrderOrderIDAssociatedObjectParams) WithContext(ctx context.Context) *GetMeOrderOrderIDAssociatedObjectParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get me order order ID associated object params
func (o *GetMeOrderOrderIDAssociatedObjectParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get me order order ID associated object params
func (o *GetMeOrderOrderIDAssociatedObjectParams) WithHTTPClient(client *http.Client) *GetMeOrderOrderIDAssociatedObjectParams {
...
func (o *GetMeOrderOrderIDAssociatedObjectParams) WithOrderID(orderID int64) *GetMeOrderOrderIDAssociatedObjectParams {
...
func (o *GetMeOrderOrderIDAssociatedObjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *GetMeFaxCustomDomainsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeFaxCustomDomainsOK()
	...
	default:
		result := NewGetMeFaxCustomDomainsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetMeFaxCustomDomainsOK() *GetMeFaxCustomDomainsOK {
	return &GetMeFaxCustomDomainsOK{}
}
...
func (o *GetMeFaxCustomDomainsOK) Error() string {
	return fmt.Sprintf("[GET /me/fax/customDomains][%d] getMeFaxCustomDomainsOK  %+v", 200, o.Payload)
}

func (o *GetMeFaxCustomDomainsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeFaxCustomDomainsDefault(code int) *GetMeFaxCustomDomainsDefault {
	return &GetMeFaxCustomDomainsDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeFaxCustomDomainsDefault) Code() int {
	return o._statusCode
}

func (o *GetMeFaxCustomDomainsDefault) Error() string {
	return fmt.Sprintf("[GET /me/fax/customDomains][%d] GetMeFaxCustomDomains default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeFaxCustomDomainsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeFaxCustomDomainsDefaultBody)

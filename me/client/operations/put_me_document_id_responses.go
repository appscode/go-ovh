...
func (o *PutMeDocumentIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPutMeDocumentIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PutMeDocumentIDOK) Error() string {
	return fmt.Sprintf("[PUT /me/document/{id}][%d] putMeDocumentIdOK ", 200)
}

func (o *PutMeDocumentIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PutMeDocumentIDDefault) Error() string {
	return fmt.Sprintf("[PUT /me/document/{id}][%d] PutMeDocumentID default  %+v", o._statusCode, o.Payload)
}

func (o *PutMeDocumentIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutMeDocumentIDDefaultBody)

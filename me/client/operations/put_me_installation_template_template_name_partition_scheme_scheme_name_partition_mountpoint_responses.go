...
func (o *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {

	case 200:
		result := NewPutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK()
	...
	default:
		result := NewPutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK() *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK {
	return &PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK{}
}
...
func (o *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK) Error() string {
	return fmt.Sprintf("[PUT /me/installationTemplate/{templateName}/partitionScheme/{schemeName}/partition/{mountpoint}][%d] putMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK ", 200)
}

func (o *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault(code int) *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault {
	return &PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault{
		_statusCode: code,
	}
}
...
func (o *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault) Error() string {
	return fmt.Sprintf("[PUT /me/installationTemplate/{templateName}/partitionScheme/{schemeName}/partition/{mountpoint}][%d] PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpoint default  %+v", o._statusCode, o.Payload)
}

func (o *PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutMeInstallationTemplateTemplateNamePartitionSchemeSchemeNamePartitionMountpointDefaultBody)

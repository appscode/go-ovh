...
func (o *GetMeCertificatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewGetMeCertificatesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeCertificatesOK) Error() string {
	return fmt.Sprintf("[GET /me/certificates][%d] getMeCertificatesOK  %+v", 200, o.Payload)
}

func (o *GetMeCertificatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeCertificatesDefault(code int) *GetMeCertificatesDefault {
	return &GetMeCertificatesDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeCertificatesDefault) Error() string {
	return fmt.Sprintf("[GET /me/certificates][%d] GetMeCertificates default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeCertificatesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeCertificatesDefaultBody)

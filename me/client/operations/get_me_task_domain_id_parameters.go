...
// NewGetMeTaskDomainIDParams creates a new GetMeTaskDomainIDParams object
// with the default values initialized.
func NewGetMeTaskDomainIDParams() *GetMeTaskDomainIDParams {
	var ()
	return &GetMeTaskDomainIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeTaskDomainIDParamsWithTimeout creates a new GetMeTaskDomainIDParams object
...
// NewGetMeTaskDomainIDParamsWithContext creates a new GetMeTaskDomainIDParams object
...
// NewGetMeTaskDomainIDParamsWithHTTPClient creates a new GetMeTaskDomainIDParams object
...
/*GetMeTaskDomainIDParams contains all the parameters to send to the API endpoint
for the get me task domain ID operation typically these are written to a http.Request
*/
...
func (o *GetMeTaskDomainIDParams) WithTimeout(timeout time.Duration) *GetMeTaskDomainIDParams {
...
func (o *GetMeTaskDomainIDParams) WithContext(ctx context.Context) *GetMeTaskDomainIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeTaskDomainIDParams) WithID(id int64) *GetMeTaskDomainIDParams {
	o.SetID(id)
	return o
}
...
func (o *GetMeTaskDomainIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

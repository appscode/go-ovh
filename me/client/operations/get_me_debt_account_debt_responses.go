...
func (o *GetMeDebtAccountDebtReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeDebtAccountDebtOK()
	...
	default:
		result := NewGetMeDebtAccountDebtDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeDebtAccountDebtOK) Error() string {
	return fmt.Sprintf("[GET /me/debtAccount/debt][%d] getMeDebtAccountDebtOK  %+v", 200, o.Payload)
}

func (o *GetMeDebtAccountDebtOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeDebtAccountDebtDefault(code int) *GetMeDebtAccountDebtDefault {
	return &GetMeDebtAccountDebtDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeDebtAccountDebtDefault) Error() string {
	return fmt.Sprintf("[GET /me/debtAccount/debt][%d] GetMeDebtAccountDebt default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeDebtAccountDebtDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeDebtAccountDebtDefaultBody)

...
func (o *PostMeGeolocationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPostMeGeolocationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PostMeGeolocationOK) Error() string {
	return fmt.Sprintf("[POST /me/geolocation][%d] postMeGeolocationOK  %+v", 200, o.Payload)
}

func (o *PostMeGeolocationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GeolocationContinentCountryLocation)
...
func NewPostMeGeolocationDefault(code int) *PostMeGeolocationDefault {
	return &PostMeGeolocationDefault{
		_statusCode: code,
	}
}
...
func (o *PostMeGeolocationDefault) Error() string {
	return fmt.Sprintf("[POST /me/geolocation][%d] PostMeGeolocation default  %+v", o._statusCode, o.Payload)
}

func (o *PostMeGeolocationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMeGeolocationDefaultBody)

...
func (o *PutMeSSHKeyKeyNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutMeSSHKeyKeyNameOK()
	...
	default:
		result := NewPutMeSSHKeyKeyNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PutMeSSHKeyKeyNameOK) Error() string {
	return fmt.Sprintf("[PUT /me/sshKey/{keyName}][%d] putMeSshKeyKeyNameOK ", 200)
}

func (o *PutMeSSHKeyKeyNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutMeSSHKeyKeyNameDefault(code int) *PutMeSSHKeyKeyNameDefault {
	return &PutMeSSHKeyKeyNameDefault{
		_statusCode: code,
	}
}
...
func (o *PutMeSSHKeyKeyNameDefault) Error() string {
	return fmt.Sprintf("[PUT /me/sshKey/{keyName}][%d] PutMeSSHKeyKeyName default  %+v", o._statusCode, o.Payload)
}

func (o *PutMeSSHKeyKeyNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutMeSSHKeyKeyNameDefaultBody)

...
func (o *GetMeAPICredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeAPICredentialOK()
	...
	default:
		result := NewGetMeAPICredentialDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetMeAPICredentialOK) Error() string {
	return fmt.Sprintf("[GET /me/api/credential][%d] getMeApiCredentialOK  %+v", 200, o.Payload)
}

func (o *GetMeAPICredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeAPICredentialDefault(code int) *GetMeAPICredentialDefault {
	return &GetMeAPICredentialDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeAPICredentialDefault) Error() string {
	return fmt.Sprintf("[GET /me/api/credential][%d] GetMeAPICredential default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeAPICredentialDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeAPICredentialDefaultBody)

...
func (o *GetMeAccessRestrictionIPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMeAccessRestrictionIPOK()
	...
	default:
		result := NewGetMeAccessRestrictionIPDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetMeAccessRestrictionIPOK() *GetMeAccessRestrictionIPOK {
	return &GetMeAccessRestrictionIPOK{}
}
...
func (o *GetMeAccessRestrictionIPOK) Error() string {
	return fmt.Sprintf("[GET /me/accessRestriction/ip][%d] getMeAccessRestrictionIpOK  %+v", 200, o.Payload)
}

func (o *GetMeAccessRestrictionIPOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMeAccessRestrictionIPDefault(code int) *GetMeAccessRestrictionIPDefault {
	return &GetMeAccessRestrictionIPDefault{
		_statusCode: code,
	}
}
...
func (o *GetMeAccessRestrictionIPDefault) Code() int {
	return o._statusCode
}

func (o *GetMeAccessRestrictionIPDefault) Error() string {
	return fmt.Sprintf("[GET /me/accessRestriction/ip][%d] GetMeAccessRestrictionIP default  %+v", o._statusCode, o.Payload)
}

func (o *GetMeAccessRestrictionIPDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetMeAccessRestrictionIPDefaultBody)

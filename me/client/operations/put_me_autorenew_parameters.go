...
// NewPutMeAutorenewParams creates a new PutMeAutorenewParams object
// with the default values initialized.
func NewPutMeAutorenewParams() *PutMeAutorenewParams {
	var ()
	return &PutMeAutorenewParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutMeAutorenewParamsWithTimeout creates a new PutMeAutorenewParams object
...
// NewPutMeAutorenewParamsWithContext creates a new PutMeAutorenewParams object
...
// NewPutMeAutorenewParamsWithHTTPClient creates a new PutMeAutorenewParams object
...
/*PutMeAutorenewParams contains all the parameters to send to the API endpoint
for the put me autorenew operation typically these are written to a http.Request
*/
...
func (o *PutMeAutorenewParams) WithContext(ctx context.Context) *PutMeAutorenewParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutMeAutorenewParams) WithMeAutorenewPut(meAutorenewPut *models.NichandleNicAutorenewInfos) *PutMeAutorenewParams {
	o.SetMeAutorenewPut(meAutorenewPut)
	return o
}
...
func (o *PutMeAutorenewParams) SetMeAutorenewPut(meAutorenewPut *models.NichandleNicAutorenewInfos) {
	o.MeAutorenewPut = meAutorenewPut
}
...
func (o *PutMeAutorenewParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MeAutorenewPut != nil {
		if err := r.SetBodyParam(o.MeAutorenewPut); err != nil {
			return err
		}
	}

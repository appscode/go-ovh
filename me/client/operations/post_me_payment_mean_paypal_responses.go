...
func (o *PostMePaymentMeanPaypalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostMePaymentMeanPaypalOK()
	...
	default:
		result := NewPostMePaymentMeanPaypalDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostMePaymentMeanPaypalOK() *PostMePaymentMeanPaypalOK {
	return &PostMePaymentMeanPaypalOK{}
}
...
func (o *PostMePaymentMeanPaypalOK) Error() string {
	return fmt.Sprintf("[POST /me/paymentMean/paypal][%d] postMePaymentMeanPaypalOK  %+v", 200, o.Payload)
}

func (o *PostMePaymentMeanPaypalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostMePaymentMeanPaypalDefault(code int) *PostMePaymentMeanPaypalDefault {
	return &PostMePaymentMeanPaypalDefault{
		_statusCode: code,
	}
}
...
func (o *PostMePaymentMeanPaypalDefault) Code() int {
	return o._statusCode
}

func (o *PostMePaymentMeanPaypalDefault) Error() string {
	return fmt.Sprintf("[POST /me/paymentMean/paypal][%d] PostMePaymentMeanPaypal default  %+v", o._statusCode, o.Payload)
}

func (o *PostMePaymentMeanPaypalDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostMePaymentMeanPaypalDefaultBody)

...
// NewPostMeDebtAccountPayParams creates a new PostMeDebtAccountPayParams object
// with the default values initialized.
func NewPostMeDebtAccountPayParams() *PostMeDebtAccountPayParams {

	return &PostMeDebtAccountPayParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMeDebtAccountPayParamsWithTimeout creates a new PostMeDebtAccountPayParams object
...
// NewPostMeDebtAccountPayParamsWithContext creates a new PostMeDebtAccountPayParams object
...
// NewPostMeDebtAccountPayParamsWithHTTPClient creates a new PostMeDebtAccountPayParams object
...
/*PostMeDebtAccountPayParams contains all the parameters to send to the API endpoint
for the post me debt account pay operation typically these are written to a http.Request
*/
...
func (o *PostMeDebtAccountPayParams) WithTimeout(timeout time.Duration) *PostMeDebtAccountPayParams {
...
func (o *PostMeDebtAccountPayParams) WithContext(ctx context.Context) *PostMeDebtAccountPayParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostMeDebtAccountPayParams) WithHTTPClient(client *http.Client) *PostMeDebtAccountPayParams {
...
func (o *PostMeDebtAccountPayParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewGetMeTaskContactChangeIDParams creates a new GetMeTaskContactChangeIDParams object
// with the default values initialized.
func NewGetMeTaskContactChangeIDParams() *GetMeTaskContactChangeIDParams {
	var ()
	return &GetMeTaskContactChangeIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeTaskContactChangeIDParamsWithTimeout creates a new GetMeTaskContactChangeIDParams object
...
// NewGetMeTaskContactChangeIDParamsWithContext creates a new GetMeTaskContactChangeIDParams object
...
// NewGetMeTaskContactChangeIDParamsWithHTTPClient creates a new GetMeTaskContactChangeIDParams object
...
/*GetMeTaskContactChangeIDParams contains all the parameters to send to the API endpoint
for the get me task contact change ID operation typically these are written to a http.Request
*/
...
func (o *GetMeTaskContactChangeIDParams) WithTimeout(timeout time.Duration) *GetMeTaskContactChangeIDParams {
...
func (o *GetMeTaskContactChangeIDParams) WithContext(ctx context.Context) *GetMeTaskContactChangeIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeTaskContactChangeIDParams) WithHTTPClient(client *http.Client) *GetMeTaskContactChangeIDParams {
...
func (o *GetMeTaskContactChangeIDParams) WithID(id int64) *GetMeTaskContactChangeIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get me task contact change ID params
func (o *GetMeTaskContactChangeIDParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *GetMeTaskContactChangeIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewGetMeAPIApplicationParams creates a new GetMeAPIApplicationParams object
// with the default values initialized.
func NewGetMeAPIApplicationParams() *GetMeAPIApplicationParams {

	return &GetMeAPIApplicationParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeAPIApplicationParamsWithTimeout creates a new GetMeAPIApplicationParams object
...
// NewGetMeAPIApplicationParamsWithContext creates a new GetMeAPIApplicationParams object
...
// NewGetMeAPIApplicationParamsWithHTTPClient creates a new GetMeAPIApplicationParams object
...
/*GetMeAPIApplicationParams contains all the parameters to send to the API endpoint
for the get me API application operation typically these are written to a http.Request
*/
...
func (o *GetMeAPIApplicationParams) WithTimeout(timeout time.Duration) *GetMeAPIApplicationParams {
...
func (o *GetMeAPIApplicationParams) WithContext(ctx context.Context) *GetMeAPIApplicationParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetMeAPIApplicationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewPostMePaymentMeanCreditCardParams creates a new PostMePaymentMeanCreditCardParams object
// with the default values initialized.
func NewPostMePaymentMeanCreditCardParams() *PostMePaymentMeanCreditCardParams {
	var ()
	return &PostMePaymentMeanCreditCardParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostMePaymentMeanCreditCardParamsWithTimeout creates a new PostMePaymentMeanCreditCardParams object
...
// NewPostMePaymentMeanCreditCardParamsWithContext creates a new PostMePaymentMeanCreditCardParams object
...
// NewPostMePaymentMeanCreditCardParamsWithHTTPClient creates a new PostMePaymentMeanCreditCardParams object
...
/*PostMePaymentMeanCreditCardParams contains all the parameters to send to the API endpoint
for the post me payment mean credit card operation typically these are written to a http.Request
*/
...
func (o *PostMePaymentMeanCreditCardParams) WithTimeout(timeout time.Duration) *PostMePaymentMeanCreditCardParams {
...
func (o *PostMePaymentMeanCreditCardParams) WithContext(ctx context.Context) *PostMePaymentMeanCreditCardParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post me payment mean credit card params
func (o *PostMePaymentMeanCreditCardParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the post me payment mean credit card params
func (o *PostMePaymentMeanCreditCardParams) WithHTTPClient(client *http.Client) *PostMePaymentMeanCreditCardParams {
...
func (o *PostMePaymentMeanCreditCardParams) WithMePaymentMeanCreditCardPost(mePaymentMeanCreditCardPost *models.PostMePaymentMeanCreditCardParamsBody) *PostMePaymentMeanCreditCardParams {
	o.SetMePaymentMeanCreditCardPost(mePaymentMeanCreditCardPost)
	return o
}
...
func (o *PostMePaymentMeanCreditCardParams) SetMePaymentMeanCreditCardPost(mePaymentMeanCreditCardPost *models.PostMePaymentMeanCreditCardParamsBody) {
	o.MePaymentMeanCreditCardPost = mePaymentMeanCreditCardPost
}

// WriteToRequest writes these params to a swagger request
func (o *PostMePaymentMeanCreditCardParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.MePaymentMeanCreditCardPost != nil {
		if err := r.SetBodyParam(o.MePaymentMeanCreditCardPost); err != nil {
			return err
		}
	}

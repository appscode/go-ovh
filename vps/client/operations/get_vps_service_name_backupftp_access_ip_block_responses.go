...
func (o *GetVpsServiceNameBackupftpAccessIPBlockReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameBackupftpAccessIPBlockOK()
	...
	default:
		result := NewGetVpsServiceNameBackupftpAccessIPBlockDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameBackupftpAccessIPBlockOK() *GetVpsServiceNameBackupftpAccessIPBlockOK {
	return &GetVpsServiceNameBackupftpAccessIPBlockOK{}
}
...
func (o *GetVpsServiceNameBackupftpAccessIPBlockOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/backupftp/access/{ipBlock}][%d] getVpsServiceNameBackupftpAccessIpBlockOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameBackupftpAccessIPBlockOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DedicatedServerBackupFtpACL)
...
func NewGetVpsServiceNameBackupftpAccessIPBlockDefault(code int) *GetVpsServiceNameBackupftpAccessIPBlockDefault {
	return &GetVpsServiceNameBackupftpAccessIPBlockDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameBackupftpAccessIPBlockDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/backupftp/access/{ipBlock}][%d] GetVpsServiceNameBackupftpAccessIPBlock default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameBackupftpAccessIPBlockDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameBackupftpAccessIPBlockDefaultBody)

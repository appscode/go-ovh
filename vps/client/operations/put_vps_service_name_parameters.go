...
// NewPutVpsServiceNameParams creates a new PutVpsServiceNameParams object
// with the default values initialized.
func NewPutVpsServiceNameParams() *PutVpsServiceNameParams {
	var ()
	return &PutVpsServiceNameParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutVpsServiceNameParamsWithTimeout creates a new PutVpsServiceNameParams object
...
// NewPutVpsServiceNameParamsWithContext creates a new PutVpsServiceNameParams object
...
// NewPutVpsServiceNameParamsWithHTTPClient creates a new PutVpsServiceNameParams object
...
/*PutVpsServiceNameParams contains all the parameters to send to the API endpoint
for the put vps service name operation typically these are written to a http.Request
*/
...
func (o *PutVpsServiceNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.VpsPut != nil {
		if err := r.SetBodyParam(o.VpsPut); err != nil {
			return err
		}
	}

...
func (o *DeleteVpsServiceNameVeeamRestoredBackupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteVpsServiceNameVeeamRestoredBackupOK()
	...
	default:
		result := NewDeleteVpsServiceNameVeeamRestoredBackupDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteVpsServiceNameVeeamRestoredBackupOK() *DeleteVpsServiceNameVeeamRestoredBackupOK {
	return &DeleteVpsServiceNameVeeamRestoredBackupOK{}
}
...
func (o *DeleteVpsServiceNameVeeamRestoredBackupOK) Error() string {
	return fmt.Sprintf("[DELETE /vps/{serviceName}/veeam/restoredBackup][%d] deleteVpsServiceNameVeeamRestoredBackupOK  %+v", 200, o.Payload)
}

func (o *DeleteVpsServiceNameVeeamRestoredBackupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteVpsServiceNameVeeamRestoredBackupDefault(code int) *DeleteVpsServiceNameVeeamRestoredBackupDefault {
	return &DeleteVpsServiceNameVeeamRestoredBackupDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteVpsServiceNameVeeamRestoredBackupDefault) Error() string {
	return fmt.Sprintf("[DELETE /vps/{serviceName}/veeam/restoredBackup][%d] DeleteVpsServiceNameVeeamRestoredBackup default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteVpsServiceNameVeeamRestoredBackupDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteVpsServiceNameVeeamRestoredBackupDefaultBody)

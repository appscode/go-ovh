...
func (o *DeleteVpsServiceNameIpsIPAddressReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteVpsServiceNameIpsIPAddressOK()
	...
	default:
		result := NewDeleteVpsServiceNameIpsIPAddressDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteVpsServiceNameIpsIPAddressOK() *DeleteVpsServiceNameIpsIPAddressOK {
	return &DeleteVpsServiceNameIpsIPAddressOK{}
}
...
func (o *DeleteVpsServiceNameIpsIPAddressOK) Error() string {
	return fmt.Sprintf("[DELETE /vps/{serviceName}/ips/{ipAddress}][%d] deleteVpsServiceNameIpsIpAddressOK ", 200)
}

func (o *DeleteVpsServiceNameIpsIPAddressOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteVpsServiceNameIpsIPAddressDefault(code int) *DeleteVpsServiceNameIpsIPAddressDefault {
	return &DeleteVpsServiceNameIpsIPAddressDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteVpsServiceNameIpsIPAddressDefault) Error() string {
	return fmt.Sprintf("[DELETE /vps/{serviceName}/ips/{ipAddress}][%d] DeleteVpsServiceNameIpsIPAddress default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteVpsServiceNameIpsIPAddressDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteVpsServiceNameIpsIPAddressDefaultBody)

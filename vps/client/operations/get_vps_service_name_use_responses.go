...
func (o *GetVpsServiceNameUseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameUseOK()
	...
	default:
		result := NewGetVpsServiceNameUseDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetVpsServiceNameUseOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/use][%d] getVpsServiceNameUseOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameUseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVpsServiceNameUseDefault(code int) *GetVpsServiceNameUseDefault {
	return &GetVpsServiceNameUseDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameUseDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/use][%d] GetVpsServiceNameUse default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameUseDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameUseDefaultBody)

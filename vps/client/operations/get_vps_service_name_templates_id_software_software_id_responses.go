...
func (o *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK()
	...
	default:
		result := NewGetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK() *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK {
	return &GetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK{}
}
...
func (o *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/templates/{id}/software/{softwareId}][%d] getVpsServiceNameTemplatesIdSoftwareSoftwareIdOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault(code int) *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault {
	return &GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/templates/{id}/software/{softwareId}][%d] GetVpsServiceNameTemplatesIDSoftwareSoftwareID default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefaultBody)

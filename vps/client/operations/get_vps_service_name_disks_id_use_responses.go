...
func (o *GetVpsServiceNameDisksIDUseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameDisksIDUseOK()
	...
	default:
		result := NewGetVpsServiceNameDisksIDUseDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameDisksIDUseOK() *GetVpsServiceNameDisksIDUseOK {
	return &GetVpsServiceNameDisksIDUseOK{}
}
...
func (o *GetVpsServiceNameDisksIDUseOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/disks/{id}/use][%d] getVpsServiceNameDisksIdUseOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameDisksIDUseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ComplexTypeUnitAndValueDouble)
...
func NewGetVpsServiceNameDisksIDUseDefault(code int) *GetVpsServiceNameDisksIDUseDefault {
	return &GetVpsServiceNameDisksIDUseDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameDisksIDUseDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/disks/{id}/use][%d] GetVpsServiceNameDisksIDUse default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameDisksIDUseDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameDisksIDUseDefaultBody)

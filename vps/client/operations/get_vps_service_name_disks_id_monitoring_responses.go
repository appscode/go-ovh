...
func (o *GetVpsServiceNameDisksIDMonitoringReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameDisksIDMonitoringOK()
	...
	default:
		result := NewGetVpsServiceNameDisksIDMonitoringDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameDisksIDMonitoringOK() *GetVpsServiceNameDisksIDMonitoringOK {
	return &GetVpsServiceNameDisksIDMonitoringOK{}
}
...
func (o *GetVpsServiceNameDisksIDMonitoringOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/disks/{id}/monitoring][%d] getVpsServiceNameDisksIdMonitoringOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameDisksIDMonitoringOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ComplexTypeUnitAndValuesVpsVpsTimestampValue)
...
func NewGetVpsServiceNameDisksIDMonitoringDefault(code int) *GetVpsServiceNameDisksIDMonitoringDefault {
	return &GetVpsServiceNameDisksIDMonitoringDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameDisksIDMonitoringDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/disks/{id}/monitoring][%d] GetVpsServiceNameDisksIDMonitoring default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameDisksIDMonitoringDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameDisksIDMonitoringDefaultBody)

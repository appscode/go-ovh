...
func (o *GetVpsServiceNameSecondaryDNSDomainsDomainReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameSecondaryDNSDomainsDomainOK()
	...
	default:
		result := NewGetVpsServiceNameSecondaryDNSDomainsDomainDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameSecondaryDNSDomainsDomainOK() *GetVpsServiceNameSecondaryDNSDomainsDomainOK {
	return &GetVpsServiceNameSecondaryDNSDomainsDomainOK{}
}
...
func (o *GetVpsServiceNameSecondaryDNSDomainsDomainOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/secondaryDnsDomains/{domain}][%d] getVpsServiceNameSecondaryDnsDomainsDomainOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameSecondaryDNSDomainsDomainOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.SecondaryDNSSecondaryDNS)
...
func NewGetVpsServiceNameSecondaryDNSDomainsDomainDefault(code int) *GetVpsServiceNameSecondaryDNSDomainsDomainDefault {
	return &GetVpsServiceNameSecondaryDNSDomainsDomainDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameSecondaryDNSDomainsDomainDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/secondaryDnsDomains/{domain}][%d] GetVpsServiceNameSecondaryDNSDomainsDomain default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameSecondaryDNSDomainsDomainDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameSecondaryDNSDomainsDomainDefaultBody)

...
func (o *GetVpsServiceNameIpsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameIpsOK()
	...
	default:
		result := NewGetVpsServiceNameIpsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetVpsServiceNameIpsOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/ips][%d] getVpsServiceNameIpsOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameIpsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVpsServiceNameIpsDefault(code int) *GetVpsServiceNameIpsDefault {
	return &GetVpsServiceNameIpsDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameIpsDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/ips][%d] GetVpsServiceNameIps default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameIpsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameIpsDefaultBody)

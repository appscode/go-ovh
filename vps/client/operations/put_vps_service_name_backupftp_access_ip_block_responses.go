...
func (o *PutVpsServiceNameBackupftpAccessIPBlockReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutVpsServiceNameBackupftpAccessIPBlockOK()
	...
	default:
		result := NewPutVpsServiceNameBackupftpAccessIPBlockDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutVpsServiceNameBackupftpAccessIPBlockOK() *PutVpsServiceNameBackupftpAccessIPBlockOK {
	return &PutVpsServiceNameBackupftpAccessIPBlockOK{}
}
...
func (o *PutVpsServiceNameBackupftpAccessIPBlockOK) Error() string {
	return fmt.Sprintf("[PUT /vps/{serviceName}/backupftp/access/{ipBlock}][%d] putVpsServiceNameBackupftpAccessIpBlockOK ", 200)
}

func (o *PutVpsServiceNameBackupftpAccessIPBlockOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutVpsServiceNameBackupftpAccessIPBlockDefault(code int) *PutVpsServiceNameBackupftpAccessIPBlockDefault {
	return &PutVpsServiceNameBackupftpAccessIPBlockDefault{
		_statusCode: code,
	}
}
...
func (o *PutVpsServiceNameBackupftpAccessIPBlockDefault) Error() string {
	return fmt.Sprintf("[PUT /vps/{serviceName}/backupftp/access/{ipBlock}][%d] PutVpsServiceNameBackupftpAccessIPBlock default  %+v", o._statusCode, o.Payload)
}

func (o *PutVpsServiceNameBackupftpAccessIPBlockDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutVpsServiceNameBackupftpAccessIPBlockDefaultBody)

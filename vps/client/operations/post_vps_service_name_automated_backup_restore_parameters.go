...
// NewPostVpsServiceNameAutomatedBackupRestoreParams creates a new PostVpsServiceNameAutomatedBackupRestoreParams object
// with the default values initialized.
func NewPostVpsServiceNameAutomatedBackupRestoreParams() *PostVpsServiceNameAutomatedBackupRestoreParams {
	var ()
	return &PostVpsServiceNameAutomatedBackupRestoreParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostVpsServiceNameAutomatedBackupRestoreParamsWithTimeout creates a new PostVpsServiceNameAutomatedBackupRestoreParams object
...
// NewPostVpsServiceNameAutomatedBackupRestoreParamsWithContext creates a new PostVpsServiceNameAutomatedBackupRestoreParams object
...
// NewPostVpsServiceNameAutomatedBackupRestoreParamsWithHTTPClient creates a new PostVpsServiceNameAutomatedBackupRestoreParams object
...
/*PostVpsServiceNameAutomatedBackupRestoreParams contains all the parameters to send to the API endpoint
for the post vps service name automated backup restore operation typically these are written to a http.Request
*/
...
func (o *PostVpsServiceNameAutomatedBackupRestoreParams) WithVpsAutomatedBackupRestorePost(vpsAutomatedBackupRestorePost *models.PostVpsServiceNameAutomatedBackupRestoreParamsBody) *PostVpsServiceNameAutomatedBackupRestoreParams {
	o.SetVpsAutomatedBackupRestorePost(vpsAutomatedBackupRestorePost)
	return o
}
...
func (o *PostVpsServiceNameAutomatedBackupRestoreParams) SetVpsAutomatedBackupRestorePost(vpsAutomatedBackupRestorePost *models.PostVpsServiceNameAutomatedBackupRestoreParamsBody) {
	o.VpsAutomatedBackupRestorePost = vpsAutomatedBackupRestorePost
}
...
func (o *PostVpsServiceNameAutomatedBackupRestoreParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.VpsAutomatedBackupRestorePost != nil {
		if err := r.SetBodyParam(o.VpsAutomatedBackupRestorePost); err != nil {
			return err
		}
	}

...
func (o *GetVpsServiceNameAutomatedBackupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameAutomatedBackupOK()
	...
	default:
		result := NewGetVpsServiceNameAutomatedBackupDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameAutomatedBackupOK() *GetVpsServiceNameAutomatedBackupOK {
	return &GetVpsServiceNameAutomatedBackupOK{}
}
...
func (o *GetVpsServiceNameAutomatedBackupOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/automatedBackup][%d] getVpsServiceNameAutomatedBackupOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameAutomatedBackupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.VpsAutomatedBackup)
...
func NewGetVpsServiceNameAutomatedBackupDefault(code int) *GetVpsServiceNameAutomatedBackupDefault {
	return &GetVpsServiceNameAutomatedBackupDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameAutomatedBackupDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/automatedBackup][%d] GetVpsServiceNameAutomatedBackup default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameAutomatedBackupDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameAutomatedBackupDefaultBody)

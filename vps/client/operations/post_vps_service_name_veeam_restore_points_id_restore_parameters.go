...
// NewPostVpsServiceNameVeeamRestorePointsIDRestoreParams creates a new PostVpsServiceNameVeeamRestorePointsIDRestoreParams object
// with the default values initialized.
func NewPostVpsServiceNameVeeamRestorePointsIDRestoreParams() *PostVpsServiceNameVeeamRestorePointsIDRestoreParams {
	var ()
	return &PostVpsServiceNameVeeamRestorePointsIDRestoreParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostVpsServiceNameVeeamRestorePointsIDRestoreParamsWithTimeout creates a new PostVpsServiceNameVeeamRestorePointsIDRestoreParams object
...
// NewPostVpsServiceNameVeeamRestorePointsIDRestoreParamsWithContext creates a new PostVpsServiceNameVeeamRestorePointsIDRestoreParams object
...
// NewPostVpsServiceNameVeeamRestorePointsIDRestoreParamsWithHTTPClient creates a new PostVpsServiceNameVeeamRestorePointsIDRestoreParams object
...
/*PostVpsServiceNameVeeamRestorePointsIDRestoreParams contains all the parameters to send to the API endpoint
for the post vps service name veeam restore points ID restore operation typically these are written to a http.Request
*/
...
func (o *PostVpsServiceNameVeeamRestorePointsIDRestoreParams) WithVpsVeeamRestorePointsRestorePost(vpsVeeamRestorePointsRestorePost *models.PostVpsServiceNameVeeamRestorePointsIDRestoreParamsBody) *PostVpsServiceNameVeeamRestorePointsIDRestoreParams {
	o.SetVpsVeeamRestorePointsRestorePost(vpsVeeamRestorePointsRestorePost)
	return o
}
...
func (o *PostVpsServiceNameVeeamRestorePointsIDRestoreParams) SetVpsVeeamRestorePointsRestorePost(vpsVeeamRestorePointsRestorePost *models.PostVpsServiceNameVeeamRestorePointsIDRestoreParamsBody) {
	o.VpsVeeamRestorePointsRestorePost = vpsVeeamRestorePointsRestorePost
}
...
func (o *PostVpsServiceNameVeeamRestorePointsIDRestoreParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.VpsVeeamRestorePointsRestorePost != nil {
		if err := r.SetBodyParam(o.VpsVeeamRestorePointsRestorePost); err != nil {
			return err
		}
	}

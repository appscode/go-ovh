...
func (o *GetVpsServiceNameAvailableUpgradeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameAvailableUpgradeOK()
	...
	default:
		result := NewGetVpsServiceNameAvailableUpgradeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameAvailableUpgradeOK() *GetVpsServiceNameAvailableUpgradeOK {
	return &GetVpsServiceNameAvailableUpgradeOK{}
}
...
func (o *GetVpsServiceNameAvailableUpgradeOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/availableUpgrade][%d] getVpsServiceNameAvailableUpgradeOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameAvailableUpgradeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVpsServiceNameAvailableUpgradeDefault(code int) *GetVpsServiceNameAvailableUpgradeDefault {
	return &GetVpsServiceNameAvailableUpgradeDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameAvailableUpgradeDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/availableUpgrade][%d] GetVpsServiceNameAvailableUpgrade default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameAvailableUpgradeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameAvailableUpgradeDefaultBody)

...
func (o *GetVpsServiceNameMonitoringReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetVpsServiceNameMonitoringOK()
	...
	default:
		result := NewGetVpsServiceNameMonitoringDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetVpsServiceNameMonitoringOK() *GetVpsServiceNameMonitoringOK {
	return &GetVpsServiceNameMonitoringOK{}
}
...
func (o *GetVpsServiceNameMonitoringOK) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/monitoring][%d] getVpsServiceNameMonitoringOK  %+v", 200, o.Payload)
}

func (o *GetVpsServiceNameMonitoringOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetVpsServiceNameMonitoringDefault(code int) *GetVpsServiceNameMonitoringDefault {
	return &GetVpsServiceNameMonitoringDefault{
		_statusCode: code,
	}
}
...
func (o *GetVpsServiceNameMonitoringDefault) Error() string {
	return fmt.Sprintf("[GET /vps/{serviceName}/monitoring][%d] GetVpsServiceNameMonitoring default  %+v", o._statusCode, o.Payload)
}

func (o *GetVpsServiceNameMonitoringDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetVpsServiceNameMonitoringDefaultBody)

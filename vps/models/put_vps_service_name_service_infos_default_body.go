...
// PutVpsServiceNameServiceInfosDefaultBody put vps service name service infos default body
// swagger:model putVpsServiceNameServiceInfosDefaultBody
...
func (m *PutVpsServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameServiceInfosDefaultBody

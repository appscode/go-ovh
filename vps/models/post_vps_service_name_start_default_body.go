...
// PostVpsServiceNameStartDefaultBody post vps service name start default body
// swagger:model postVpsServiceNameStartDefaultBody
...
func (m *PostVpsServiceNameStartDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameStartDefaultBody

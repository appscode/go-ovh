...
// GetVpsServiceNameSecondaryDNSNameServerAvailableDefaultBody get vps service name secondary Dns name server available default body
// swagger:model getVpsServiceNameSecondaryDnsNameServerAvailableDefaultBody
...
func (m *GetVpsServiceNameSecondaryDNSNameServerAvailableDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameSecondaryDNSNameServerAvailableDefaultBody

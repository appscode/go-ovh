...
// PostVpsServiceNameBackupftpAccessDefaultBody post vps service name backupftp access default body
// swagger:model postVpsServiceNameBackupftpAccessDefaultBody
...
func (m *PostVpsServiceNameBackupftpAccessDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameBackupftpAccessDefaultBody

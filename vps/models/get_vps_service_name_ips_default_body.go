...
// GetVpsServiceNameIpsDefaultBody get vps service name ips default body
// swagger:model getVpsServiceNameIpsDefaultBody
...
func (m *GetVpsServiceNameIpsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameIpsDefaultBody

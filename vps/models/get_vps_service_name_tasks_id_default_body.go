...
// GetVpsServiceNameTasksIDDefaultBody get vps service name tasks Id default body
// swagger:model getVpsServiceNameTasksIdDefaultBody
...
func (m *GetVpsServiceNameTasksIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTasksIDDefaultBody

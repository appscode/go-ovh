...
// GetVpsServiceNameDisksIDMonitoringDefaultBody get vps service name disks Id monitoring default body
// swagger:model getVpsServiceNameDisksIdMonitoringDefaultBody
...
func (m *GetVpsServiceNameDisksIDMonitoringDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDisksIDMonitoringDefaultBody

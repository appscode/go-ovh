...
// PostVpsServiceNameSecondaryDNSDomainsDefaultBody post vps service name secondary Dns domains default body
// swagger:model postVpsServiceNameSecondaryDnsDomainsDefaultBody
...
func (m *PostVpsServiceNameSecondaryDNSDomainsDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameSecondaryDNSDomainsDefaultBody

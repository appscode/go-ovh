...
// GetVpsServiceNameDistributionSoftwareSoftwareIDDefaultBody get vps service name distribution software software Id default body
// swagger:model getVpsServiceNameDistributionSoftwareSoftwareIdDefaultBody
...
func (m *GetVpsServiceNameDistributionSoftwareSoftwareIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDistributionSoftwareSoftwareIDDefaultBody

...
// GetVpsServiceNameTasksDefaultBody get vps service name tasks default body
// swagger:model getVpsServiceNameTasksDefaultBody
...
func (m *GetVpsServiceNameTasksDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTasksDefaultBody

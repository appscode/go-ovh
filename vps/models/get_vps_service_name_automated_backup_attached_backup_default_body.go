...
// GetVpsServiceNameAutomatedBackupAttachedBackupDefaultBody get vps service name automated backup attached backup default body
// swagger:model getVpsServiceNameAutomatedBackupAttachedBackupDefaultBody
...
func (m *GetVpsServiceNameAutomatedBackupAttachedBackupDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameAutomatedBackupAttachedBackupDefaultBody

...
// PostVpsServiceNameChangeContactDefaultBody post vps service name change contact default body
// swagger:model postVpsServiceNameChangeContactDefaultBody
...
func (m *PostVpsServiceNameChangeContactDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameChangeContactDefaultBody

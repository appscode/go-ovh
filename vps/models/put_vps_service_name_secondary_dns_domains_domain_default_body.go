...
// PutVpsServiceNameSecondaryDNSDomainsDomainDefaultBody put vps service name secondary Dns domains domain default body
// swagger:model putVpsServiceNameSecondaryDnsDomainsDomainDefaultBody
...
func (m *PutVpsServiceNameSecondaryDNSDomainsDomainDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameSecondaryDNSDomainsDomainDefaultBody

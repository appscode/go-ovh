...
// PutVpsServiceNameBackupftpAccessIPBlockDefaultBody put vps service name backupftp access Ip block default body
// swagger:model putVpsServiceNameBackupftpAccessIpBlockDefaultBody
...
func (m *PutVpsServiceNameBackupftpAccessIPBlockDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameBackupftpAccessIPBlockDefaultBody

...
// PostVpsServiceNameChangeContactParamsBody post vps service name change contact params body
// swagger:model postVpsServiceNameChangeContactParamsBody
...
func (m *PostVpsServiceNameChangeContactParamsBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameChangeContactParamsBody

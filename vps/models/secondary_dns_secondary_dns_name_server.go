...
// SecondaryDNSSecondaryDNSNameServer A structure describing informations about available nameserver for secondary dns
// swagger:model secondaryDns.SecondaryDNSNameServer
...
func (m *SecondaryDNSSecondaryDNSNameServer) UnmarshalBinary(b []byte) error {
	var res SecondaryDNSSecondaryDNSNameServer

...
// GetVpsServiceNameBackupftpDefaultBody get vps service name backupftp default body
// swagger:model getVpsServiceNameBackupftpDefaultBody
...
func (m *GetVpsServiceNameBackupftpDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameBackupftpDefaultBody

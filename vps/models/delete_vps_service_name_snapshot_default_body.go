...
// DeleteVpsServiceNameSnapshotDefaultBody delete vps service name snapshot default body
// swagger:model deleteVpsServiceNameSnapshotDefaultBody
...
func (m *DeleteVpsServiceNameSnapshotDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameSnapshotDefaultBody

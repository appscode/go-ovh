...
// PostVpsServiceNameAutomatedBackupRestoreDefaultBody post vps service name automated backup restore default body
// swagger:model postVpsServiceNameAutomatedBackupRestoreDefaultBody
...
func (m *PostVpsServiceNameAutomatedBackupRestoreDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameAutomatedBackupRestoreDefaultBody

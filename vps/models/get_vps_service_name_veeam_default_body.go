...
// GetVpsServiceNameVeeamDefaultBody get vps service name veeam default body
// swagger:model getVpsServiceNameVeeamDefaultBody
...
func (m *GetVpsServiceNameVeeamDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameVeeamDefaultBody

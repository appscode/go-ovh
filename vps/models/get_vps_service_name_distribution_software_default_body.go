...
// GetVpsServiceNameDistributionSoftwareDefaultBody get vps service name distribution software default body
// swagger:model getVpsServiceNameDistributionSoftwareDefaultBody
...
func (m *GetVpsServiceNameDistributionSoftwareDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDistributionSoftwareDefaultBody

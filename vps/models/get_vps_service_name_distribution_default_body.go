...
// GetVpsServiceNameDistributionDefaultBody get vps service name distribution default body
// swagger:model getVpsServiceNameDistributionDefaultBody
...
func (m *GetVpsServiceNameDistributionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDistributionDefaultBody

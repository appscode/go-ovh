...
// PostVpsServiceNameBackupftpPasswordDefaultBody post vps service name backupftp password default body
// swagger:model postVpsServiceNameBackupftpPasswordDefaultBody
...
func (m *PostVpsServiceNameBackupftpPasswordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameBackupftpPasswordDefaultBody

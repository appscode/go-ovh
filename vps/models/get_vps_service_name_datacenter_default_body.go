...
// GetVpsServiceNameDatacenterDefaultBody get vps service name datacenter default body
// swagger:model getVpsServiceNameDatacenterDefaultBody
...
func (m *GetVpsServiceNameDatacenterDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDatacenterDefaultBody

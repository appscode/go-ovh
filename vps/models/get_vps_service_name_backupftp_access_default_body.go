...
// GetVpsServiceNameBackupftpAccessDefaultBody get vps service name backupftp access default body
// swagger:model getVpsServiceNameBackupftpAccessDefaultBody
...
func (m *GetVpsServiceNameBackupftpAccessDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameBackupftpAccessDefaultBody

...
// PostVpsServiceNameStopDefaultBody post vps service name stop default body
// swagger:model postVpsServiceNameStopDefaultBody
...
func (m *PostVpsServiceNameStopDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameStopDefaultBody

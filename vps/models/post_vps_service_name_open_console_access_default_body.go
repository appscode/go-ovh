...
// PostVpsServiceNameOpenConsoleAccessDefaultBody post vps service name open console access default body
// swagger:model postVpsServiceNameOpenConsoleAccessDefaultBody
...
func (m *PostVpsServiceNameOpenConsoleAccessDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameOpenConsoleAccessDefaultBody

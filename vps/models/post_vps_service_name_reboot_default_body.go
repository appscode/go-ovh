...
// PostVpsServiceNameRebootDefaultBody post vps service name reboot default body
// swagger:model postVpsServiceNameRebootDefaultBody
...
func (m *PostVpsServiceNameRebootDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameRebootDefaultBody

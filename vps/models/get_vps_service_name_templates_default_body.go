...
// GetVpsServiceNameTemplatesDefaultBody get vps service name templates default body
// swagger:model getVpsServiceNameTemplatesDefaultBody
...
func (m *GetVpsServiceNameTemplatesDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTemplatesDefaultBody

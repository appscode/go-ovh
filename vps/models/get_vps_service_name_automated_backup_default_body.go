...
// GetVpsServiceNameAutomatedBackupDefaultBody get vps service name automated backup default body
// swagger:model getVpsServiceNameAutomatedBackupDefaultBody
...
func (m *GetVpsServiceNameAutomatedBackupDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameAutomatedBackupDefaultBody

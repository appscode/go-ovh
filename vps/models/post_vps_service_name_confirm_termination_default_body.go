...
// PostVpsServiceNameConfirmTerminationDefaultBody post vps service name confirm termination default body
// swagger:model postVpsServiceNameConfirmTerminationDefaultBody
...
func (m *PostVpsServiceNameConfirmTerminationDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameConfirmTerminationDefaultBody

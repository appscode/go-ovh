...
// GetVpsServiceNameStatusDefaultBody get vps service name status default body
// swagger:model getVpsServiceNameStatusDefaultBody
...
func (m *GetVpsServiceNameStatusDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameStatusDefaultBody

...
// GetVpsServiceNameBackupftpAccessIPBlockDefaultBody get vps service name backupftp access Ip block default body
// swagger:model getVpsServiceNameBackupftpAccessIpBlockDefaultBody
...
func (m *GetVpsServiceNameBackupftpAccessIPBlockDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameBackupftpAccessIPBlockDefaultBody

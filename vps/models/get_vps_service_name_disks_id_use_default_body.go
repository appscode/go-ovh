...
// GetVpsServiceNameDisksIDUseDefaultBody get vps service name disks Id use default body
// swagger:model getVpsServiceNameDisksIdUseDefaultBody
...
func (m *GetVpsServiceNameDisksIDUseDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDisksIDUseDefaultBody

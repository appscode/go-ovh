...
// GetVpsServiceNameDisksIDDefaultBody get vps service name disks Id default body
// swagger:model getVpsServiceNameDisksIdDefaultBody
...
func (m *GetVpsServiceNameDisksIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDisksIDDefaultBody

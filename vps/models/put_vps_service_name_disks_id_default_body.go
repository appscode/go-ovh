...
// PutVpsServiceNameDisksIDDefaultBody put vps service name disks Id default body
// swagger:model putVpsServiceNameDisksIdDefaultBody
...
func (m *PutVpsServiceNameDisksIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameDisksIDDefaultBody

...
// GetVpsServiceNameOptionDefaultBody get vps service name option default body
// swagger:model getVpsServiceNameOptionDefaultBody
...
func (m *GetVpsServiceNameOptionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameOptionDefaultBody

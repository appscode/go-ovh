...
// GetVpsServiceNameVeeamRestoredBackupDefaultBody get vps service name veeam restored backup default body
// swagger:model getVpsServiceNameVeeamRestoredBackupDefaultBody
...
func (m *GetVpsServiceNameVeeamRestoredBackupDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameVeeamRestoredBackupDefaultBody

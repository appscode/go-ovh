...
// PutVpsServiceNameIpsIPAddressDefaultBody put vps service name ips Ip address default body
// swagger:model putVpsServiceNameIpsIpAddressDefaultBody
...
func (m *PutVpsServiceNameIpsIPAddressDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameIpsIPAddressDefaultBody

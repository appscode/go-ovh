...
// GetVpsServiceNameTemplatesIDSoftwareDefaultBody get vps service name templates Id software default body
// swagger:model getVpsServiceNameTemplatesIdSoftwareDefaultBody
...
func (m *GetVpsServiceNameTemplatesIDSoftwareDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTemplatesIDSoftwareDefaultBody

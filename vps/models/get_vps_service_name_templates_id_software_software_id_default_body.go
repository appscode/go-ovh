...
// GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefaultBody get vps service name templates Id software software Id default body
// swagger:model getVpsServiceNameTemplatesIdSoftwareSoftwareIdDefaultBody
...
func (m *GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTemplatesIDSoftwareSoftwareIDDefaultBody

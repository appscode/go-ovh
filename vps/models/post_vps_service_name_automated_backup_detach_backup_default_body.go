...
// PostVpsServiceNameAutomatedBackupDetachBackupDefaultBody post vps service name automated backup detach backup default body
// swagger:model postVpsServiceNameAutomatedBackupDetachBackupDefaultBody
...
func (m *PostVpsServiceNameAutomatedBackupDetachBackupDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameAutomatedBackupDetachBackupDefaultBody

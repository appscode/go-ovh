...
// PostVpsServiceNameReinstallDefaultBody post vps service name reinstall default body
// swagger:model postVpsServiceNameReinstallDefaultBody
...
func (m *PostVpsServiceNameReinstallDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameReinstallDefaultBody

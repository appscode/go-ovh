...
// GetVpsServiceNameBackupftpAuthorizableBlocksDefaultBody get vps service name backupftp authorizable blocks default body
// swagger:model getVpsServiceNameBackupftpAuthorizableBlocksDefaultBody
...
func (m *GetVpsServiceNameBackupftpAuthorizableBlocksDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameBackupftpAuthorizableBlocksDefaultBody

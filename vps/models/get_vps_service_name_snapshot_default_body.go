...
// GetVpsServiceNameSnapshotDefaultBody get vps service name snapshot default body
// swagger:model getVpsServiceNameSnapshotDefaultBody
...
func (m *GetVpsServiceNameSnapshotDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameSnapshotDefaultBody

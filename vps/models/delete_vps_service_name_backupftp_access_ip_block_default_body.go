...
// DeleteVpsServiceNameBackupftpAccessIPBlockDefaultBody delete vps service name backupftp access Ip block default body
// swagger:model deleteVpsServiceNameBackupftpAccessIpBlockDefaultBody
...
func (m *DeleteVpsServiceNameBackupftpAccessIPBlockDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameBackupftpAccessIPBlockDefaultBody

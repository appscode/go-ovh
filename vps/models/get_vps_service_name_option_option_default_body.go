...
// GetVpsServiceNameOptionOptionDefaultBody get vps service name option option default body
// swagger:model getVpsServiceNameOptionOptionDefaultBody
...
func (m *GetVpsServiceNameOptionOptionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameOptionOptionDefaultBody

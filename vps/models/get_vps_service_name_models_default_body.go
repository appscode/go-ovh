...
// GetVpsServiceNameModelsDefaultBody get vps service name models default body
// swagger:model getVpsServiceNameModelsDefaultBody
...
func (m *GetVpsServiceNameModelsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameModelsDefaultBody

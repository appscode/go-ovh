...
// PostVpsServiceNameCreateSnapshotDefaultBody post vps service name create snapshot default body
// swagger:model postVpsServiceNameCreateSnapshotDefaultBody
...
func (m *PostVpsServiceNameCreateSnapshotDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameCreateSnapshotDefaultBody

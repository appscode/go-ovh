...
// DeleteVpsServiceNameIpsIPAddressDefaultBody delete vps service name ips Ip address default body
// swagger:model deleteVpsServiceNameIpsIpAddressDefaultBody
...
func (m *DeleteVpsServiceNameIpsIPAddressDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameIpsIPAddressDefaultBody

...
// PostVpsServiceNameVeeamRestorePointsIDRestoreDefaultBody post vps service name veeam restore points Id restore default body
// swagger:model postVpsServiceNameVeeamRestorePointsIdRestoreDefaultBody
...
func (m *PostVpsServiceNameVeeamRestorePointsIDRestoreDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameVeeamRestorePointsIDRestoreDefaultBody

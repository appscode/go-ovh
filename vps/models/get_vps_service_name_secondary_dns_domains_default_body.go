...
// GetVpsServiceNameSecondaryDNSDomainsDefaultBody get vps service name secondary Dns domains default body
// swagger:model getVpsServiceNameSecondaryDnsDomainsDefaultBody
...
func (m *GetVpsServiceNameSecondaryDNSDomainsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameSecondaryDNSDomainsDefaultBody

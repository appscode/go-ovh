...
// DeleteVpsServiceNameSecondaryDNSDomainsDomainDefaultBody delete vps service name secondary Dns domains domain default body
// swagger:model deleteVpsServiceNameSecondaryDnsDomainsDomainDefaultBody
...
func (m *DeleteVpsServiceNameSecondaryDNSDomainsDomainDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameSecondaryDNSDomainsDomainDefaultBody

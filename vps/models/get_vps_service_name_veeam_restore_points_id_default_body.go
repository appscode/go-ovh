...
// GetVpsServiceNameVeeamRestorePointsIDDefaultBody get vps service name veeam restore points Id default body
// swagger:model getVpsServiceNameVeeamRestorePointsIdDefaultBody
...
func (m *GetVpsServiceNameVeeamRestorePointsIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameVeeamRestorePointsIDDefaultBody

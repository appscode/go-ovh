...
// PostVpsServiceNameSetPasswordDefaultBody post vps service name set password default body
// swagger:model postVpsServiceNameSetPasswordDefaultBody
...
func (m *PostVpsServiceNameSetPasswordDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameSetPasswordDefaultBody

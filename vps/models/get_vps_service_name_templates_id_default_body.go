...
// GetVpsServiceNameTemplatesIDDefaultBody get vps service name templates Id default body
// swagger:model getVpsServiceNameTemplatesIdDefaultBody
...
func (m *GetVpsServiceNameTemplatesIDDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameTemplatesIDDefaultBody

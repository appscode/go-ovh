...
// PostVpsServiceNameTerminateDefaultBody post vps service name terminate default body
// swagger:model postVpsServiceNameTerminateDefaultBody
...
func (m *PostVpsServiceNameTerminateDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameTerminateDefaultBody

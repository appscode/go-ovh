...
// PostVpsServiceNameSnapshotRevertDefaultBody post vps service name snapshot revert default body
// swagger:model postVpsServiceNameSnapshotRevertDefaultBody
...
func (m *PostVpsServiceNameSnapshotRevertDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameSnapshotRevertDefaultBody

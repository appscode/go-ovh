...
// GetVpsServiceNameUseDefaultBody get vps service name use default body
// swagger:model getVpsServiceNameUseDefaultBody
...
func (m *GetVpsServiceNameUseDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameUseDefaultBody

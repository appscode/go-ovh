...
// GetVpsServiceNameSecondaryDNSDomainsDomainDNSServerDefaultBody get vps service name secondary Dns domains domain Dns server default body
// swagger:model getVpsServiceNameSecondaryDnsDomainsDomainDnsServerDefaultBody
...
func (m *GetVpsServiceNameSecondaryDNSDomainsDomainDNSServerDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameSecondaryDNSDomainsDomainDNSServerDefaultBody

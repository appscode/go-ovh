...
// GetVpsServiceNameServiceInfosDefaultBody get vps service name service infos default body
// swagger:model getVpsServiceNameServiceInfosDefaultBody
...
func (m *GetVpsServiceNameServiceInfosDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameServiceInfosDefaultBody

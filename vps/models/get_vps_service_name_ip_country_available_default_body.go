...
// GetVpsServiceNameIPCountryAvailableDefaultBody get vps service name Ip country available default body
// swagger:model getVpsServiceNameIpCountryAvailableDefaultBody
...
func (m *GetVpsServiceNameIPCountryAvailableDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameIPCountryAvailableDefaultBody

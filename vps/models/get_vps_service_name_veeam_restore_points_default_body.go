...
// GetVpsServiceNameVeeamRestorePointsDefaultBody get vps service name veeam restore points default body
// swagger:model getVpsServiceNameVeeamRestorePointsDefaultBody
...
func (m *GetVpsServiceNameVeeamRestorePointsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameVeeamRestorePointsDefaultBody

...
// GetVpsServiceNameMonitoringDefaultBody get vps service name monitoring default body
// swagger:model getVpsServiceNameMonitoringDefaultBody
...
func (m *GetVpsServiceNameMonitoringDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameMonitoringDefaultBody

...
// DeleteVpsServiceNameVeeamRestoredBackupDefaultBody delete vps service name veeam restored backup default body
// swagger:model deleteVpsServiceNameVeeamRestoredBackupDefaultBody
...
func (m *DeleteVpsServiceNameVeeamRestoredBackupDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameVeeamRestoredBackupDefaultBody

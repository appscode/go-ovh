...
// DeleteVpsServiceNameOptionOptionDefaultBody delete vps service name option option default body
// swagger:model deleteVpsServiceNameOptionOptionDefaultBody
...
func (m *DeleteVpsServiceNameOptionOptionDefaultBody) UnmarshalBinary(b []byte) error {
	var res DeleteVpsServiceNameOptionOptionDefaultBody

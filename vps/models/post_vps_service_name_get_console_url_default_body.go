...
// PostVpsServiceNameGetConsoleURLDefaultBody post vps service name get console Url default body
// swagger:model postVpsServiceNameGetConsoleUrlDefaultBody
...
func (m *PostVpsServiceNameGetConsoleURLDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostVpsServiceNameGetConsoleURLDefaultBody

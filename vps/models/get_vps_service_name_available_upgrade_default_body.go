...
// GetVpsServiceNameAvailableUpgradeDefaultBody get vps service name available upgrade default body
// swagger:model getVpsServiceNameAvailableUpgradeDefaultBody
...
func (m *GetVpsServiceNameAvailableUpgradeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameAvailableUpgradeDefaultBody

...
// GetVpsServiceNameAutomatedBackupRestorePointsDefaultBody get vps service name automated backup restore points default body
// swagger:model getVpsServiceNameAutomatedBackupRestorePointsDefaultBody
...
func (m *GetVpsServiceNameAutomatedBackupRestorePointsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameAutomatedBackupRestorePointsDefaultBody

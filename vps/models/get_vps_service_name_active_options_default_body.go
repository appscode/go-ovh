...
// GetVpsServiceNameActiveOptionsDefaultBody get vps service name active options default body
// swagger:model getVpsServiceNameActiveOptionsDefaultBody
...
func (m *GetVpsServiceNameActiveOptionsDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameActiveOptionsDefaultBody

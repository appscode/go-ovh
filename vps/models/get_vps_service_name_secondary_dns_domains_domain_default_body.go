...
// GetVpsServiceNameSecondaryDNSDomainsDomainDefaultBody get vps service name secondary Dns domains domain default body
// swagger:model getVpsServiceNameSecondaryDnsDomainsDomainDefaultBody
...
func (m *GetVpsServiceNameSecondaryDNSDomainsDomainDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameSecondaryDNSDomainsDomainDefaultBody

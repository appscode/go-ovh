...
// PutVpsServiceNameSnapshotDefaultBody put vps service name snapshot default body
// swagger:model putVpsServiceNameSnapshotDefaultBody
...
func (m *PutVpsServiceNameSnapshotDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutVpsServiceNameSnapshotDefaultBody

...
// GetVpsServiceNameDisksDefaultBody get vps service name disks default body
// swagger:model getVpsServiceNameDisksDefaultBody
...
func (m *GetVpsServiceNameDisksDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameDisksDefaultBody

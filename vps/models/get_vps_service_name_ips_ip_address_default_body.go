...
// GetVpsServiceNameIpsIPAddressDefaultBody get vps service name ips Ip address default body
// swagger:model getVpsServiceNameIpsIpAddressDefaultBody
...
func (m *GetVpsServiceNameIpsIPAddressDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetVpsServiceNameIpsIPAddressDefaultBody

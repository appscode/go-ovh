...
func (o *GetCloudProjectServiceNameUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameUserOK()
	...
	default:
		result := NewGetCloudProjectServiceNameUserDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameUserOK() *GetCloudProjectServiceNameUserOK {
	return &GetCloudProjectServiceNameUserOK{}
}
...
func (o *GetCloudProjectServiceNameUserOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user][%d] getCloudProjectServiceNameUserOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameUserOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameUserDefault(code int) *GetCloudProjectServiceNameUserDefault {
	return &GetCloudProjectServiceNameUserDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameUserDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user][%d] GetCloudProjectServiceNameUser default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameUserDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameUserDefaultBody)

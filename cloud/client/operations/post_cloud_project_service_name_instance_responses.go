...
func (o *PostCloudProjectServiceNameInstanceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameInstanceOK()
	...
	default:
		result := NewPostCloudProjectServiceNameInstanceDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameInstanceOK() *PostCloudProjectServiceNameInstanceOK {
	return &PostCloudProjectServiceNameInstanceOK{}
}
...
func (o *PostCloudProjectServiceNameInstanceOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance][%d] postCloudProjectServiceNameInstanceOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameInstanceDefault(code int) *PostCloudProjectServiceNameInstanceDefault {
	return &PostCloudProjectServiceNameInstanceDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameInstanceDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance][%d] PostCloudProjectServiceNameInstance default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameInstanceDefaultBody)

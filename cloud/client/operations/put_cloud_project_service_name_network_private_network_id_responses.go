...
func (o *PutCloudProjectServiceNameNetworkPrivateNetworkIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutCloudProjectServiceNameNetworkPrivateNetworkIDOK()
	...
	default:
		result := NewPutCloudProjectServiceNameNetworkPrivateNetworkIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutCloudProjectServiceNameNetworkPrivateNetworkIDOK() *PutCloudProjectServiceNameNetworkPrivateNetworkIDOK {
	return &PutCloudProjectServiceNameNetworkPrivateNetworkIDOK{}
}
...
func (o *PutCloudProjectServiceNameNetworkPrivateNetworkIDOK) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/network/private/{networkId}][%d] putCloudProjectServiceNameNetworkPrivateNetworkIdOK ", 200)
}

func (o *PutCloudProjectServiceNameNetworkPrivateNetworkIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutCloudProjectServiceNameNetworkPrivateNetworkIDDefault(code int) *PutCloudProjectServiceNameNetworkPrivateNetworkIDDefault {
	return &PutCloudProjectServiceNameNetworkPrivateNetworkIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutCloudProjectServiceNameNetworkPrivateNetworkIDDefault) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/network/private/{networkId}][%d] PutCloudProjectServiceNameNetworkPrivateNetworkID default  %+v", o._statusCode, o.Payload)
}

func (o *PutCloudProjectServiceNameNetworkPrivateNetworkIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutCloudProjectServiceNameNetworkPrivateNetworkIDDefaultBody)

...
// NewPostCloudProjectServiceNameUserParams creates a new PostCloudProjectServiceNameUserParams object
// with the default values initialized.
func NewPostCloudProjectServiceNameUserParams() *PostCloudProjectServiceNameUserParams {
	var ()
	return &PostCloudProjectServiceNameUserParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostCloudProjectServiceNameUserParamsWithTimeout creates a new PostCloudProjectServiceNameUserParams object
...
// NewPostCloudProjectServiceNameUserParamsWithContext creates a new PostCloudProjectServiceNameUserParams object
...
// NewPostCloudProjectServiceNameUserParamsWithHTTPClient creates a new PostCloudProjectServiceNameUserParams object
...
/*PostCloudProjectServiceNameUserParams contains all the parameters to send to the API endpoint
for the post cloud project service name user operation typically these are written to a http.Request
*/
...
func (o *PostCloudProjectServiceNameUserParams) WithCloudProjectUserPost(cloudProjectUserPost *models.PostCloudProjectServiceNameUserParamsBody) *PostCloudProjectServiceNameUserParams {
	o.SetCloudProjectUserPost(cloudProjectUserPost)
	return o
}
...
func (o *PostCloudProjectServiceNameUserParams) SetCloudProjectUserPost(cloudProjectUserPost *models.PostCloudProjectServiceNameUserParamsBody) {
	o.CloudProjectUserPost = cloudProjectUserPost
}
...
func (o *PostCloudProjectServiceNameUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CloudProjectUserPost != nil {
		if err := r.SetBodyParam(o.CloudProjectUserPost); err != nil {
			return err
		}
	}

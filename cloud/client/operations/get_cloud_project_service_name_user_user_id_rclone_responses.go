...
func (o *GetCloudProjectServiceNameUserUserIDRcloneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameUserUserIDRcloneOK()
	...
	default:
		result := NewGetCloudProjectServiceNameUserUserIDRcloneDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameUserUserIDRcloneOK() *GetCloudProjectServiceNameUserUserIDRcloneOK {
	return &GetCloudProjectServiceNameUserUserIDRcloneOK{}
}
...
func (o *GetCloudProjectServiceNameUserUserIDRcloneOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user/{userId}/rclone][%d] getCloudProjectServiceNameUserUserIdRcloneOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameUserUserIDRcloneOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudUserRclone)
...
func NewGetCloudProjectServiceNameUserUserIDRcloneDefault(code int) *GetCloudProjectServiceNameUserUserIDRcloneDefault {
	return &GetCloudProjectServiceNameUserUserIDRcloneDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameUserUserIDRcloneDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user/{userId}/rclone][%d] GetCloudProjectServiceNameUserUserIDRclone default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameUserUserIDRcloneDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameUserUserIDRcloneDefaultBody)

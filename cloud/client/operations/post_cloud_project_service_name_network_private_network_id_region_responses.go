...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK()
	...
	default:
		result := NewPostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK() *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK {
	return &PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK{}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private/{networkId}/region][%d] postCloudProjectServiceNameNetworkPrivateNetworkIdRegionOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault(code int) *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault {
	return &PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private/{networkId}/region][%d] PostCloudProjectServiceNameNetworkPrivateNetworkIDRegion default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameNetworkPrivateNetworkIDRegionDefaultBody)

...
func (o *PutCloudProjectServiceNameServiceInfosReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutCloudProjectServiceNameServiceInfosOK()
	...
	default:
		result := NewPutCloudProjectServiceNameServiceInfosDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutCloudProjectServiceNameServiceInfosOK() *PutCloudProjectServiceNameServiceInfosOK {
	return &PutCloudProjectServiceNameServiceInfosOK{}
}
...
func (o *PutCloudProjectServiceNameServiceInfosOK) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/serviceInfos][%d] putCloudProjectServiceNameServiceInfosOK ", 200)
}

func (o *PutCloudProjectServiceNameServiceInfosOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutCloudProjectServiceNameServiceInfosDefault(code int) *PutCloudProjectServiceNameServiceInfosDefault {
	return &PutCloudProjectServiceNameServiceInfosDefault{
		_statusCode: code,
	}
}
...
func (o *PutCloudProjectServiceNameServiceInfosDefault) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/serviceInfos][%d] PutCloudProjectServiceNameServiceInfos default  %+v", o._statusCode, o.Payload)
}

func (o *PutCloudProjectServiceNameServiceInfosDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutCloudProjectServiceNameServiceInfosDefaultBody)

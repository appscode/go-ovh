...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDValidateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameIPLoadbalancingIDValidateOK()
	...
	default:
		result := NewPostCloudProjectServiceNameIPLoadbalancingIDValidateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameIPLoadbalancingIDValidateOK() *PostCloudProjectServiceNameIPLoadbalancingIDValidateOK {
	return &PostCloudProjectServiceNameIPLoadbalancingIDValidateOK{}
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDValidateOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/ipLoadbalancing/{id}/validate][%d] postCloudProjectServiceNameIpLoadbalancingIdValidateOK ", 200)
}

func (o *PostCloudProjectServiceNameIPLoadbalancingIDValidateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameIPLoadbalancingIDValidateDefault(code int) *PostCloudProjectServiceNameIPLoadbalancingIDValidateDefault {
	return &PostCloudProjectServiceNameIPLoadbalancingIDValidateDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDValidateDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/ipLoadbalancing/{id}/validate][%d] PostCloudProjectServiceNameIPLoadbalancingIDValidate default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameIPLoadbalancingIDValidateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameIPLoadbalancingIDValidateDefaultBody)

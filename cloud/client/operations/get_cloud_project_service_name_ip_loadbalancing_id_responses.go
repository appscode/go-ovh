...
func (o *GetCloudProjectServiceNameIPLoadbalancingIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameIPLoadbalancingIDOK()
	...
	default:
		result := NewGetCloudProjectServiceNameIPLoadbalancingIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameIPLoadbalancingIDOK() *GetCloudProjectServiceNameIPLoadbalancingIDOK {
	return &GetCloudProjectServiceNameIPLoadbalancingIDOK{}
}
...
func (o *GetCloudProjectServiceNameIPLoadbalancingIDOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/ipLoadbalancing/{id}][%d] getCloudProjectServiceNameIpLoadbalancingIdOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameIPLoadbalancingIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameIPLoadbalancingIDDefault(code int) *GetCloudProjectServiceNameIPLoadbalancingIDDefault {
	return &GetCloudProjectServiceNameIPLoadbalancingIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameIPLoadbalancingIDDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/ipLoadbalancing/{id}][%d] GetCloudProjectServiceNameIPLoadbalancingID default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameIPLoadbalancingIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameIPLoadbalancingIDDefaultBody)

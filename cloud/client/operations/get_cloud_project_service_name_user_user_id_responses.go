...
func (o *GetCloudProjectServiceNameUserUserIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameUserUserIDOK()
	...
	default:
		result := NewGetCloudProjectServiceNameUserUserIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameUserUserIDOK() *GetCloudProjectServiceNameUserUserIDOK {
	return &GetCloudProjectServiceNameUserUserIDOK{}
}
...
func (o *GetCloudProjectServiceNameUserUserIDOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user/{userId}][%d] getCloudProjectServiceNameUserUserIdOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameUserUserIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudUserUser)
...
func NewGetCloudProjectServiceNameUserUserIDDefault(code int) *GetCloudProjectServiceNameUserUserIDDefault {
	return &GetCloudProjectServiceNameUserUserIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameUserUserIDDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/user/{userId}][%d] GetCloudProjectServiceNameUserUserID default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameUserUserIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameUserUserIDDefaultBody)

...
func (o *PutCloudProjectServiceNameMigrationMigrationIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutCloudProjectServiceNameMigrationMigrationIDOK()
	...
	default:
		result := NewPutCloudProjectServiceNameMigrationMigrationIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutCloudProjectServiceNameMigrationMigrationIDOK() *PutCloudProjectServiceNameMigrationMigrationIDOK {
	return &PutCloudProjectServiceNameMigrationMigrationIDOK{}
}
...
func (o *PutCloudProjectServiceNameMigrationMigrationIDOK) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/migration/{migrationId}][%d] putCloudProjectServiceNameMigrationMigrationIdOK  %+v", 200, o.Payload)
}

func (o *PutCloudProjectServiceNameMigrationMigrationIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutCloudProjectServiceNameMigrationMigrationIDDefault(code int) *PutCloudProjectServiceNameMigrationMigrationIDDefault {
	return &PutCloudProjectServiceNameMigrationMigrationIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutCloudProjectServiceNameMigrationMigrationIDDefault) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/migration/{migrationId}][%d] PutCloudProjectServiceNameMigrationMigrationID default  %+v", o._statusCode, o.Payload)
}

func (o *PutCloudProjectServiceNameMigrationMigrationIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutCloudProjectServiceNameMigrationMigrationIDDefaultBody)

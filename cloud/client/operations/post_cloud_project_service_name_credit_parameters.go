...
// NewPostCloudProjectServiceNameCreditParams creates a new PostCloudProjectServiceNameCreditParams object
// with the default values initialized.
func NewPostCloudProjectServiceNameCreditParams() *PostCloudProjectServiceNameCreditParams {
	var ()
	return &PostCloudProjectServiceNameCreditParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostCloudProjectServiceNameCreditParamsWithTimeout creates a new PostCloudProjectServiceNameCreditParams object
...
// NewPostCloudProjectServiceNameCreditParamsWithContext creates a new PostCloudProjectServiceNameCreditParams object
...
// NewPostCloudProjectServiceNameCreditParamsWithHTTPClient creates a new PostCloudProjectServiceNameCreditParams object
...
/*PostCloudProjectServiceNameCreditParams contains all the parameters to send to the API endpoint
for the post cloud project service name credit operation typically these are written to a http.Request
*/
...
func (o *PostCloudProjectServiceNameCreditParams) WithCloudProjectCreditPost(cloudProjectCreditPost *models.PostCloudProjectServiceNameCreditParamsBody) *PostCloudProjectServiceNameCreditParams {
	o.SetCloudProjectCreditPost(cloudProjectCreditPost)
	return o
}
...
func (o *PostCloudProjectServiceNameCreditParams) SetCloudProjectCreditPost(cloudProjectCreditPost *models.PostCloudProjectServiceNameCreditParamsBody) {
	o.CloudProjectCreditPost = cloudProjectCreditPost
}
...
func (o *PostCloudProjectServiceNameCreditParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CloudProjectCreditPost != nil {
		if err := r.SetBodyParam(o.CloudProjectCreditPost); err != nil {
			return err
		}
	}

...
func (o *PostCloudProjectServiceNameNetworkPrivateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameNetworkPrivateOK()
	...
	default:
		result := NewPostCloudProjectServiceNameNetworkPrivateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameNetworkPrivateOK() *PostCloudProjectServiceNameNetworkPrivateOK {
	return &PostCloudProjectServiceNameNetworkPrivateOK{}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private][%d] postCloudProjectServiceNameNetworkPrivateOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameNetworkPrivateDefault(code int) *PostCloudProjectServiceNameNetworkPrivateDefault {
	return &PostCloudProjectServiceNameNetworkPrivateDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private][%d] PostCloudProjectServiceNameNetworkPrivate default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameNetworkPrivateDefaultBody)

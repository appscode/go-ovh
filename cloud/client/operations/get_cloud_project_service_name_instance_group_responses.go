...
func (o *GetCloudProjectServiceNameInstanceGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameInstanceGroupOK()
	...
	default:
		result := NewGetCloudProjectServiceNameInstanceGroupDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameInstanceGroupOK() *GetCloudProjectServiceNameInstanceGroupOK {
	return &GetCloudProjectServiceNameInstanceGroupOK{}
}
...
func (o *GetCloudProjectServiceNameInstanceGroupOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance/group][%d] getCloudProjectServiceNameInstanceGroupOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceGroupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameInstanceGroupDefault(code int) *GetCloudProjectServiceNameInstanceGroupDefault {
	return &GetCloudProjectServiceNameInstanceGroupDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameInstanceGroupDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance/group][%d] GetCloudProjectServiceNameInstanceGroup default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceGroupDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameInstanceGroupDefaultBody)

...
func (o *GetCloudServiceNamePcaPcaServiceNameBillingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudServiceNamePcaPcaServiceNameBillingOK()
	...
	default:
		result := NewGetCloudServiceNamePcaPcaServiceNameBillingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudServiceNamePcaPcaServiceNameBillingOK() *GetCloudServiceNamePcaPcaServiceNameBillingOK {
	return &GetCloudServiceNamePcaPcaServiceNameBillingOK{}
}
...
func (o *GetCloudServiceNamePcaPcaServiceNameBillingOK) Error() string {
	return fmt.Sprintf("[GET /cloud/{serviceName}/pca/{pcaServiceName}/billing][%d] getCloudServiceNamePcaPcaServiceNameBillingOK  %+v", 200, o.Payload)
}

func (o *GetCloudServiceNamePcaPcaServiceNameBillingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudServiceNamePcaPcaServiceNameBillingDefault(code int) *GetCloudServiceNamePcaPcaServiceNameBillingDefault {
	return &GetCloudServiceNamePcaPcaServiceNameBillingDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudServiceNamePcaPcaServiceNameBillingDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/{serviceName}/pca/{pcaServiceName}/billing][%d] GetCloudServiceNamePcaPcaServiceNameBilling default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudServiceNamePcaPcaServiceNameBillingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudServiceNamePcaPcaServiceNameBillingDefaultBody)

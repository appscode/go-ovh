...
func (o *DeleteCloudProjectServiceNameSshkeyKeyIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCloudProjectServiceNameSshkeyKeyIDOK()
	...
	default:
		result := NewDeleteCloudProjectServiceNameSshkeyKeyIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteCloudProjectServiceNameSshkeyKeyIDOK() *DeleteCloudProjectServiceNameSshkeyKeyIDOK {
	return &DeleteCloudProjectServiceNameSshkeyKeyIDOK{}
}
...
func (o *DeleteCloudProjectServiceNameSshkeyKeyIDOK) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/sshkey/{keyId}][%d] deleteCloudProjectServiceNameSshkeyKeyIdOK ", 200)
}

func (o *DeleteCloudProjectServiceNameSshkeyKeyIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteCloudProjectServiceNameSshkeyKeyIDDefault(code int) *DeleteCloudProjectServiceNameSshkeyKeyIDDefault {
	return &DeleteCloudProjectServiceNameSshkeyKeyIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteCloudProjectServiceNameSshkeyKeyIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/sshkey/{keyId}][%d] DeleteCloudProjectServiceNameSshkeyKeyID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteCloudProjectServiceNameSshkeyKeyIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteCloudProjectServiceNameSshkeyKeyIDDefaultBody)

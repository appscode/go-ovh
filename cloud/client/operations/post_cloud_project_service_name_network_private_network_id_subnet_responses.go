...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK()
	...
	default:
		result := NewPostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK() *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK {
	return &PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK{}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private/{networkId}/subnet][%d] postCloudProjectServiceNameNetworkPrivateNetworkIdSubnetOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudNetworkSubnet)
...
func NewPostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault(code int) *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault {
	return &PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/network/private/{networkId}/subnet][%d] PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnet default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefaultBody)

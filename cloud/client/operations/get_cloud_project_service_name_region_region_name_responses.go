...
func (o *GetCloudProjectServiceNameRegionRegionNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameRegionRegionNameOK()
	...
	default:
		result := NewGetCloudProjectServiceNameRegionRegionNameDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameRegionRegionNameOK() *GetCloudProjectServiceNameRegionRegionNameOK {
	return &GetCloudProjectServiceNameRegionRegionNameOK{}
}
...
func (o *GetCloudProjectServiceNameRegionRegionNameOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/region/{regionName}][%d] getCloudProjectServiceNameRegionRegionNameOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameRegionRegionNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudRegionRegionDetail)
...
func NewGetCloudProjectServiceNameRegionRegionNameDefault(code int) *GetCloudProjectServiceNameRegionRegionNameDefault {
	return &GetCloudProjectServiceNameRegionRegionNameDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameRegionRegionNameDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/region/{regionName}][%d] GetCloudProjectServiceNameRegionRegionName default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameRegionRegionNameDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameRegionRegionNameDefaultBody)

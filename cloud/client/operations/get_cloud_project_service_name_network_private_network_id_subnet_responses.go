...
func (o *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK()
	...
	default:
		result := NewGetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK() *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK {
	return &GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK{}
}
...
func (o *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/network/private/{networkId}/subnet][%d] getCloudProjectServiceNameNetworkPrivateNetworkIdSubnetOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault(code int) *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault {
	return &GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/network/private/{networkId}/subnet][%d] GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnet default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameNetworkPrivateNetworkIDSubnetDefaultBody)

...
func (o *PostCloudProjectServiceNameAlertingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameAlertingOK()
	...
	default:
		result := NewPostCloudProjectServiceNameAlertingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameAlertingOK() *PostCloudProjectServiceNameAlertingOK {
	return &PostCloudProjectServiceNameAlertingOK{}
}
...
func (o *PostCloudProjectServiceNameAlertingOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/alerting][%d] postCloudProjectServiceNameAlertingOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameAlertingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameAlertingDefault(code int) *PostCloudProjectServiceNameAlertingDefault {
	return &PostCloudProjectServiceNameAlertingDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameAlertingDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/alerting][%d] PostCloudProjectServiceNameAlerting default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameAlertingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameAlertingDefaultBody)

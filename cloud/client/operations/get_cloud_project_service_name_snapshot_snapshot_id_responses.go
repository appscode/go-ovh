...
func (o *GetCloudProjectServiceNameSnapshotSnapshotIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameSnapshotSnapshotIDOK()
	...
	default:
		result := NewGetCloudProjectServiceNameSnapshotSnapshotIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameSnapshotSnapshotIDOK() *GetCloudProjectServiceNameSnapshotSnapshotIDOK {
	return &GetCloudProjectServiceNameSnapshotSnapshotIDOK{}
}
...
func (o *GetCloudProjectServiceNameSnapshotSnapshotIDOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/snapshot/{snapshotId}][%d] getCloudProjectServiceNameSnapshotSnapshotIdOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameSnapshotSnapshotIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameSnapshotSnapshotIDDefault(code int) *GetCloudProjectServiceNameSnapshotSnapshotIDDefault {
	return &GetCloudProjectServiceNameSnapshotSnapshotIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameSnapshotSnapshotIDDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/snapshot/{snapshotId}][%d] GetCloudProjectServiceNameSnapshotSnapshotID default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameSnapshotSnapshotIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameSnapshotSnapshotIDDefaultBody)

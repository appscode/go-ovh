...
func (o *GetCloudProjectServiceNameInstanceInstanceIDInterfaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameInstanceInstanceIDInterfaceOK()
	...
	default:
		result := NewGetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameInstanceInstanceIDInterfaceOK() *GetCloudProjectServiceNameInstanceInstanceIDInterfaceOK {
	return &GetCloudProjectServiceNameInstanceInstanceIDInterfaceOK{}
}
...
func (o *GetCloudProjectServiceNameInstanceInstanceIDInterfaceOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance/{instanceId}/interface][%d] getCloudProjectServiceNameInstanceInstanceIdInterfaceOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceInstanceIDInterfaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault(code int) *GetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault {
	return &GetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance/{instanceId}/interface][%d] GetCloudProjectServiceNameInstanceInstanceIDInterface default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceInstanceIDInterfaceDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameInstanceInstanceIDInterfaceDefaultBody)

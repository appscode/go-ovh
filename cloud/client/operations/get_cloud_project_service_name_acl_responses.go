...
func (o *GetCloudProjectServiceNameACLReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameACLOK()
	...
	default:
		result := NewGetCloudProjectServiceNameACLDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameACLOK() *GetCloudProjectServiceNameACLOK {
	return &GetCloudProjectServiceNameACLOK{}
}
...
func (o *GetCloudProjectServiceNameACLOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/acl][%d] getCloudProjectServiceNameAclOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameACLOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameACLDefault(code int) *GetCloudProjectServiceNameACLDefault {
	return &GetCloudProjectServiceNameACLDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameACLDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/acl][%d] GetCloudProjectServiceNameACL default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameACLDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameACLDefaultBody)

...
func (o *GetCloudProjectServiceNameQuotaReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameQuotaOK()
	...
	default:
		result := NewGetCloudProjectServiceNameQuotaDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameQuotaOK() *GetCloudProjectServiceNameQuotaOK {
	return &GetCloudProjectServiceNameQuotaOK{}
}
...
func (o *GetCloudProjectServiceNameQuotaOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/quota][%d] getCloudProjectServiceNameQuotaOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameQuotaOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameQuotaDefault(code int) *GetCloudProjectServiceNameQuotaDefault {
	return &GetCloudProjectServiceNameQuotaDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameQuotaDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/quota][%d] GetCloudProjectServiceNameQuota default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameQuotaDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameQuotaDefaultBody)

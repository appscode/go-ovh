...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameIPLoadbalancingIDRenewOK()
	...
	default:
		result := NewPostCloudProjectServiceNameIPLoadbalancingIDRenewDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameIPLoadbalancingIDRenewOK() *PostCloudProjectServiceNameIPLoadbalancingIDRenewOK {
	return &PostCloudProjectServiceNameIPLoadbalancingIDRenewOK{}
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/ipLoadbalancing/{id}/renew][%d] postCloudProjectServiceNameIpLoadbalancingIdRenewOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameIPLoadbalancingIDRenewDefault(code int) *PostCloudProjectServiceNameIPLoadbalancingIDRenewDefault {
	return &PostCloudProjectServiceNameIPLoadbalancingIDRenewDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/ipLoadbalancing/{id}/renew][%d] PostCloudProjectServiceNameIPLoadbalancingIDRenew default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameIPLoadbalancingIDRenewDefaultBody)

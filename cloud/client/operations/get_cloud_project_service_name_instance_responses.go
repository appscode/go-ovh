...
func (o *GetCloudProjectServiceNameInstanceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameInstanceOK()
	...
	default:
		result := NewGetCloudProjectServiceNameInstanceDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameInstanceOK() *GetCloudProjectServiceNameInstanceOK {
	return &GetCloudProjectServiceNameInstanceOK{}
}
...
func (o *GetCloudProjectServiceNameInstanceOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance][%d] getCloudProjectServiceNameInstanceOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameInstanceDefault(code int) *GetCloudProjectServiceNameInstanceDefault {
	return &GetCloudProjectServiceNameInstanceDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameInstanceDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/instance][%d] GetCloudProjectServiceNameInstance default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameInstanceDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameInstanceDefaultBody)

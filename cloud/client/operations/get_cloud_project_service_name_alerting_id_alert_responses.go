...
func (o *GetCloudProjectServiceNameAlertingIDAlertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameAlertingIDAlertOK()
	...
	default:
		result := NewGetCloudProjectServiceNameAlertingIDAlertDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameAlertingIDAlertOK() *GetCloudProjectServiceNameAlertingIDAlertOK {
	return &GetCloudProjectServiceNameAlertingIDAlertOK{}
}
...
func (o *GetCloudProjectServiceNameAlertingIDAlertOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/alerting/{id}/alert][%d] getCloudProjectServiceNameAlertingIdAlertOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameAlertingIDAlertOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameAlertingIDAlertDefault(code int) *GetCloudProjectServiceNameAlertingIDAlertDefault {
	return &GetCloudProjectServiceNameAlertingIDAlertDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameAlertingIDAlertDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/alerting/{id}/alert][%d] GetCloudProjectServiceNameAlertingIDAlert default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameAlertingIDAlertDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameAlertingIDAlertDefaultBody)

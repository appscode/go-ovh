...
func (o *DeleteCloudProjectServiceNameStorageContainerIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCloudProjectServiceNameStorageContainerIDOK()
	...
	default:
		result := NewDeleteCloudProjectServiceNameStorageContainerIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteCloudProjectServiceNameStorageContainerIDOK() *DeleteCloudProjectServiceNameStorageContainerIDOK {
	return &DeleteCloudProjectServiceNameStorageContainerIDOK{}
}
...
func (o *DeleteCloudProjectServiceNameStorageContainerIDOK) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/storage/{containerId}][%d] deleteCloudProjectServiceNameStorageContainerIdOK ", 200)
}

func (o *DeleteCloudProjectServiceNameStorageContainerIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteCloudProjectServiceNameStorageContainerIDDefault(code int) *DeleteCloudProjectServiceNameStorageContainerIDDefault {
	return &DeleteCloudProjectServiceNameStorageContainerIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteCloudProjectServiceNameStorageContainerIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/storage/{containerId}][%d] DeleteCloudProjectServiceNameStorageContainerID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteCloudProjectServiceNameStorageContainerIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteCloudProjectServiceNameStorageContainerIDDefaultBody)

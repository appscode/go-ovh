...
func (o *PostCloudProjectServiceNameInstanceInstanceIDInterfaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameInstanceInstanceIDInterfaceOK()
	...
	default:
		result := NewPostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameInstanceInstanceIDInterfaceOK() *PostCloudProjectServiceNameInstanceInstanceIDInterfaceOK {
	return &PostCloudProjectServiceNameInstanceInstanceIDInterfaceOK{}
}
...
func (o *PostCloudProjectServiceNameInstanceInstanceIDInterfaceOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance/{instanceId}/interface][%d] postCloudProjectServiceNameInstanceInstanceIdInterfaceOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceInstanceIDInterfaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault(code int) *PostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault {
	return &PostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance/{instanceId}/interface][%d] PostCloudProjectServiceNameInstanceInstanceIDInterface default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceInstanceIDInterfaceDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameInstanceInstanceIDInterfaceDefaultBody)

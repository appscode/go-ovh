...
func (o *GetCloudProjectServiceNameMigrationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameMigrationOK()
	...
	default:
		result := NewGetCloudProjectServiceNameMigrationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameMigrationOK() *GetCloudProjectServiceNameMigrationOK {
	return &GetCloudProjectServiceNameMigrationOK{}
}
...
func (o *GetCloudProjectServiceNameMigrationOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/migration][%d] getCloudProjectServiceNameMigrationOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameMigrationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameMigrationDefault(code int) *GetCloudProjectServiceNameMigrationDefault {
	return &GetCloudProjectServiceNameMigrationDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameMigrationDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/migration][%d] GetCloudProjectServiceNameMigration default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameMigrationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameMigrationDefaultBody)

...
func (o *GetCloudProjectServiceNameSnapshotReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameSnapshotOK()
	...
	default:
		result := NewGetCloudProjectServiceNameSnapshotDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameSnapshotOK() *GetCloudProjectServiceNameSnapshotOK {
	return &GetCloudProjectServiceNameSnapshotOK{}
}
...
func (o *GetCloudProjectServiceNameSnapshotOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/snapshot][%d] getCloudProjectServiceNameSnapshotOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameSnapshotOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameSnapshotDefault(code int) *GetCloudProjectServiceNameSnapshotDefault {
	return &GetCloudProjectServiceNameSnapshotDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameSnapshotDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/snapshot][%d] GetCloudProjectServiceNameSnapshot default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameSnapshotDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameSnapshotDefaultBody)

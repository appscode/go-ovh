...
func (o *GetCloudProjectServiceNameAlertingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameAlertingOK()
	...
	default:
		result := NewGetCloudProjectServiceNameAlertingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameAlertingOK() *GetCloudProjectServiceNameAlertingOK {
	return &GetCloudProjectServiceNameAlertingOK{}
}
...
func (o *GetCloudProjectServiceNameAlertingOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/alerting][%d] getCloudProjectServiceNameAlertingOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameAlertingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameAlertingDefault(code int) *GetCloudProjectServiceNameAlertingDefault {
	return &GetCloudProjectServiceNameAlertingDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameAlertingDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/alerting][%d] GetCloudProjectServiceNameAlerting default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameAlertingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameAlertingDefaultBody)

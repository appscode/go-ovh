...
func (o *GetCloudProjectServiceNameBillReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameBillOK()
	...
	default:
		result := NewGetCloudProjectServiceNameBillDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameBillOK() *GetCloudProjectServiceNameBillOK {
	return &GetCloudProjectServiceNameBillOK{}
}
...
func (o *GetCloudProjectServiceNameBillOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/bill][%d] getCloudProjectServiceNameBillOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameBillOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameBillDefault(code int) *GetCloudProjectServiceNameBillDefault {
	return &GetCloudProjectServiceNameBillDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameBillDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/bill][%d] GetCloudProjectServiceNameBill default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameBillDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameBillDefaultBody)

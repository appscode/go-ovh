...
func (o *PostCloudProjectServiceNameCreditReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameCreditOK()
	...
	default:
		result := NewPostCloudProjectServiceNameCreditDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameCreditOK() *PostCloudProjectServiceNameCreditOK {
	return &PostCloudProjectServiceNameCreditOK{}
}
...
func (o *PostCloudProjectServiceNameCreditOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/credit][%d] postCloudProjectServiceNameCreditOK ", 200)
}

func (o *PostCloudProjectServiceNameCreditOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostCloudProjectServiceNameCreditDefault(code int) *PostCloudProjectServiceNameCreditDefault {
	return &PostCloudProjectServiceNameCreditDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameCreditDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/credit][%d] PostCloudProjectServiceNameCredit default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameCreditDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameCreditDefaultBody)

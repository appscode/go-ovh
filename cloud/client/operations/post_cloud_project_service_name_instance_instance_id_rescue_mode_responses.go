...
func (o *PostCloudProjectServiceNameInstanceInstanceIDRescueModeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostCloudProjectServiceNameInstanceInstanceIDRescueModeOK()
	...
	default:
		result := NewPostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPostCloudProjectServiceNameInstanceInstanceIDRescueModeOK() *PostCloudProjectServiceNameInstanceInstanceIDRescueModeOK {
	return &PostCloudProjectServiceNameInstanceInstanceIDRescueModeOK{}
}
...
func (o *PostCloudProjectServiceNameInstanceInstanceIDRescueModeOK) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance/{instanceId}/rescueMode][%d] postCloudProjectServiceNameInstanceInstanceIdRescueModeOK  %+v", 200, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceInstanceIDRescueModeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudInstanceRescueAdminPassword)
...
func NewPostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault(code int) *PostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault {
	return &PostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault{
		_statusCode: code,
	}
}
...
func (o *PostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault) Error() string {
	return fmt.Sprintf("[POST /cloud/project/{serviceName}/instance/{instanceId}/rescueMode][%d] PostCloudProjectServiceNameInstanceInstanceIDRescueMode default  %+v", o._statusCode, o.Payload)
}

func (o *PostCloudProjectServiceNameInstanceInstanceIDRescueModeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostCloudProjectServiceNameInstanceInstanceIDRescueModeDefaultBody)

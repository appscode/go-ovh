...
// NewPostCloudProjectServiceNameIPFailoverIDAttachParams creates a new PostCloudProjectServiceNameIPFailoverIDAttachParams object
// with the default values initialized.
func NewPostCloudProjectServiceNameIPFailoverIDAttachParams() *PostCloudProjectServiceNameIPFailoverIDAttachParams {
	var ()
	return &PostCloudProjectServiceNameIPFailoverIDAttachParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostCloudProjectServiceNameIPFailoverIDAttachParamsWithTimeout creates a new PostCloudProjectServiceNameIPFailoverIDAttachParams object
...
// NewPostCloudProjectServiceNameIPFailoverIDAttachParamsWithContext creates a new PostCloudProjectServiceNameIPFailoverIDAttachParams object
...
// NewPostCloudProjectServiceNameIPFailoverIDAttachParamsWithHTTPClient creates a new PostCloudProjectServiceNameIPFailoverIDAttachParams object
...
/*PostCloudProjectServiceNameIPFailoverIDAttachParams contains all the parameters to send to the API endpoint
for the post cloud project service name IP failover ID attach operation typically these are written to a http.Request
*/
...
func (o *PostCloudProjectServiceNameIPFailoverIDAttachParams) WithCloudProjectIPFailoverAttachPost(cloudProjectIPFailoverAttachPost *models.PostCloudProjectServiceNameIPFailoverIDAttachParamsBody) *PostCloudProjectServiceNameIPFailoverIDAttachParams {
	o.SetCloudProjectIPFailoverAttachPost(cloudProjectIPFailoverAttachPost)
	return o
}
...
func (o *PostCloudProjectServiceNameIPFailoverIDAttachParams) SetCloudProjectIPFailoverAttachPost(cloudProjectIPFailoverAttachPost *models.PostCloudProjectServiceNameIPFailoverIDAttachParamsBody) {
	o.CloudProjectIPFailoverAttachPost = cloudProjectIPFailoverAttachPost
}
...
func (o *PostCloudProjectServiceNameIPFailoverIDAttachParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CloudProjectIPFailoverAttachPost != nil {
		if err := r.SetBodyParam(o.CloudProjectIPFailoverAttachPost); err != nil {
			return err
		}
	}

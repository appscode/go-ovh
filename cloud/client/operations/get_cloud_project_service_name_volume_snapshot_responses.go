...
func (o *GetCloudProjectServiceNameVolumeSnapshotReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameVolumeSnapshotOK()
	...
	default:
		result := NewGetCloudProjectServiceNameVolumeSnapshotDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameVolumeSnapshotOK() *GetCloudProjectServiceNameVolumeSnapshotOK {
	return &GetCloudProjectServiceNameVolumeSnapshotOK{}
}
...
func (o *GetCloudProjectServiceNameVolumeSnapshotOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/volume/snapshot][%d] getCloudProjectServiceNameVolumeSnapshotOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameVolumeSnapshotOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameVolumeSnapshotDefault(code int) *GetCloudProjectServiceNameVolumeSnapshotDefault {
	return &GetCloudProjectServiceNameVolumeSnapshotDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameVolumeSnapshotDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/volume/snapshot][%d] GetCloudProjectServiceNameVolumeSnapshot default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameVolumeSnapshotDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameVolumeSnapshotDefaultBody)

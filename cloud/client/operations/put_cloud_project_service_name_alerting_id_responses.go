...
func (o *PutCloudProjectServiceNameAlertingIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutCloudProjectServiceNameAlertingIDOK()
	...
	default:
		result := NewPutCloudProjectServiceNameAlertingIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPutCloudProjectServiceNameAlertingIDOK() *PutCloudProjectServiceNameAlertingIDOK {
	return &PutCloudProjectServiceNameAlertingIDOK{}
}
...
func (o *PutCloudProjectServiceNameAlertingIDOK) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/alerting/{id}][%d] putCloudProjectServiceNameAlertingIdOK ", 200)
}

func (o *PutCloudProjectServiceNameAlertingIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutCloudProjectServiceNameAlertingIDDefault(code int) *PutCloudProjectServiceNameAlertingIDDefault {
	return &PutCloudProjectServiceNameAlertingIDDefault{
		_statusCode: code,
	}
}
...
func (o *PutCloudProjectServiceNameAlertingIDDefault) Error() string {
	return fmt.Sprintf("[PUT /cloud/project/{serviceName}/alerting/{id}][%d] PutCloudProjectServiceNameAlertingID default  %+v", o._statusCode, o.Payload)
}

func (o *PutCloudProjectServiceNameAlertingIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PutCloudProjectServiceNameAlertingIDDefaultBody)

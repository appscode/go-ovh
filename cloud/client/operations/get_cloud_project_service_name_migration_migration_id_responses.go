...
func (o *GetCloudProjectServiceNameMigrationMigrationIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameMigrationMigrationIDOK()
	...
	default:
		result := NewGetCloudProjectServiceNameMigrationMigrationIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameMigrationMigrationIDOK() *GetCloudProjectServiceNameMigrationMigrationIDOK {
	return &GetCloudProjectServiceNameMigrationMigrationIDOK{}
}
...
func (o *GetCloudProjectServiceNameMigrationMigrationIDOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/migration/{migrationId}][%d] getCloudProjectServiceNameMigrationMigrationIdOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameMigrationMigrationIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CloudMigrationMigration)
...
func NewGetCloudProjectServiceNameMigrationMigrationIDDefault(code int) *GetCloudProjectServiceNameMigrationMigrationIDDefault {
	return &GetCloudProjectServiceNameMigrationMigrationIDDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameMigrationMigrationIDDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/migration/{migrationId}][%d] GetCloudProjectServiceNameMigrationMigrationID default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameMigrationMigrationIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameMigrationMigrationIDDefaultBody)

...
// NewDeleteCloudProjectServiceNameSnapshotSnapshotIDParams creates a new DeleteCloudProjectServiceNameSnapshotSnapshotIDParams object
...
func NewDeleteCloudProjectServiceNameSnapshotSnapshotIDParams() *DeleteCloudProjectServiceNameSnapshotSnapshotIDParams {
	var ()
	return &DeleteCloudProjectServiceNameSnapshotSnapshotIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteCloudProjectServiceNameSnapshotSnapshotIDParamsWithTimeout creates a new DeleteCloudProjectServiceNameSnapshotSnapshotIDParams object
...
// NewDeleteCloudProjectServiceNameSnapshotSnapshotIDParamsWithContext creates a new DeleteCloudProjectServiceNameSnapshotSnapshotIDParams object
...
// NewDeleteCloudProjectServiceNameSnapshotSnapshotIDParamsWithHTTPClient creates a new DeleteCloudProjectServiceNameSnapshotSnapshotIDParams object
...
/*DeleteCloudProjectServiceNameSnapshotSnapshotIDParams contains all the parameters to send to the API endpoint
for the delete cloud project service name snapshot snapshot ID operation typically these are written to a http.Request
*/

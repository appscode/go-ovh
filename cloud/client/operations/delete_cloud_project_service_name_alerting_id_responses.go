...
func (o *DeleteCloudProjectServiceNameAlertingIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCloudProjectServiceNameAlertingIDOK()
	...
	default:
		result := NewDeleteCloudProjectServiceNameAlertingIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteCloudProjectServiceNameAlertingIDOK() *DeleteCloudProjectServiceNameAlertingIDOK {
	return &DeleteCloudProjectServiceNameAlertingIDOK{}
}
...
func (o *DeleteCloudProjectServiceNameAlertingIDOK) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/alerting/{id}][%d] deleteCloudProjectServiceNameAlertingIdOK ", 200)
}

func (o *DeleteCloudProjectServiceNameAlertingIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteCloudProjectServiceNameAlertingIDDefault(code int) *DeleteCloudProjectServiceNameAlertingIDDefault {
	return &DeleteCloudProjectServiceNameAlertingIDDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteCloudProjectServiceNameAlertingIDDefault) Error() string {
	return fmt.Sprintf("[DELETE /cloud/project/{serviceName}/alerting/{id}][%d] DeleteCloudProjectServiceNameAlertingID default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteCloudProjectServiceNameAlertingIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteCloudProjectServiceNameAlertingIDDefaultBody)

...
func (o *GetCloudProjectServiceNameFlavorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudProjectServiceNameFlavorOK()
	...
	default:
		result := NewGetCloudProjectServiceNameFlavorDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCloudProjectServiceNameFlavorOK() *GetCloudProjectServiceNameFlavorOK {
	return &GetCloudProjectServiceNameFlavorOK{}
}
...
func (o *GetCloudProjectServiceNameFlavorOK) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/flavor][%d] getCloudProjectServiceNameFlavorOK  %+v", 200, o.Payload)
}

func (o *GetCloudProjectServiceNameFlavorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCloudProjectServiceNameFlavorDefault(code int) *GetCloudProjectServiceNameFlavorDefault {
	return &GetCloudProjectServiceNameFlavorDefault{
		_statusCode: code,
	}
}
...
func (o *GetCloudProjectServiceNameFlavorDefault) Error() string {
	return fmt.Sprintf("[GET /cloud/project/{serviceName}/flavor][%d] GetCloudProjectServiceNameFlavor default  %+v", o._statusCode, o.Payload)
}

func (o *GetCloudProjectServiceNameFlavorDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetCloudProjectServiceNameFlavorDefaultBody)

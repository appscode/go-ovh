...
// NewPostCloudProjectServiceNameIPLoadbalancingIDRenewParams creates a new PostCloudProjectServiceNameIPLoadbalancingIDRenewParams object
...
func NewPostCloudProjectServiceNameIPLoadbalancingIDRenewParams() *PostCloudProjectServiceNameIPLoadbalancingIDRenewParams {
	var ()
	return &PostCloudProjectServiceNameIPLoadbalancingIDRenewParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostCloudProjectServiceNameIPLoadbalancingIDRenewParamsWithTimeout creates a new PostCloudProjectServiceNameIPLoadbalancingIDRenewParams object
...
// NewPostCloudProjectServiceNameIPLoadbalancingIDRenewParamsWithContext creates a new PostCloudProjectServiceNameIPLoadbalancingIDRenewParams object
...
// NewPostCloudProjectServiceNameIPLoadbalancingIDRenewParamsWithHTTPClient creates a new PostCloudProjectServiceNameIPLoadbalancingIDRenewParams object
...
/*PostCloudProjectServiceNameIPLoadbalancingIDRenewParams contains all the parameters to send to the API endpoint
for the post cloud project service name IP loadbalancing ID renew operation typically these are written to a http.Request
*/
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewParams) WithCloudProjectIPLBRenewPost(cloudProjectIPLBRenewPost *models.PostCloudProjectServiceNameIPLoadbalancingIDRenewParamsBody) *PostCloudProjectServiceNameIPLoadbalancingIDRenewParams {
	o.SetCloudProjectIPLBRenewPost(cloudProjectIPLBRenewPost)
	return o
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewParams) SetCloudProjectIPLBRenewPost(cloudProjectIPLBRenewPost *models.PostCloudProjectServiceNameIPLoadbalancingIDRenewParamsBody) {
	o.CloudProjectIPLBRenewPost = cloudProjectIPLBRenewPost
}
...
func (o *PostCloudProjectServiceNameIPLoadbalancingIDRenewParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CloudProjectIPLBRenewPost != nil {
		if err := r.SetBodyParam(o.CloudProjectIPLBRenewPost); err != nil {
			return err
		}
	}

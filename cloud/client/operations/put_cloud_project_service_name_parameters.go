...
// NewPutCloudProjectServiceNameParams creates a new PutCloudProjectServiceNameParams object
// with the default values initialized.
func NewPutCloudProjectServiceNameParams() *PutCloudProjectServiceNameParams {
	var ()
	return &PutCloudProjectServiceNameParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutCloudProjectServiceNameParamsWithTimeout creates a new PutCloudProjectServiceNameParams object
...
// NewPutCloudProjectServiceNameParamsWithContext creates a new PutCloudProjectServiceNameParams object
...
// NewPutCloudProjectServiceNameParamsWithHTTPClient creates a new PutCloudProjectServiceNameParams object
...
/*PutCloudProjectServiceNameParams contains all the parameters to send to the API endpoint
for the put cloud project service name operation typically these are written to a http.Request
*/
...
func (o *PutCloudProjectServiceNameParams) WithCloudProjectPut(cloudProjectPut *models.CloudProject) *PutCloudProjectServiceNameParams {
	o.SetCloudProjectPut(cloudProjectPut)
	return o
}
...
func (o *PutCloudProjectServiceNameParams) SetCloudProjectPut(cloudProjectPut *models.CloudProject) {
	o.CloudProjectPut = cloudProjectPut
}
...
func (o *PutCloudProjectServiceNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CloudProjectPut != nil {
		if err := r.SetBodyParam(o.CloudProjectPut); err != nil {
			return err
		}
	}

...
// swagger:model cloud.Authentication.Catalog
...
func (m *CloudAuthenticationCatalog) validateEndpoints(formats strfmt.Registry) error {
...
func (m *CloudAuthenticationCatalog) validateID(formats strfmt.Registry) error {
...
func (m *CloudAuthenticationCatalog) validateType(formats strfmt.Registry) error {
...
func (m *CloudAuthenticationCatalog) UnmarshalBinary(b []byte) error {
	var res CloudAuthenticationCatalog

...
// CloudSshkeySSHKey SshKey
// swagger:model cloud.Sshkey.SshKey
...
func (m *CloudSshkeySSHKey) validateID(formats strfmt.Registry) error {
...
func (m *CloudSshkeySSHKey) validateName(formats strfmt.Registry) error {
...
func (m *CloudSshkeySSHKey) validatePublicKey(formats strfmt.Registry) error {
...
func (m *CloudSshkeySSHKey) validateRegions(formats strfmt.Registry) error {

...
// GetCloudSubsidiaryPriceDefaultBody get cloud subsidiary price default body
// swagger:model getCloudSubsidiaryPriceDefaultBody
...
func (m *GetCloudSubsidiaryPriceDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudSubsidiaryPriceDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudSubsidiaryPriceDefaultBody

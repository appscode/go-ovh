...
// GetCloudProjectServiceNameImageDefaultBody get cloud project service name image default body
// swagger:model getCloudProjectServiceNameImageDefaultBody
...
func (m *GetCloudProjectServiceNameImageDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameImageDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameImageDefaultBody

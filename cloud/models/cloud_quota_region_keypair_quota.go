...
// CloudQuotaRegionKeypairQuota KeypairQuota
// swagger:model cloud.QuotaRegion.KeypairQuota
...
func (m *CloudQuotaRegionKeypairQuota) validateMaxCount(formats strfmt.Registry) error {
...
func (m *CloudQuotaRegionKeypairQuota) UnmarshalBinary(b []byte) error {
	var res CloudQuotaRegionKeypairQuota

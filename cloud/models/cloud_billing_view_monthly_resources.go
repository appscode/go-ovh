...
// swagger:model cloud.BillingView.MonthlyResources
...
func (m *CloudBillingViewMonthlyResources) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudBillingViewMonthlyResources) validateInstance(formats strfmt.Registry) error {
...
func (m *CloudBillingViewMonthlyResources) UnmarshalBinary(b []byte) error {
	var res CloudBillingViewMonthlyResources

...
// swagger:model cloud.Reserved.RegionStock
...
func (m *CloudReservedRegionStock) validateFlavors(formats strfmt.Registry) error {
...
func (m *CloudReservedRegionStock) validateName(formats strfmt.Registry) error {
...
func (m *CloudReservedRegionStock) UnmarshalBinary(b []byte) error {
	var res CloudReservedRegionStock

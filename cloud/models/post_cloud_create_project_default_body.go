...
// PostCloudCreateProjectDefaultBody post cloud create project default body
// swagger:model postCloudCreateProjectDefaultBody
...
func (m *PostCloudCreateProjectDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostCloudCreateProjectDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostCloudCreateProjectDefaultBody

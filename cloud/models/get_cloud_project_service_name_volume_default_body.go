...
// GetCloudProjectServiceNameVolumeDefaultBody get cloud project service name volume default body
// swagger:model getCloudProjectServiceNameVolumeDefaultBody
...
func (m *GetCloudProjectServiceNameVolumeDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameVolumeDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameVolumeDefaultBody

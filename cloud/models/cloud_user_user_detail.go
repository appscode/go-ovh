...
// CloudUserUserDetail UserDetail
// swagger:model cloud.User.UserDetail
...
func (m *CloudUserUserDetail) validateCreationDate(formats strfmt.Registry) error {
...
func (m *CloudUserUserDetail) validateDescription(formats strfmt.Registry) error {
...
func (m *CloudUserUserDetail) validateID(formats strfmt.Registry) error {
...
func (m *CloudUserUserDetail) validatePassword(formats strfmt.Registry) error {
...
var cloudUserUserDetailTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		cloudUserUserDetailTypeStatusPropEnum = append(cloudUserUserDetailTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *CloudUserUserDetail) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, cloudUserUserDetailTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *CloudUserUserDetail) validateStatus(formats strfmt.Registry) error {
...
func (m *CloudUserUserDetail) validateUsername(formats strfmt.Registry) error {

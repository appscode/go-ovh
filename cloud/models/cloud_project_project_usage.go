...
// CloudProjectProjectUsage Usage information on your project
// swagger:model cloud.Project.ProjectUsage
...
func (m *CloudProjectProjectUsage) validateCurrent(formats strfmt.Registry) error {
...
func (m *CloudProjectProjectUsage) UnmarshalBinary(b []byte) error {
	var res CloudProjectProjectUsage

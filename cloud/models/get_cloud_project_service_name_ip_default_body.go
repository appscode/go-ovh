...
// GetCloudProjectServiceNameIPDefaultBody get cloud project service name Ip default body
// swagger:model getCloudProjectServiceNameIpDefaultBody
...
func (m *GetCloudProjectServiceNameIPDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameIPDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameIPDefaultBody

...
// swagger:model cloud.SnapshotPrice
...
func (m *CloudSnapshotPrice) validateMonthlyPrice(formats strfmt.Registry) error {
...
func (m *CloudSnapshotPrice) validatePrice(formats strfmt.Registry) error {

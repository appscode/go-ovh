...
// swagger:model cloud.Project.BandwidthStorageUsage
...
func (m *CloudProjectBandwidthStorageUsage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudProjectBandwidthStorageUsage) validateTotal(formats strfmt.Registry) error {
...
func (m *CloudProjectBandwidthStorageUsage) UnmarshalBinary(b []byte) error {
	var res CloudProjectBandwidthStorageUsage

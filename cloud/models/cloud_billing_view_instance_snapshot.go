...
// swagger:model cloud.BillingView.InstanceSnapshot
...
func (m *CloudBillingViewInstanceSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudBillingViewInstanceSnapshot) validateQuantity(formats strfmt.Registry) error {
...
func (m *CloudBillingViewInstanceSnapshot) validateTotalPrice(formats strfmt.Registry) error {
...
func (m *CloudBillingViewInstanceSnapshot) UnmarshalBinary(b []byte) error {
	var res CloudBillingViewInstanceSnapshot

...
// swagger:model cloud.VolumePrice
...
func (m *CloudVolumePrice) validateMonthlyPrice(formats strfmt.Registry) error {
...
func (m *CloudVolumePrice) validatePrice(formats strfmt.Registry) error {

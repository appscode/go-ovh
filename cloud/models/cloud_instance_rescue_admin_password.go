...
// swagger:model cloud.Instance.RescueAdminPassword
...
func (m *CloudInstanceRescueAdminPassword) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudInstanceRescueAdminPassword) UnmarshalBinary(b []byte) error {
	var res CloudInstanceRescueAdminPassword

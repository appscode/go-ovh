...
// swagger:model cloud.Project.InstancesUsage
...
func (m *CloudProjectInstancesUsage) validateTotal(formats strfmt.Registry) error {
...
func (m *CloudProjectInstancesUsage) UnmarshalBinary(b []byte) error {
	var res CloudProjectInstancesUsage

...
// GetCloudProjectServiceNameUserDefaultBody get cloud project service name user default body
// swagger:model getCloudProjectServiceNameUserDefaultBody
...
func (m *GetCloudProjectServiceNameUserDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameUserDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameUserDefaultBody

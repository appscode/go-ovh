...
// swagger:model cloud.FlavorPrice
...
func (m *CloudFlavorPrice) validateMonthlyPrice(formats strfmt.Registry) error {
...
func (m *CloudFlavorPrice) validatePrice(formats strfmt.Registry) error {

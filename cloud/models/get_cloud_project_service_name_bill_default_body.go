...
// GetCloudProjectServiceNameBillDefaultBody get cloud project service name bill default body
// swagger:model getCloudProjectServiceNameBillDefaultBody
...
func (m *GetCloudProjectServiceNameBillDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameBillDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameBillDefaultBody

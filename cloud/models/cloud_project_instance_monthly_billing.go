...
// swagger:model cloud.Project.InstanceMonthlyBilling
...
func (m *CloudProjectInstanceMonthlyBilling) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudProjectInstanceMonthlyBilling) validateCost(formats strfmt.Registry) error {
...
func (m *CloudProjectInstanceMonthlyBilling) UnmarshalBinary(b []byte) error {
	var res CloudProjectInstanceMonthlyBilling

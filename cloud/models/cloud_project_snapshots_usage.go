...
// swagger:model cloud.Project.SnapshotsUsage
...
func (m *CloudProjectSnapshotsUsage) validateTotal(formats strfmt.Registry) error {
...
func (m *CloudProjectSnapshotsUsage) UnmarshalBinary(b []byte) error {
	var res CloudProjectSnapshotsUsage

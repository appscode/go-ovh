...
// CloudBillingViewStoredStorage StoredStorage
// swagger:model cloud.BillingView.StoredStorage
...
func (m *CloudBillingViewStoredStorage) validateQuantity(formats strfmt.Registry) error {
...
func (m *CloudBillingViewStoredStorage) validateTotalPrice(formats strfmt.Registry) error {
...
func (m *CloudBillingViewStoredStorage) UnmarshalBinary(b []byte) error {
	var res CloudBillingViewStoredStorage

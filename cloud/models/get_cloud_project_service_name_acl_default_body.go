...
// GetCloudProjectServiceNameACLDefaultBody get cloud project service name Acl default body
// swagger:model getCloudProjectServiceNameAclDefaultBody
...
func (m *GetCloudProjectServiceNameACLDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameACLDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameACLDefaultBody

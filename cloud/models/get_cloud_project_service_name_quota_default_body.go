...
// GetCloudProjectServiceNameQuotaDefaultBody get cloud project service name quota default body
// swagger:model getCloudProjectServiceNameQuotaDefaultBody
...
func (m *GetCloudProjectServiceNameQuotaDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameQuotaDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameQuotaDefaultBody

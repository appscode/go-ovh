...
// swagger:model cloud.BillingView.HourlyVolumeDetail
...
func (m *CloudBillingViewHourlyVolumeDetail) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudBillingViewHourlyVolumeDetail) validateQuantity(formats strfmt.Registry) error {
...
func (m *CloudBillingViewHourlyVolumeDetail) validateTotalPrice(formats strfmt.Registry) error {
...
func (m *CloudBillingViewHourlyVolumeDetail) validateVolumeID(formats strfmt.Registry) error {
...
func (m *CloudBillingViewHourlyVolumeDetail) UnmarshalBinary(b []byte) error {
	var res CloudBillingViewHourlyVolumeDetail

...
// CloudAuthenticationDomain Domain
// swagger:model cloud.Authentication.Domain
...
func (m *CloudAuthenticationDomain) validateName(formats strfmt.Registry) error {
...
func (m *CloudAuthenticationDomain) UnmarshalBinary(b []byte) error {
	var res CloudAuthenticationDomain

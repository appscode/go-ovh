...
// GetCloudProjectServiceNameSshkeyDefaultBody get cloud project service name sshkey default body
// swagger:model getCloudProjectServiceNameSshkeyDefaultBody
...
func (m *GetCloudProjectServiceNameSshkeyDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameSshkeyDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameSshkeyDefaultBody

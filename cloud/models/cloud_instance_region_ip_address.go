...
// CloudInstanceRegionIPAddress IpAddress
// swagger:model cloud.InstanceRegion.IpAddress
...
func (m *CloudInstanceRegionIPAddress) validateIP(formats strfmt.Registry) error {
...
func (m *CloudInstanceRegionIPAddress) validateType(formats strfmt.Registry) error {
...
func (m *CloudInstanceRegionIPAddress) validateVersion(formats strfmt.Registry) error {
...
func (m *CloudInstanceRegionIPAddress) UnmarshalBinary(b []byte) error {
	var res CloudInstanceRegionIPAddress

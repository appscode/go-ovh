...
// CloudUsageUsageCurrent UsageCurrent
// swagger:model cloud.Usage.UsageCurrent
...
func (m *CloudUsageUsageCurrent) validateHourlyUsage(formats strfmt.Registry) error {
...
func (m *CloudUsageUsageCurrent) validateLastUpdate(formats strfmt.Registry) error {
...
func (m *CloudUsageUsageCurrent) validateMonthlyUsage(formats strfmt.Registry) error {
...
func (m *CloudUsageUsageCurrent) validatePeriod(formats strfmt.Registry) error {
...
func (m *CloudUsageUsageCurrent) UnmarshalBinary(b []byte) error {
	var res CloudUsageUsageCurrent

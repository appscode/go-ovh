...
// GetCloudProjectServiceNameVrackDefaultBody get cloud project service name vrack default body
// swagger:model getCloudProjectServiceNameVrackDefaultBody
...
func (m *GetCloudProjectServiceNameVrackDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameVrackDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameVrackDefaultBody

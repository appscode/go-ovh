...
// GetCloudProjectServiceNameFlavorDefaultBody get cloud project service name flavor default body
// swagger:model getCloudProjectServiceNameFlavorDefaultBody
...
func (m *GetCloudProjectServiceNameFlavorDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameFlavorDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameFlavorDefaultBody

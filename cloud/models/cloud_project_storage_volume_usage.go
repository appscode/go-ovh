...
// swagger:model cloud.Project.StorageVolumeUsage
...
func (m *CloudProjectStorageVolumeUsage) validateTotal(formats strfmt.Registry) error {
...
func (m *CloudProjectStorageVolumeUsage) UnmarshalBinary(b []byte) error {
	var res CloudProjectStorageVolumeUsage

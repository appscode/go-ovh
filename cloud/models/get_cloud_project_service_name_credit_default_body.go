...
// GetCloudProjectServiceNameCreditDefaultBody get cloud project service name credit default body
// swagger:model getCloudProjectServiceNameCreditDefaultBody
...
func (m *GetCloudProjectServiceNameCreditDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameCreditDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameCreditDefaultBody

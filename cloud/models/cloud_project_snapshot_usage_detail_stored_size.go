...
// CloudProjectSnapshotUsageDetailStoredSize Stored snapshot size in gigabytes
// swagger:model cloudProjectSnapshotUsageDetailStoredSize
...
func (m *CloudProjectSnapshotUsageDetailStoredSize) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudProjectSnapshotUsageDetailStoredSize) UnmarshalBinary(b []byte) error {
	var res CloudProjectSnapshotUsageDetailStoredSize

...
// PutCloudProjectServiceNameDefaultBody put cloud project service name default body
// swagger:model putCloudProjectServiceNameDefaultBody
...
func (m *PutCloudProjectServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PutCloudProjectServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res PutCloudProjectServiceNameDefaultBody

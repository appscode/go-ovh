...
// swagger:model cloud.InstanceInterface.FixedIp
...
func (m *CloudInstanceInterfaceFixedIP) validateIP(formats strfmt.Registry) error {
...
func (m *CloudInstanceInterfaceFixedIP) validateSubnetID(formats strfmt.Registry) error {

	if err := validate.RequiredString("subnetId", "body", string(m.SubnetID)); err != nil {
		return err
	}
...
func (m *CloudInstanceInterfaceFixedIP) UnmarshalBinary(b []byte) error {
	var res CloudInstanceInterfaceFixedIP

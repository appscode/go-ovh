...
// swagger:model cloud.Storage.Endpoint
...
func (m *CloudStorageEndpoint) validateRegion(formats strfmt.Registry) error {
...
func (m *CloudStorageEndpoint) validateURL(formats strfmt.Registry) error {

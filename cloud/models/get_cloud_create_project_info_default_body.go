...
// GetCloudCreateProjectInfoDefaultBody get cloud create project info default body
// swagger:model getCloudCreateProjectInfoDefaultBody
...
func (m *GetCloudCreateProjectInfoDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudCreateProjectInfoDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudCreateProjectInfoDefaultBody

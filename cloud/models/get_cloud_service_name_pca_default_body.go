...
// GetCloudServiceNamePcaDefaultBody get cloud service name pca default body
// swagger:model getCloudServiceNamePcaDefaultBody
...
func (m *GetCloudServiceNamePcaDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudServiceNamePcaDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudServiceNamePcaDefaultBody

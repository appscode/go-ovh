...
// swagger:model cloud.BillingView.BandwidthStorage
...
func (m *CloudBillingViewBandwidthStorage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudBillingViewBandwidthStorage) validateQuantity(formats strfmt.Registry) error {
...
func (m *CloudBillingViewBandwidthStorage) validateTotalPrice(formats strfmt.Registry) error {
...
func (m *CloudBillingViewBandwidthStorage) UnmarshalBinary(b []byte) error {
	var res CloudBillingViewBandwidthStorage

...
// swagger:model cloud.Region.OpenstackService
...
func (m *CloudRegionOpenstackService) validateName(formats strfmt.Registry) error {
...
var cloudRegionOpenstackServiceTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		cloudRegionOpenstackServiceTypeStatusPropEnum = append(cloudRegionOpenstackServiceTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *CloudRegionOpenstackService) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, cloudRegionOpenstackServiceTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *CloudRegionOpenstackService) validateStatus(formats strfmt.Registry) error {
...
func (m *CloudRegionOpenstackService) UnmarshalBinary(b []byte) error {
	var res CloudRegionOpenstackService

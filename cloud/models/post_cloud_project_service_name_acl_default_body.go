...
// PostCloudProjectServiceNameACLDefaultBody post cloud project service name Acl default body
// swagger:model postCloudProjectServiceNameAclDefaultBody
...
func (m *PostCloudProjectServiceNameACLDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostCloudProjectServiceNameACLDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostCloudProjectServiceNameACLDefaultBody

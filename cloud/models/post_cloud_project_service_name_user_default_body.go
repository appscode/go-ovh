...
// PostCloudProjectServiceNameUserDefaultBody post cloud project service name user default body
// swagger:model postCloudProjectServiceNameUserDefaultBody
...
func (m *PostCloudProjectServiceNameUserDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostCloudProjectServiceNameUserDefaultBody) UnmarshalBinary(b []byte) error {
	var res PostCloudProjectServiceNameUserDefaultBody

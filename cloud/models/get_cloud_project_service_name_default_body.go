...
// GetCloudProjectServiceNameDefaultBody get cloud project service name default body
// swagger:model getCloudProjectServiceNameDefaultBody
...
func (m *GetCloudProjectServiceNameDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameDefaultBody

...
// swagger:model cloud.BandwidthStoragePrice
...
func (m *CloudBandwidthStoragePrice) validatePrice(formats strfmt.Registry) error {
...
func (m *CloudBandwidthStoragePrice) UnmarshalBinary(b []byte) error {
	var res CloudBandwidthStoragePrice

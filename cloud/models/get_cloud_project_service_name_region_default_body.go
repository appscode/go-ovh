...
// GetCloudProjectServiceNameRegionDefaultBody get cloud project service name region default body
// swagger:model getCloudProjectServiceNameRegionDefaultBody
...
func (m *GetCloudProjectServiceNameRegionDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetCloudProjectServiceNameRegionDefaultBody) UnmarshalBinary(b []byte) error {
	var res GetCloudProjectServiceNameRegionDefaultBody

...
// CloudInstanceInstanceMetrics InstanceMetrics
// swagger:model cloud.Instance.InstanceMetrics
...
func (m *CloudInstanceInstanceMetrics) validateUnit(formats strfmt.Registry) error {
...
func (m *CloudInstanceInstanceMetrics) validateValues(formats strfmt.Registry) error {
...
func (m *CloudInstanceInstanceMetrics) UnmarshalBinary(b []byte) error {
	var res CloudInstanceInstanceMetrics
